 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bc="FirebaseError";class Ve extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=Bc,Object.setPrototypeOf(this,Ve.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,sn.prototype.create)}}class sn{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?Hc(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Ve(s,a,i)}}function Hc(n,e){return n.replace(qc,(t,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const qc=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zt(n){return JSON.parse(n)}function G(n){return JSON.stringify(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lo=function(n){let e={},t={},i={},s="";try{const r=n.split(".");e=zt(Rn(r[0])||""),t=zt(Rn(r[1])||""),s=r[2],i=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:i,signature:s}},jc=function(n){const e=Lo(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},zc=function(n){const e=Lo(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kd="firebase-heartbeat-database",Yd=1,Wt="firebase-heartbeat-store";let Ni=null;function Uo(){return Ni||(Ni=hd(Kd,Yd,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Wt)}catch(t){console.warn(t)}}}}).catch(n=>{throw $e.create("idb-open",{originalErrorMessage:n.message})})),Ni}async function Qd(n){try{const t=(await Uo()).transaction(Wt),i=await t.objectStore(Wt).get(Bo(n));return await t.done,i}catch(e){if(e instanceof Ve)Ie.warn(e.message);else{const t=$e.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ie.warn(t.message)}}}async function Cr(n,e){try{const i=(await Uo()).transaction(Wt,"readwrite");await i.objectStore(Wt).put(e,Bo(n)),await i.done}catch(t){if(t instanceof Ve)Ie.warn(t.message);else{const i=$e.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Ie.warn(i.message)}}}function Bo(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rn{constructor(e,t){this.shortDelay=e,this.longDelay=t,xe(t>e,"Short delay should be less than long delay!"),this.isMobile=hs()||Oo()}get(){return lu()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vt(n,e,t=!1){if(t)return e;try{return await e}catch(i){throw i instanceof Ve&&mu(i)&&n.auth.currentUser===n&&await n.auth.signOut(),i}}function mu({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on extends la{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Le extends on{constructor(){super("twitter.com")}static credential(e,t){return et._fromParams({providerId:Le.PROVIDER_ID,signInMethod:Le.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Le.credentialFromTaggedObject(e)}static credentialFromError(e){return Le.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:i}=e;if(!t||!i)return null;try{return Le.credential(t,i)}catch{return null}}}Le.TWITTER_SIGN_IN_METHOD="twitter.com";Le.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jh="__/auth/handler",zh="emulator/auth/handler",Wh=encodeURIComponent("fac");async function Ur(n,e,t,i,s,r){R(n.config.authDomain,n,"auth-domain-config-required"),R(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:St,eventId:s};if(e instanceof la){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Hi(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,u]of Object.entries({}))o[d]=u}if(e instanceof on){const d=e.getScopes().filter(u=>u!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const d of Object.keys(a))a[d]===void 0&&delete a[d];const l=await n._getAppCheckToken(),c=l?`#${Wh}=${encodeURIComponent(l)}`:"";return`${Vh(n)}?${It(a).slice(1)}${c}`}function Vh({config:n}){return n.emulator?vs(n,zh):`https://${n.authDomain}/${jh}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const to=32,no=768;class B{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let i=0;for(let s=0;s<this.pieces_.length;s++)this.pieces_[s].length>0&&(this.pieces_[i]=this.pieces_[s],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function D(){return new B("")}function N(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function je(n){return n.pieces_.length-n.pieceNum_}function q(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new B(n.pieces_,e)}function Rs(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function Gf(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function Kt(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function ja(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new B(e,0)}function z(n,e){const t=[];for(let i=n.pieceNum_;i<n.pieces_.length;i++)t.push(n.pieces_[i]);if(e instanceof B)for(let i=e.pieceNum_;i<e.pieces_.length;i++)t.push(e.pieces_[i]);else{const i=e.split("/");for(let s=0;s<i.length;s++)i[s].length>0&&t.push(i[s])}return new B(t,0)}function O(n){return n.pieceNum_>=n.pieces_.length}function X(n,e){const t=N(n),i=N(e);if(t===null)return e;if(t===i)return X(q(n),q(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function Kf(n,e){const t=Kt(n,0),i=Kt(e,0);for(let s=0;s<t.length&&s<i.length;s++){const r=st(t[s],i[s]);if(r!==0)return r}return t.length===i.length?0:t.length<i.length?-1:1}function As(n,e){if(je(n)!==je(e))return!1;for(let t=n.pieceNum_,i=e.pieceNum_;t<=n.pieces_.length;t++,i++)if(n.pieces_[t]!==e.pieces_[i])return!1;return!0}function oe(n,e){let t=n.pieceNum_,i=e.pieceNum_;if(je(n)>je(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[i])return!1;++t,++i}return!0}class Yf{constructor(e,t){this.errorPrefix_=t,this.parts_=Kt(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=ti(this.parts_[i]);za(this)}}function Qf(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=ti(e),za(n)}function Jf(n){const e=n.parts_.pop();n.byteLength_-=ti(e),n.parts_.length>0&&(n.byteLength_-=1)}function za(n){if(n.byteLength_>no)throw new Error(n.errorPrefix_+"has a key path longer than "+no+" bytes ("+n.byteLength_+").");if(n.parts_.length>to)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+to+") or object contains a cycle "+Ye(n))}function Ye(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oi{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new P(vt,e),s=new P(vt,t);return this.compare(i,s)!==0}minPost(){return P.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $i;const ot={};class Ee{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return y(ot&&W,"ChildrenNode.ts has not been loaded"),$i=$i||new Ee({".priority":ot},{".priority":W}),$i}get(e){const t=gt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof ne?t:null}hasIndex(e){return _e(this.indexSet_,e.toString())}addIndex(e,t){y(e!==mt,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(P.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=Bn(i,e.getCompare()):a=ot;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const d=Object.assign({},this.indexes_);return d[l]=a,new Ee(d,c)}addToIndexes(e,t){const i=An(this.indexes_,(s,r)=>{const o=gt(this.indexSet_,r);if(y(o,"Missing index implementation for "+r),s===ot)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(P.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),Bn(a,o.getCompare())}else return ot;else{const a=t.get(e.name);let l=s;return a&&(l=l.remove(new P(e.name,a))),l.insert(e,e.node)}});return new Ee(i,this.indexSet_)}removeFromIndexes(e,t){const i=An(this.indexes_,s=>{if(s===ot)return s;{const r=t.get(e.name);return r?s.remove(new P(e.name,r)):s}});return new Ee(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hp extends oi{constructor(e){super(),this.indexPath_=e,y(!O(e)&&N(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const i=this.extractChild(e.node),s=this.extractChild(t.node),r=i.compareTo(s);return r===0?st(e.name,t.name):r}makePost(e,t){const i=V(e),s=T.EMPTY_NODE.updateChild(this.indexPath_,i);return new P(t,s)}maxPost(){const e=T.EMPTY_NODE.updateChild(this.indexPath_,dn);return new P(tt,e)}toString(){return Kt(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fp extends oi{compare(e,t){const i=e.node.compareTo(t.node);return i===0?st(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return P.MIN}maxPost(){return P.MAX}makePost(e,t){const i=V(e);return new P(t,i)}toString(){return".value"}}const pp=new fp;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qa(n){return{type:"value",snapshotNode:n}}function yt(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Yt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Qt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function mp(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Os{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){y(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(Yt(t,a)):y(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(yt(t,i)):o.trackChildChange(Qt(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(W,(s,r)=>{t.hasChild(s)||i.trackChildChange(Yt(s,r))}),t.isLeafNode()||t.forEachChild(W,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(Qt(s,r,o))}else i.trackChildChange(yt(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?T.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hn extends Ha{constructor(e,t,i,s){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=i,this.appCheckTokenProvider_=s,this.log_=cn("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(y(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,i,s){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Hn.getListenId_(e,i),a={};this.listens_[o]=a;const l=oo(e._queryParams);this.restRequest_(r+".json",l,(c,d)=>{let u=d;if(c===404&&(u=null,c=null),c===null&&this.onDataUpdate_(r,u,!1,i),gt(this.listens_,o)===a){let f;c?c===401?f="permission_denied":f="rest_error:"+c:f="ok",s(f,null)}})}unlisten(e,t){const i=Hn.getListenId_(e,t);delete this.listens_[i]}get(e){const t=oo(e._queryParams),i=e._path.toString(),s=new nn;return this.restRequest_(i+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(i,a,!1,null),s.resolve(a)):s.reject(new Error(a))}),s.promise}refreshAuthToken(e){}restRequest_(e,t={},i){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([s,r])=>{s&&s.accessToken&&(t.auth=s.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+It(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(i&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=zt(a.responseText)}catch{Z("Failed to parse JSON response for "+o+": "+a.responseText)}i(null,l)}else a.status!==401&&a.status!==404&&Z("Got unsuccessful REST response for "+o+" Status: "+a.status),i(a.status);i=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qn(){return{value:null,children:new Map}}function Ja(n,e,t){if(O(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const i=N(e);n.children.has(i)||n.children.set(i,qn());const s=n.children.get(i);e=q(e),Ja(s,e,t)}}function Zi(n,e,t){n.value!==null?t(e,n.value):yp(n,(i,s)=>{const r=new B(e.toString()+"/"+i);Zi(s,r,t)})}function yp(n,e){n.children.forEach((t,i)=>{e(i,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lo=10*1e3,wp=30*1e3,Ep=5*60*1e3;class Cp{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new bp(e);const i=lo+(wp-lo)*Math.random();Bt(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;J(e,(s,r)=>{r>0&&_e(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),Bt(this.reportStats_.bind(this),Math.floor(Math.random()*2*Ep))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=de.ACK_USER_WRITE,this.source=Ds()}operationForChild(e){if(O(this.path)){if(this.affectedTree.value!=null)return y(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new B(e));return new jn(D(),t,this.revert)}}else return y(N(this.path)===e,"operationForChild called for unrelated child."),new jn(q(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xt{constructor(e,t){this.source=e,this.path=t,this.type=de.LISTEN_COMPLETE}operationForChild(e){return O(this.path)?new Xt(this.source,D()):new Xt(this.source,q(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nt{constructor(e,t,i){this.source=e,this.path=t,this.snap=i,this.type=de.OVERWRITE}operationForChild(e){return O(this.path)?new nt(this.source,D(),this.snap.getImmediateChild(e)):new nt(this.source,q(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=de.MERGE}operationForChild(e){if(O(this.path)){const t=this.children.subtree(new B(e));return t.isEmpty()?null:t.value?new nt(this.source,D(),t.value):new bt(this.source,D(),t)}else return y(N(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new bt(this.source,q(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ip{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Sp(n,e,t,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(mp(o.childName,o.snapshotNode))}),Mt(n,s,"child_removed",e,i,t),Mt(n,s,"child_added",e,i,t),Mt(n,s,"child_moved",r,i,t),Mt(n,s,"child_changed",e,i,t),Mt(n,s,"value",e,i,t),s}function Mt(n,e,t,i,s,r){const o=i.filter(a=>a.type===t);o.sort((a,l)=>Tp(n,a,l)),o.forEach(a=>{const l=xp(n,a,r);s.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,n.query_))})})}function xp(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function Tp(n,e,t){if(e.childName==null||t.childName==null)throw Ct("Should only compare child_ events.");const i=new P(e.childName,e.snapshotNode),s=new P(t.childName,t.snapshotNode);return n.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ai(n,e){return{eventCache:n,serverCache:e}}function Ht(n,e,t,i){return ai(new ze(e,t,i),n.serverCache)}function Xa(n,e,t,i){return ai(n.eventCache,new ze(e,t,i))}function zn(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function it(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function li(n,e){return il(e,n)}function Rp(n,e,t,i,s){y(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=qt(n.visibleWrites,e,t)),n.lastWriteId=i}function Ap(n,e,t,i){y(i>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:i,visible:!0}),n.visibleWrites=es(n.visibleWrites,e,t),n.lastWriteId=i}function Np(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function Pp(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);y(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&Op(a,i.path)?s=!1:oe(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return Lp(n),!0;if(i.snap)n.visibleWrites=co(n.visibleWrites,i.path);else{const a=i.children;J(a,l=>{n.visibleWrites=co(n.visibleWrites,z(i.path,l))})}return!0}else return!1}function Op(n,e){if(n.snap)return oe(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&oe(z(n.path,t),e))return!0;return!1}function Lp(n){n.visibleWrites=el(n.allWrites,Dp,D()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function Dp(n){return n.visible}function el(n,e,t){let i=ue.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)oe(t,o)?(a=X(t,o),i=qt(i,a,r.snap)):oe(o,t)&&(a=X(o,t),i=qt(i,D(),r.snap.getChild(a)));else if(r.children){if(oe(t,o))a=X(t,o),i=es(i,a,r.children);else if(oe(o,t))if(a=X(o,t),O(a))i=es(i,D(),r.children);else{const l=gt(r.children,N(a));if(l){const c=l.getChild(q(a));i=qt(i,D(),c)}}}else throw Ct("WriteRecord should have .snap or .children")}}return i}function tl(n,e,t,i,s){if(!i&&!s){const r=rt(n.visibleWrites,e);if(r!=null)return r;{const o=Be(n.visibleWrites,e);if(ns(o))return t;if(t==null&&!ts(o,D()))return null;{const a=t||T.EMPTY_NODE;return wt(o,a)}}}else{const r=Be(n.visibleWrites,e);if(!s&&ns(r))return t;if(!s&&t==null&&!ts(r,D()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(oe(c.path,e)||oe(e,c.path))},a=el(n.allWrites,o,e),l=t||T.EMPTY_NODE;return wt(a,l)}}}function Mp(n,e,t){let i=T.EMPTY_NODE;const s=rt(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(W,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=Be(n.visibleWrites,e);return t.forEachChild(W,(o,a)=>{const l=wt(Be(r,new B(o)),a);i=i.updateImmediateChild(o,l)}),uo(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=Be(n.visibleWrites,e);return uo(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function $p(n,e,t,i,s){y(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=z(e,t);if(ts(n.visibleWrites,r))return null;{const o=Be(n.visibleWrites,r);return ns(o)?s.getChild(t):wt(o,s.getChild(t))}}function Fp(n,e,t,i){const s=z(e,t),r=rt(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=Be(n.visibleWrites,s);return wt(o,i.getNode().getImmediateChild(t))}else return null}function Up(n,e){return rt(n.visibleWrites,e)}function Bp(n,e,t,i,s,r,o){let a;const l=Be(n.visibleWrites,e),c=rt(l,D());if(c!=null)a=c;else if(t!=null)a=wt(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const d=[],u=o.getCompare(),f=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let h=f.getNext();for(;h&&d.length<s;)u(h,i)!==0&&d.push(h),h=f.getNext();return d}else return[]}function Hp(){return{visibleWrites:ue.empty(),allWrites:[],lastWriteId:-1}}function Wn(n,e,t,i){return tl(n.writeTree,n.treePath,e,t,i)}function Fs(n,e){return Mp(n.writeTree,n.treePath,e)}function ho(n,e,t,i){return $p(n.writeTree,n.treePath,e,t,i)}function Vn(n,e){return Up(n.writeTree,z(n.treePath,e))}function qp(n,e,t,i,s,r){return Bp(n.writeTree,n.treePath,e,t,i,s,r)}function Us(n,e,t){return Fp(n.writeTree,n.treePath,e,t)}function nl(n,e){return il(z(n.treePath,e),n.writeTree)}function il(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wp(n){return{filter:n}}function Vp(n,e){y(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),y(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function Gp(n,e,t,i,s){const r=new jp;let o,a;if(t.type===de.OVERWRITE){const c=t;c.source.fromUser?o=is(n,e,c.path,c.snap,i,s,r):(y(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!O(c.path),o=Gn(n,e,c.path,c.snap,i,s,a,r))}else if(t.type===de.MERGE){const c=t;c.source.fromUser?o=Yp(n,e,c.path,c.children,i,s,r):(y(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=ss(n,e,c.path,c.children,i,s,a,r))}else if(t.type===de.ACK_USER_WRITE){const c=t;c.revert?o=Xp(n,e,c.path,i,s,r):o=Qp(n,e,c.path,c.affectedTree,i,s,r)}else if(t.type===de.LISTEN_COMPLETE)o=Jp(n,e,t.path,i,r);else throw Ct("Unknown operation type: "+t.type);const l=r.getChanges();return Kp(e,o,l),{viewCache:o,changes:l}}function Kp(n,e,t){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=zn(n);(t.length>0||!n.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&t.push(Qa(zn(e)))}}function rl(n,e,t,i,s,r){const o=e.eventCache;if(Vn(i,t)!=null)return e;{let a,l;if(O(t))if(y(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=it(e),d=c instanceof T?c:T.EMPTY_NODE,u=Fs(i,d);a=n.filter.updateFullNode(e.eventCache.getNode(),u,r)}else{const c=Wn(i,it(e));a=n.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=N(t);if(c===".priority"){y(je(t)===1,"Can't have a priority with additional path components");const d=o.getNode();l=e.serverCache.getNode();const u=ho(i,t,d,l);u!=null?a=n.filter.updatePriority(d,u):a=o.getNode()}else{const d=q(t);let u;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const f=ho(i,t,o.getNode(),l);f!=null?u=o.getNode().getImmediateChild(c).updateChild(d,f):u=o.getNode().getImmediateChild(c)}else u=Us(i,c,e.serverCache);u!=null?a=n.filter.updateChild(o.getNode(),c,u,d,s,r):a=o.getNode()}}return Ht(e,a,o.isFullyInitialized()||O(t),n.filter.filtersNodes())}}function Gn(n,e,t,i,s,r,o,a){const l=e.serverCache;let c;const d=o?n.filter:n.filter.getIndexedFilter();if(O(t))c=d.updateFullNode(l.getNode(),i,null);else if(d.filtersNodes()&&!l.isFiltered()){const h=l.getNode().updateChild(t,i);c=d.updateFullNode(l.getNode(),h,null)}else{const h=N(t);if(!l.isCompleteForPath(t)&&je(t)>1)return e;const m=q(t),b=l.getNode().getImmediateChild(h).updateChild(m,i);h===".priority"?c=d.updatePriority(l.getNode(),b):c=d.updateChild(l.getNode(),h,b,m,sl,null)}const u=Xa(e,c,l.isFullyInitialized()||O(t),d.filtersNodes()),f=new Bs(s,u,r);return rl(n,u,t,s,f,a)}function is(n,e,t,i,s,r,o){const a=e.eventCache;let l,c;const d=new Bs(s,e,r);if(O(t))c=n.filter.updateFullNode(e.eventCache.getNode(),i,o),l=Ht(e,c,!0,n.filter.filtersNodes());else{const u=N(t);if(u===".priority")c=n.filter.updatePriority(e.eventCache.getNode(),i),l=Ht(e,c,a.isFullyInitialized(),a.isFiltered());else{const f=q(t),h=a.getNode().getImmediateChild(u);let m;if(O(f))m=i;else{const v=d.getCompleteChild(u);v!=null?Rs(f)===".priority"&&v.getChild(ja(f)).isEmpty()?m=v:m=v.updateChild(f,i):m=T.EMPTY_NODE}if(h.equals(m))l=e;else{const v=n.filter.updateChild(a.getNode(),u,m,f,d,o);l=Ht(e,v,a.isFullyInitialized(),n.filter.filtersNodes())}}}return l}function fo(n,e){return n.eventCache.isCompleteForChild(e)}function Yp(n,e,t,i,s,r,o){let a=e;return i.foreach((l,c)=>{const d=z(t,l);fo(e,N(d))&&(a=is(n,a,d,c,s,r,o))}),i.foreach((l,c)=>{const d=z(t,l);fo(e,N(d))||(a=is(n,a,d,c,s,r,o))}),a}function po(n,e,t){return t.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function ss(n,e,t,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;O(t)?c=i:c=new H(null).setTree(t,i);const d=e.serverCache.getNode();return c.children.inorderTraversal((u,f)=>{if(d.hasChild(u)){const h=e.serverCache.getNode().getImmediateChild(u),m=po(n,h,f);l=Gn(n,l,new B(u),m,s,r,o,a)}}),c.children.inorderTraversal((u,f)=>{const h=!e.serverCache.isCompleteForChild(u)&&f.value===null;if(!d.hasChild(u)&&!h){const m=e.serverCache.getNode().getImmediateChild(u),v=po(n,m,f);l=Gn(n,l,new B(u),v,s,r,o,a)}}),l}function Qp(n,e,t,i,s,r,o){if(Vn(s,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(O(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return Gn(n,e,t,l.getNode().getChild(t),s,r,a,o);if(O(t)){let c=new H(null);return l.getNode().forEachChild(mt,(d,u)=>{c=c.set(new B(d),u)}),ss(n,e,t,c,s,r,a,o)}else return e}else{let c=new H(null);return i.foreach((d,u)=>{const f=z(t,d);l.isCompleteForPath(f)&&(c=c.set(d,l.getNode().getChild(f)))}),ss(n,e,t,c,s,r,a,o)}}function Jp(n,e,t,i,s){const r=e.serverCache,o=Xa(e,r.getNode(),r.isFullyInitialized()||O(t),r.isFiltered());return rl(n,o,t,i,sl,s)}function Xp(n,e,t,i,s,r){let o;if(Vn(i,t)!=null)return e;{const a=new Bs(i,e,s),l=e.eventCache.getNode();let c;if(O(t)||N(t)===".priority"){let d;if(e.serverCache.isFullyInitialized())d=Wn(i,it(e));else{const u=e.serverCache.getNode();y(u instanceof T,"serverChildren would be complete if leaf node"),d=Fs(i,u)}d=d,c=n.filter.updateFullNode(l,d,r)}else{const d=N(t);let u=Us(i,d,e.serverCache);u==null&&e.serverCache.isCompleteForChild(d)&&(u=l.getImmediateChild(d)),u!=null?c=n.filter.updateChild(l,d,u,q(t),a,r):e.eventCache.getNode().hasChild(d)?c=n.filter.updateChild(l,d,T.EMPTY_NODE,q(t),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Wn(i,it(e)),o.isLeafNode()&&(c=n.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||Vn(i,D())!=null,Ht(e,c,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $m{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function fi(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!As(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function xl(n,e,t){fi(n,t),Tl(n,i=>As(i,e))}function le(n,e,t){fi(n,t),Tl(n,i=>oe(i,e)||oe(e,i))}function Tl(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(Fm(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Fm(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();Ut&&Q("event: "+t.toString()),Tt(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nr{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return O(this._path)?null:Rs(this._path)}get ref(){return new ke(this._repo,this._path)}get _queryIdentifier(){const e=ao(this._queryParams),t=Ss(e);return t==="{}"?"default":t}get _queryObject(){return ao(this._queryParams)}isEqual(e){if(e=ie(e),!(e instanceof nr))return!1;const t=this._repo===e._repo,i=As(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+Gf(this._path)}}class ke extends nr{constructor(e,t){super(e,t,new Ls,!1)}get parent(){const e=ja(this._path);return e===null?null:new ke(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class en{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new B(e),i=tn(this.ref,e);return new en(this._node.getChild(t),i,W)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new en(s,tn(this.ref,i),W)))}hasChild(e){const t=new B(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function S(n,e){return n=ie(n),n._checkNotDeleted("ref"),e!==void 0?tn(n._root,e):n._root}function tn(n,e){return n=ie(n),N(n._path)===null?Dm("child","path",e):Il("child","path",e),new ke(n._repo,z(n._path,e))}function At(n,e){n=ie(n),Sl("push",n._path),Cl("push",e,n._path,!0);const t=kl(n._repo),i=tg(t),s=tn(n,i),r=tn(n,i);let o;return o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function $(n,e){n=ie(n),Sl("set",n._path),Cl("set",e,n._path,!1);const t=new nn;return Wm(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function ge(n,e){Lm("update",e,n._path);const t=new nn;return Vm(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function te(n){n=ie(n);const e=new Ll(()=>{}),t=new gi(e);return zm(n._repo,n,t).then(i=>new en(i,new ke(n._repo,n._path),n._queryParams.getIndex()))}class gi{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new ng("value",this,new en(e.snapshotNode,new ke(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new ig(this,e,t):null}matches(e){return e instanceof gi?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function sg(n,e,t,i,s){const r=new Ll(t,void 0),o=new gi(r);return Km(n._repo,n,o),()=>Rl(n._repo,n,o)}function ir(n,e,t,i){return sg(n,"value",e)}function sr(n,e,t){Rl(n._repo,n,null)}rm(ke);dm(ke);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function pg(n){sf(St),_t(new Ze("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return lg(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),Fe(zr,Wr,n),Fe(zr,Wr,"esm2017")}Ce.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};Ce.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};pg();const mg={apiKey:"AIzaSyCzdkKcfNvafQ3x9NDUsTn8UOww7_v3nn0",authDomain:"who-s-the-queen-bee.firebaseapp.com",databaseURL:"https://who-s-the-queen-bee-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"who-s-the-queen-bee",storageBucket:"who-s-the-queen-bee.firebasestorage.app",messagingSenderId:"808367557368",appId:"1:808367557368:web:7af8a2948e62494c5e490d"},Dl=$o(mg),gg=tf(Dl),x=hg(Dl),_g="modulepreload",vg=function(n){return"/queen-bee-scorecard/"+n},Io={},Ml=function(e,t,i){let s=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),a=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(t.map(l=>{if(l=vg(l),l in Io)return;Io[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":_g,c||(u.as="script"),u.crossOrigin="",u.href=l,a&&u.setAttribute("nonce",a),document.head.appendChild(u),c)return new Promise((f,h)=>{u.addEventListener("load",f),u.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return s.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return e().catch(r)})};async function ae(){const n=await te(S(x,"employees"));return n.exists()?n.val():{}}async function _i(n,e){await ge(S(x,`employees/${n}`),e)}function Re(n=new Date){return`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}`}async function pn(n,e=Re()){const t=await te(S(x,`monthly_points/${e}/${n}`));return t.exists()?t.val():{points:0,rank:null,db_count:0,db_pts_deducted:0,net_points:0}}async function rr(n,e,t=Re()){const i=await pn(n,t),s={...i,points:(i.points||0)+e,net_points:(i.net_points||0)+e};return await $(S(x,`monthly_points/${t}/${n}`),s),s}function vi(n=Re(),e){const t=S(x,`monthly_points/${n}`);return ir(t,i=>e(i.exists()?i.val():{})),()=>sr(t)}async function mn(n){const e=await te(S(x,`vault/${n}`));return e.exists()?e.val():{total_earned:0,total_deducted:0,net:0,last_reset_date:null}}async function or(n,e){const t=await mn(n),i={...t,total_earned:(t.total_earned||0)+e,net:(t.net||0)+e};return await $(S(x,`vault/${n}`),i),i}async function $l(n){const e=At(S(x,"awards")),t={...n,timestamp:Date.now()};return await $(e,t),e.key}async function Fl(n){const e=await te(S(x,"awards"));if(!e.exists())return[];const t=e.val();return Object.entries(t).map(([i,s])=>({id:i,...s})).filter(i=>i.receiver_id===n).sort((i,s)=>s.timestamp-i.timestamp)}async function ar(n){const e=await te(S(x,"awards"));if(!e.exists())return[];const t=e.val();return Object.entries(t).map(([i,s])=>({id:i,...s})).filter(i=>i.giver_id===n).sort((i,s)=>s.timestamp-i.timestamp)}async function Ul(n){const e=At(S(x,"dark_beans")),t={...n,timestamp:Date.now(),appealed:!1,appeal_status:null};return await $(e,t),e.key}async function Bl(n,e=Re()){const t=await te(S(x,"dark_beans"));if(!t.exists())return[];const i=t.val();return Object.entries(i).map(([s,r])=>({id:s,...r})).filter(s=>s.receiver_id===n&&s.month_key===e).sort((s,r)=>r.timestamp-s.timestamp)}async function lr(n,e,t){const i=await te(S(x,`offense_escalation/${n}/${e}/${t}`));return i.exists()?i.val().instance_count:0}async function Hl(n,e,t){const i=await lr(n,e,t);return await $(S(x,`offense_escalation/${n}/${e}/${t}`),{instance_count:i+1}),i+1}async function gn(){const n=await te(S(x,"action_menu"));return n.exists()?n.val():{}}async function ql(n,e){await ge(S(x,`action_menu/${n}`),e)}async function Nt(){const n=await te(S(x,"offense_menu"));return n.exists()?n.val():{}}async function jl(n,e){await ge(S(x,`offense_menu/${n}`),e)}async function yi(n=Re()){const e=await te(S(x,`nominations/${n}/wildcard_nominee`));return e.exists()?e.val():null}async function cr(n,e){await $(S(x,`nominations/${n}/wildcard_nominee`),e)}async function dr(n){await $(S(x,`nominations/${n}/wildcard_nominee`),null)}async function zl(n,e,t){await $(S(x,`votes/${n}/${e}`),t)}async function _n(n=Re()){const e=await te(S(x,`votes/${n}`));return e.exists()?e.val():{}}async function xn(n,e){return(await te(S(x,`votes/${n}/${e}`))).exists()}async function $t(n){const e=At(S(x,"audit_flags")),t={...n,timestamp:Date.now(),status:"open",acted_by:null,acted_at:null};return await $(e,t),e.key}async function Wl(n,e,t){await ge(S(x,`audit_flags/${n}`),{status:e,acted_by:t,acted_at:Date.now()})}async function Vl(){const n=await te(S(x,"audit_flags"));return n.exists()?Object.entries(n.val()).map(([e,t])=>({id:e,...t})).sort((e,t)=>t.timestamp-e.timestamp):[]}async function Gl(n){const e=At(S(x,"pending_registrations"));return await $(e,{...n,submitted_at:Date.now(),status:"pending"}),e.key}async function Kl(n,e,t){const i="emp_"+n.slice(-8);return await $(S(x,`employees/${i}`),{name:e.name,email:e.email,role:e.role,outlet:e.outlet,pin_hash:e.pin_hash,active:!0}),await ge(S(x,`pending_registrations/${n}`),{status:"approved",approved_by:t,approved_at:Date.now()}),i}async function Yl(n,e){await ge(S(x,`pending_registrations/${n}`),{status:"rejected",rejected_by:e,rejected_at:Date.now()})}function Jn(n){const e=S(x,"pending_registrations");return ir(e,t=>{if(!t.exists()){n([]);return}const i=Object.entries(t.val()).map(([s,r])=>({id:s,...r})).filter(s=>s.status==="pending");n(i)}),()=>sr(e)}async function Ql(n,e,t,i=Re()){const s=await pn(n,i),r={...s,db_count:(s.db_count||0)+e,db_pts_deducted:(s.db_pts_deducted||0)+t,net_points:Math.max(0,(s.net_points||s.points||0)-t)};return await $(S(x,`monthly_points/${i}/${n}`),r),r}async function Jl(n,e){const t=await mn(n),i={...t,total_deducted:(t.total_deducted||0)+e,net:Math.max(0,(t.net||0)-e)};return await $(S(x,`vault/${n}`),i),i}async function Xl(n,e,t,i=Re()){const s=await pn(n,i),r={...s,db_count:Math.max(0,(s.db_count||0)-e),db_pts_deducted:Math.max(0,(s.db_pts_deducted||0)-t),net_points:(s.net_points||s.points||0)+t};return await $(S(x,`monthly_points/${i}/${n}`),r),r}async function Zl(n,e){const t=await mn(n),i={...t,total_deducted:Math.max(0,(t.total_deducted||0)-e),net:(t.net||0)+e};return await $(S(x,`vault/${n}`),i),i}async function ec(n){const e=await te(S(x,"dark_beans"));return e.exists()?Object.entries(e.val()).map(([t,i])=>({id:t,...i})).filter(t=>t.giver_id===n&&!t.revoked).sort((t,i)=>i.timestamp-t.timestamp):[]}async function tc(n){const e=At(S(x,"revoke_requests"));return await $(e,{...n,submitted_at:Date.now(),status:"pending"}),e.key}function Xn(n){const e=S(x,"revoke_requests");return ir(e,t=>{if(!t.exists()){n([]);return}const i=Object.entries(t.val()).map(([s,r])=>({id:s,...r})).filter(s=>s.status==="pending");n(i)}),()=>sr(e)}async function nc(n,e,t){const i=Date.now(),s=At(S(x,"revoke_log"));await Promise.all([Xl(e.receiver_id,e.db_count,e.pts_deducted,e.month_key),Zl(e.receiver_id,e.pts_deducted),ge(S(x,`dark_beans/${e.dark_bean_id}`),{revoked:!0,revoked_at:i,revoked_by:t}),ge(S(x,`revoke_requests/${n}`),{status:"approved",approved_by:t,approved_at:i}),$(s,{dark_bean_id:e.dark_bean_id,receiver_id:e.receiver_id,giver_id:e.giver_id,giver_name:e.giver_name,offense_id:e.offense_id,conduct_tier:e.conduct_tier,pts_restored:e.pts_deducted,reason:e.reason,approved_by:t,timestamp:i})])}async function ic(n,e){await ge(S(x,`revoke_requests/${n}`),{status:"rejected",rejected_by:e,rejected_at:Date.now()})}async function sc(){await Promise.all([$(S(x,"awards"),null),$(S(x,"monthly_points"),null),$(S(x,"vault"),null),$(S(x,"dark_beans"),null),$(S(x,"audit_flags"),null),$(S(x,"offense_escalation"),null),$(S(x,"votes"),null),$(S(x,"nominations"),null),$(S(x,"revoke_requests"),null),$(S(x,"revoke_log"),null)])}async function rc(){await Promise.all([$(S(x,"employees"),null),$(S(x,"pending_registrations"),null)])}async function bi(){const n=await te(S(x,"config"));return n.exists()?n.val():{}}async function oc(n){await ge(S(x,"config"),n)}const yg=Object.freeze(Object.defineProperty({__proto__:null,addMonthlyPoints:rr,addVaultPoints:or,approveRegistration:Kl,approveRevokeRequest:nc,castVote:zl,clearWildcardNominee:dr,createAuditFlag:$t,createAward:$l,createDarkBean:Ul,createRevokeRequest:tc,deductMonthlyPoints:Ql,deductVaultPoints:Jl,getActions:gn,getAllEmployees:ae,getAllFlags:Vl,getAwardsByEmployee:Fl,getAwardsByGiver:ar,getConfig:bi,getDarkBeansByEmployee:Bl,getDarkBeansByGiver:ec,getMonthlyPoints:pn,getOffenseInstance:lr,getOffenses:Nt,getVault:mn,getVotes:_n,getWildcardNominee:yi,hasVoted:xn,incrementOffenseInstance:Hl,listenLeaderboard:vi,listenPendingRegistrations:Jn,listenRevokeRequests:Xn,monthKey:Re,nukeAllStaff:rc,nukeTransactionalData:sc,rejectRegistration:Yl,rejectRevokeRequest:ic,reverseDeduction:Xl,reverseVaultDeduction:Zl,setWildcardNominee:cr,submitRegistration:Gl,updateConfig:oc,updateFlagStatus:Wl,upsertAction:ql,upsertEmployee:_i,upsertOffense:jl},Symbol.toStringTag,{value:"Module"})),wi="hb_bs_session",bg=2*60*60*1e3,wg=30*1e3;function ac(n){const e={...n,loginAt:Date.now()};localStorage.setItem(wi,JSON.stringify(e))}function lc(){try{const n=localStorage.getItem(wi);if(!n)return null;const e=JSON.parse(n);return Date.now()-e.loginAt>bg?(cc(),null):e}catch{return null}}function cc(){localStorage.removeItem(wi)}function Eg(){const n=lc();n&&(n.loginAt=Date.now(),localStorage.setItem(wi,JSON.stringify(n)))}function dc(){return setInterval(Eg,wg)}async function Cg(n){const t=new TextEncoder().encode(n),i=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}async function Ig(n,e){const{getAllEmployees:t}=await Ml(async()=>{const{getAllEmployees:o}=await Promise.resolve().then(()=>yg);return{getAllEmployees:o}},void 0),i=await t(),s=Object.entries(i).map(([o,a])=>({id:o,...a})).find(o=>o.email===n&&o.active!==!1);if(!s)throw new Error("Employee not found");const r=await Cg(e);if(s.pin_hash!==r)throw new Error("Incorrect PIN");return ac(s),s}function Zn(){return!!(window.PublicKeyCredential&&navigator.credentials)}async function Sg(n){if(!Zn())return!1;try{const e=crypto.getRandomValues(new Uint8Array(32)),t=new TextEncoder().encode(n.id),i=await navigator.credentials.create({publicKey:{challenge:e,rp:{name:"Heebee Bean System"},user:{id:t,name:n.email,displayName:n.name},pubKeyCredParams:[{type:"public-key",alg:-7}],authenticatorSelection:{authenticatorAttachment:"platform",userVerification:"required"},timeout:6e4,attestation:"none"}});return i?(await _i(n.id,{webauthn_id:Tg(i.rawId)}),!0):!1}catch(e){return console.warn("WebAuthn registration failed, using PIN only:",e.message),!1}}async function xg(n){if(!Zn()||!n.webauthn_id)return!1;try{const e=crypto.getRandomValues(new Uint8Array(32)),t=kg(n.webauthn_id);return await navigator.credentials.get({publicKey:{challenge:e,allowCredentials:[{type:"public-key",id:t}],userVerification:"required",timeout:6e4}})?(ac(n),n):!1}catch(e){return console.warn("WebAuthn auth failed, fall back to PIN:",e.message),!1}}function Tg(n){return btoa(String.fromCharCode(...new Uint8Array(n)))}function kg(n){const e=atob(n),t=new Uint8Array(e.length);for(let i=0;i<e.length;i++)t[i]=e.charCodeAt(i);return t.buffer}function Rg(){cc()}const he={green:{id:"green",icon:"🫘",label:"Green Bean",pts:1,dailyCap:3},silver:{id:"silver",icon:"☕",label:"Silver Bean",pts:5,dailyCap:3},gold:{id:"gold",icon:"🥇",label:"Gold Bean",pts:10,dailyCap:3},crystal:{id:"crystal",icon:"💎",label:"Crystal Bean",pts:25,dailyCap:10}},Ei=["Trainee","Barista","Senior Barista","Kitchen Helper","Commi 3","Commi 2","Commi 1","DCDP","CDP"],Ci=["Floor Manager","Sous Chef","Cafe Manager","Head Chef","Area Manager","HOD","CEO","COO","Owner"],Ii=["HR","Accountant","Admin Staff"],uc={"Floor Manager":["green"],"Sous Chef":["green"],"Cafe Manager":["silver"],"Head Chef":["silver"],"Area Manager":["gold"],HOD:["gold"],CEO:["green","silver","gold","crystal"],COO:["green","silver","gold","crystal"],Owner:["green","silver","gold","crystal"]},Tn={green:{id:"green",icon:"🟢",label:"Minor",base_db:1,pts:5},silver:{id:"silver",icon:"🟠",label:"Moderate",base_db:3,pts:15},gold:{id:"gold",icon:"🔴",label:"Serious",base_db:5,pts:25},crystal:{id:"crystal",icon:"⚫",label:"Severe",base_db:10,pts:50}},hc={"Floor Manager":["green"],"Sous Chef":["green"],"Cafe Manager":["green","silver"],"Head Chef":["green","silver"],"Area Manager":["green","silver","gold"],HOD:["green","silver","gold"],HR:["green","silver","gold","crystal"],CEO:["green","silver","gold","crystal"],COO:["green","silver","gold","crystal"],Owner:["green","silver","gold","crystal"]},cs=5,fc=[{id:"act_01",name:"Daily Task Completion",applicable_bean_tier:"any",active:!0},{id:"act_02",name:"Perfect Attendance",applicable_bean_tier:"any",active:!0},{id:"act_03",name:"Upsell Achievement",applicable_bean_tier:"silver",active:!0},{id:"act_04",name:"Training Completion",applicable_bean_tier:"any",active:!0},{id:"act_05",name:"Customer Recovery Handle",applicable_bean_tier:"silver",active:!0},{id:"act_06",name:"Outlet Opening Standard",applicable_bean_tier:"any",active:!0},{id:"act_07",name:"Special Initiative",applicable_bean_tier:"gold",active:!0}],pc=[{id:"off_01",name:"Late Arrival",base_db:1,escalation:"double",submission_cap:8,active:!0},{id:"off_02",name:"No-Show No Notice",base_db:5,escalation:"double",submission_cap:20,active:!0},{id:"off_03",name:"Negligence",base_db:2,escalation:"double",submission_cap:16,active:!0},{id:"off_04",name:"Duty Denial",base_db:3,escalation:"double",submission_cap:24,active:!0},{id:"off_05",name:"Misconduct",base_db:4,escalation:"double",submission_cap:32,active:!0},{id:"off_06",name:"Serious/Insubordination",base_db:10,escalation:"double",submission_cap:40,active:!0}],ur=[{id:"SHB",name:"Sarabha Nagar",brand:"Heebee Coffee"},{id:"GHB",name:"Ghumar Mandi",brand:"Heebee Coffee"},{id:"JLD",name:"Model Town, Jalandhar",brand:"Heebee Coffee"},{id:"POUR",name:"Pour by Heebee",brand:"Pour"}];function mc(n){return Ei.includes(n)}function hr(n){return Ci.includes(n)}function gc(n){return Ii.includes(n)}function dt(n){return n==="HR"}function re(n){return["CEO","COO","Owner"].includes(n)}function _c(n){const e={},t={};n.forEach(({giver_id:s,receiver_id:r,points_value:o})=>{e[s]=(e[s]||0)+o;const a=`${s}::${r}`;t[a]=(t[a]||0)+o});const i=[];return Object.entries(t).forEach(([s,r])=>{const[o,a]=s.split("::"),l=e[o]||0;l>0&&r/l>.6&&i.push({type:"bias_concentration",giver_id:o,receiver_id:a,pct:Math.round(r/l*100)})}),i}function vc(n){return n>=100?"disciplinary":n>=51?"owners_notified":n>=26?"suggest_disqualify":n>=10?"silent_flag":null}function yc(n){const e={green:0,silver:0,gold:0,crystal:0};return n.forEach(({bean_type:t})=>{e[t]!==void 0&&e[t]++}),Object.entries(e).filter(([,t])=>t>0).map(([t,i])=>`${he[t].icon} ${i}`).join(" · ")}const Ag=Object.freeze(Object.defineProperty({__proto__:null,ADMIN_ROLES:Ii,BEAN_TIERS:he,CONDUCT_TIERS:Tn,DB_POINTS_EACH:cs,DEFAULT_ACTIONS:fc,DEFAULT_OFFENSES:pc,GIVER_ROLES:Ci,OUTLETS:ur,RECEIVER_ROLES:Ei,ROLE_BEAN_PERMISSIONS:uc,ROLE_CONDUCT_PERMISSIONS:hc,checkBiasConcentration:_c,formatBeanCounts:yc,getDBThresholdLevel:vc,isAdmin:gc,isGiver:hr,isHR:dt,isOwner:re,isReceiver:mc},Symbol.toStringTag,{value:"Module"})),Ng=[...Ei,...Ci,...Ii];async function Pg(n){const e=new TextEncoder().encode(n),t=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(t)).map(i=>i.toString(16).padStart(2,"0")).join("")}function Og(n,e){n.innerHTML=`
  ...
  `,n.querySelector("#btn-logout").addEventListener("click",i);try{hr(e.role)?await Hg(n,e,s):gc(e.role)?await qg(n,e,s):await Bg(n,e,t,s)}catch(r){console.error("Dashboard error:",r),n.querySelector("#dash-loading").classList.remove("hidden"),n.querySelector("#dash-loading").innerHTML=`<div class="empty-state"><p style="color:var(--red);">Failed to load dashboard.</p><p class="text-dim text-sm mt-8">${r.message}</p></div>`}}async function Bg(n,e,t,i){const s=t.db_toggle===!0,[r,o,a,l]=await Promise.all([pn(e.id),mn(e.id),Fl(e.id),ae()]);n.querySelector("#dash-loading").classList.add("hidden");const c=n.querySelector("#dash-content");c.classList.remove("hidden"),vi(me(),I=>{const E=Fg(I),C=["Trainee","Barista","Senior Barista","Kitchen Helper","Commi 3","Commi 2","Commi 1","DCDP","CDP"],g=E.filter(k=>{const F=l[k.id]||{};return C.includes(F.role||"")}).findIndex(k=>k.id===e.id),_=c.querySelector("#nomination-banner");_&&(g>=0&&g<5?(_.innerHTML=`
          <div class="card mb-16" style="text-align:center;padding:20px 16px;background:rgba(201,168,76,0.1);border-color:rgba(201,168,76,0.5);position:relative;overflow:hidden;">
            ...
            <p class="text-dim text-sm">You're nominee #${g+1} this month — the team is voting for you!</p>
          </div>
        `,_.classList.remove("hidden")):(_.innerHTML="",_.classList.add("hidden")));const p=E.find(k=>k.id===e.id),w=c.querySelector("#my-rank");w&&p&&(w.textContent=`#${p.rank}`)});const d=a.slice(0,5),u=yc(a),f=e.name.split(" ").map(I=>I[0]).join("").slice(0,2).toUpperCase(),h=["#8B5E3C","#5E6E8B","#5E8B6E","#8B5E7A","#7A8B5E","#6E5E8B","#8B7A5E"],m=h[e.name.charCodeAt(0)%h.length];c.innerHTML=`
    <!-- Profile Photo -->
    ...
    ${d.length===0?'<div class="empty-state"><div class="icon">🫘</div><p>No beans yet this month</p></div>':d.map(I=>Wg(I)).join("")}
  `;const v=c.querySelector("#photo-upload"),b=c.querySelector("#photo-status");c.querySelector("#profile-hex"),v==null||v.addEventListener("change",async I=>{const E=I.target.files[0];if(E){b.textContent="Compressing…";try{const C=await Dg(E),L=Math.round(C.length/1024);await _i(e.id,{photo_url:C}),e.photo_url=C;const g=c.querySelector("#profile-hex");g&&(g.outerHTML=`<img id="profile-hex" src="${C}" style="width:64px;height:64px;clip-path:polygon(50% 0%,95% 25%,95% 75%,50% 100%,5% 75%,5% 25%);object-fit:cover;" />`),b.textContent=`✓ Saved (${L}KB)`,setTimeout(()=>{b.textContent=""},3e3)}catch(C){b.textContent="Failed. Try a smaller image.",console.error(C)}}})}async function Hg(n,e,t){var C,L,g,_;const i=["Owner","CEO","COO","HR"].includes(e.role),s=me(),[r,o,a,l,c,d,u,f]=await Promise.all([ar(e.id),ae(),gn(),ec(e.id),Nt(),i?bi():Promise.resolve({}),i?yi(s):Promise.resolve(null),i?_n(s):Promise.resolve({})]),h=Object.keys(f).length>0;n.querySelector("#dash-loading").classList.add("hidden");const m=n.querySelector("#dash-content");m.classList.remove("hidden");const v=me(),b=r.filter(p=>{const w=new Date(p.timestamp);return`${w.getFullYear()}-${String(w.getMonth()+1).padStart(2,"0")}`===v}),I=b.reduce((p,w)=>p+w.points_value*(w.quantity||1),0),E={green:0,silver:0,gold:0,crystal:0};b.forEach(p=>{E[p.bean_type]!==void 0&&E[p.bean_type]++}),m.innerHTML=`
    <div class="card mb-16" style="text-align:center;padding:28px 20px;">
      <p class="section-header" style="margin-bottom:4px;">Beans Given This Month</p>
      <div class="mono text-gold" style="font-size:3rem;font-weight:400;margin-bottom:4px;">
        ${b.length}
      </div>
      <p class="text-dim text-sm">${Je(I)} pts awarded to your team</p>
    </div>
  ...
  `,(C=m.querySelector("#btn-quick-award"))==null||C.addEventListener("click",()=>t("award")),(L=m.querySelector("#toggle-voting-pts"))==null||L.addEventListener("change",async p=>{const w=p.target.checked,k=p.target.nextElementSibling,F=k==null?void 0:k.querySelector("span");k&&(k.style.background=w?"var(--gold)":"var(--border)"),F&&(F.style.left=w?"23px":"3px"),await oc({voting_points_enabled:w})}),(g=m.querySelector("#btn-set-wildcard"))==null||g.addEventListener("click",async()=>{if(h)return;const p=m.querySelector("#wildcard-select"),w=p==null?void 0:p.value;if(!w)return;const k=m.querySelector("#btn-set-wildcard");k.disabled=!0,k.textContent="Saving…",await cr(s,{employee_id:w,nominated_by_id:e.id,nominated_by_name:e.name,nominated_at:Date.now()}),k.textContent="✓ Saved";const F=m.querySelector("#wildcard-status"),M=o[w];F&&(F.textContent=`⭐ ${(M==null?void 0:M.name)||w} is this month's wildcard nominee`),k.disabled=!1}),(_=m.querySelector("#btn-clear-wildcard"))==null||_.addEventListener("click",async()=>{if(h)return;const p=m.querySelector("#btn-clear-wildcard");p.disabled=!0,p.textContent="Clearing…",await dr(s),p.textContent="Cleared";const w=m.querySelector("#wildcard-status");w&&(w.textContent="No wildcard nominee set"),m.querySelector("#wildcard-select").value=""}),m.querySelectorAll(".btn-revoke-request").forEach(p=>{p.addEventListener("click",async()=>{const w=p.dataset.id,k=l.find(M=>M.id===w);if(!k)return;const F=prompt("Reason for revoking this conduct? (required)");if(!(!F||!F.trim())){p.disabled=!0,p.textContent="Requesting…";try{await tc({dark_bean_id:w,receiver_id:k.receiver_id,giver_id:e.id,giver_name:e.name,offense_id:k.offense_id,conduct_tier:k.conduct_tier,db_count:k.db_count,pts_deducted:k.pts_deducted,month_key:k.month_key,reason:F.trim()}),p.textContent="⏳ Pending Approval",p.style.color="var(--text-secondary)"}catch(M){p.disabled=!1,p.textContent="Request Revoke",console.error(M)}}})})}async function qg(n,e,t){var c,d,u,f;const i=me(),[s,r,o]=await Promise.all([ae(),yi(i),_n(i)]),a=Object.keys(o).length>0;n.querySelector("#dash-loading").classList.add("hidden");const l=n.querySelector("#dash-content");l.classList.remove("hidden"),l.innerHTML=`
  ...
  `}function zg(n){const e={green:0,silver:0,gold:0,crystal:0};return n.forEach(({bean_type:t})=>{e[t]!==void 0&&e[t]++}),Object.entries(e).filter(([,t])=>t>0).map(([t,i])=>`
    ...
    `).join("")}function Wg(n){const e=he[n.bean_type]||{icon:"🫘",label:n.bean_type};return`
    <div class="lb-row" style="margin-bottom:8px;">
      ...
      <div style="flex:1;">
        ...
        <p class="text-dim text-xs">${n.action_id||"Award"} · ${Xe(n.timestamp)}</p>
      </div>
    </div>
...
👤 From: ${i} · 📋 ${s}`})}async function e_(n,e,t){n.innerHTML=`
  ...
  `;let i=e.role==="HR"?"conduct":"award",s={},r={},o={},a=[];try{[s,r,o]=await Promise.all([ae(),gn(),Nt()]),a=Object.entries(s).map(([d,u])=>({id:d,...u})).filter(d=>mc(d.role)&&d.active!==!1).sort((d,u)=>d.name.localeCompare(u.name))}catch{n.querySelector("#award-content").innerHTML='<p class="text-dim text-sm text-center">Failed to load. Check connection.</p>';return}n.querySelectorAll(".award-tab").forEach(d=>{d.addEventListener("click",()=>{i=d.dataset.tab,n.querySelectorAll(".award-tab").forEach(u=>{u.className=u.dataset.tab===i?"btn btn-primary award-tab":"btn btn-ghost award-tab",u.style.flex="1",u.style.padding="10px"}),i==="award"?l():c()})}),e.role==="HR"?c():l();function l(){const d=n.querySelector("#award-content"),u=uc[e.role]||[],f=Object.entries(r).map(([_,p])=>({id:_,...p})).filter(_=>_.active!==!1);if(a.length===0){d.innerHTML=`
    ...
    `;const m=d.querySelector("#emp-list"),v=d.querySelector("#search-emp");let b=a;function I(){m.innerHTML=b.map(_=>{var p,w;return`
    ...
    `;const m=d.querySelector("#emp-list-c"),v=d.querySelector("#search-emp-c");let b=a;function I(){m.innerHTML=b.map(g=>{var _,p;return`
      ...
      `}).join(""),m.querySelectorAll(".emp-row-c").forEach(g=>{g.addEventListener("click",()=>{h.receiver=a.find(_=>_.id===g.dataset.id),I(),E()})})}v.addEventListener("input",()=>{const g=v.value.toLowerCase();b=g?a.filter(_=>_.name.toLowerCase().includes(g)):a,I()}),I(),d.querySelectorAll(".conduct-tier-btn").forEach(g=>{g.addEventListener("click",()=>{h.tier=g.dataset.type,d.querySelectorAll(".conduct-tier-btn").forEach(_=>{_.style.borderColor=_.dataset.type===h.tier?"rgba(255,69,58,0.6)":"var(--border)",_.style.background=_.dataset.type===h.tier?"rgba(255,69,58,0.1)":"var(--glass-bg)"}),E()})}),d.querySelectorAll(".offense-btn").forEach(g=>{g.addEventListener("click",()=>{h.offenseId=g.dataset.id,d.querySelectorAll(".offense-btn").forEach(_=>{_.style.background=_.dataset.id===h.offenseId?"rgba(255,69,58,0.12)":"",_.style.borderColor=_.dataset.id===h.offenseId?"rgba(255,69,58,0.4)":"",_.style.color=_.dataset.id===h.offenseId?"var(--red)":""}),E()})});async function E(){const g=d.querySelector("#conduct-preview"),_=d.querySelector("#btn-conduct-submit");if(!h.receiver||!h.tier||!h.offenseId){g.classList.add("hidden"),_.disabled=!0;return}g.innerHTML='<div class="spinner" style="margin:0 auto;"></div>',g.classList.remove("hidden");const p=Tn[h.tier],w=me(),k=await lr(h.receiver.id,w,h.offenseId)+1,F=Math.pow(2,k-1),M=p.base_db*F,A=M*cs,se=["1st","2nd","3rd","4th","5th"][k-1]||`${k}th`,Pt=f.find(pr=>pr.id===h.offenseId);g.innerHTML=`
        <p style="font-size:0.75rem;color:var(--text-secondary);margin-bottom:4px;">${h.receiver.name} · ${(Pt==null?void 0:Pt.name)||""}</p>
        <p style="font-size:0.8rem;color:var(--text-secondary);margin-bottom:12px;">
          ${se} offense this month
          ${k>1?`<span style="color:var(--red);"> · ${F}× escalation</span>`:""}
        </p>
        <div class="mono" style="font-size:2.2rem;color:var(--red);">${p.icon} ${M}</div>
        <p style="font-size:0.8rem;color:var(--text-secondary);margin-top:4px;">${p.label} · ${M} Dark Bean${M!==1?"s":""}</p>
        <p class="text-dim text-sm mt-8">= −${A} pts from monthly score</p>
      `,_.disabled=!1}const C=d.querySelector("#conduct-error"),L=d.querySelector("#btn-conduct-submit");L.addEventListener("click",async()=>{if(!(!h.receiver||!h.tier||!h.offenseId)){L.disabled=!0,L.textContent="Issuing…",C.classList.add("hidden");try{const g=me(),_=Mg(),p=Tn[h.tier],w=f.find(Ge=>Ge.id===h.offenseId),F=(await Bl(h.receiver.id,g)).filter(Ge=>Ge.offense_id===h.offenseId&&!Ge.revoked),M=await Hl(h.receiver.id,g,h.offenseId),A=Math.pow(2,M-1),j=p.base_db*A,se=j*cs;await Ul({giver_id:e.id,giver_name:e.name,receiver_id:h.receiver.id,offense_id:h.offenseId,conduct_tier:h.tier,db_count:j,pts_deducted:se,month_key:g,note:d.querySelector("#inp-conduct-note").value.trim(),instance:M,multiplier:A});const Pt=await Ql(h.receiver.id,j,se,g);await Jl(h.receiver.id,se),F.filter(Ge=>{const xi=new Date(Ge.timestamp),Cc=`${xi.getFullYear()}-${String(xi.getMonth()+1).padStart(2,"0")}-${String(xi.getDate()).padStart(2,"0")}`;return Ge.giver_id!==e.id&&Cc===_}).length>0&&await $t({type:"cross_conduct",receiver_id:h.receiver.id,giver_id:e.id,suggestion_text:`${h.receiver.name} received "${w==null?void 0:w.name}" conduct from multiple managers on the same day. Possible duplicate issuance.`,suggestion:"Confirm with both managers this is not a duplicate. Consider revoking one."}).catch(()=>{}),F.length>=3&&await $t({type:"conduct_frequency",receiver_id:h.receiver.id,giver_id:e.id,suggestion_text:`${h.receiver.name} has now received "${w==null?void 0:w.name}" conduct ${F.length+1} times this month.`,suggestion:"High frequency of same conduct. Escalate to formal HR review or disciplinary process."}).catch(()=>{});const mr=Pt.db_count||0,Si=vc(mr);Si&&await $t({type:"db_threshold",receiver_id:h.receiver.id,giver_id:e.id,suggestion_text:`${h.receiver.name} has accumulated ${mr} Dark Beans this month (${Si.replace(/_/g," ")}).`,suggestion:Si==="disciplinary"?"Consider formal disciplinary action.":"Review conduct history and consider counselling."}).catch(()=>{}),d.innerHTML=`
          <div class="text-center" style="padding:60px 20px;">
            ...
            <p class="text-dim text-sm mt-4">${(w==null?void 0:w.name)||""} · ${p.label}${M>1?` · ${A}× escalation`:""}</p>
        ...
        `,d.querySelector("#btn-conduct-again").addEventListener("click",c)}catch(g){C.textContent="Failed to submit. Try again.",C.classList.remove("hidden"),L.disabled=!1,L.textContent="Issue Conduct",console.error(g)}}})}}async function t_(n,e,t){const i=re(e.role);n.innerHTML=`
    <div class="page">
  ...
  `;let s="flags";const r=n.querySelector("#audit-content");n.querySelectorAll(".audit-tab").forEach(u=>{u.addEventListener("click",()=>{s=u.dataset.tab,n.querySelectorAll(".audit-tab").forEach(f=>{f.className=f.dataset.tab===s?"btn btn-primary audit-tab":"btn btn-ghost audit-tab",f.style.flex="1",f.style.padding="10px"}),o(s)})});async function o(u){r.innerHTML='<div class="loading-center" style="min-height:30vh;"><div class="spinner"></div></div>',u==="flags"&&await a(),u==="log"&&await l(),u==="votes"&&await c(),u==="reset"&&d()}async function a(){try{const[u,f]=await Promise.all([Vl(),ae()]),h=u.filter(v=>v.status==="open"),m=u.filter(v=>v.status!=="open");if(!u.length){r.innerHTML=`
        ...
        `:""}
      `,r.querySelectorAll(".flag-action-btn").forEach(v=>{v.addEventListener("click",async()=>{const{flagId:b,action:I}=v.dataset;v.disabled=!0,await Wl(b,I,e.id),await o("flags")})})}catch{r.innerHTML='<p class="text-dim text-sm text-center">Failed to load flags.</p>'}}async function l(){try{const u="https://who-s-the-queen-bee-default-rtdb.asia-southeast1.firebasedatabase.app",[f,h,m,v,b,I]=await Promise.all([ae(),gn(),Nt(),fetch(`${u}/awards.json`).then(p=>p.json()),fetch(`${u}/dark_beans.json`).then(p=>p.json()),fetch(`${u}/revoke_log.json`).then(p=>p.json())]),E=v?Object.entries(v).map(([p,w])=>({id:p,kind:"award",...w})):[],C=b?Object.entries(b).map(([p,w])=>({id:p,kind:"conduct",...w})):[],L=I?Object.entries(I).map(([p,w])=>({id:p,kind:"revoke",...w})):[],g=[...E,...C,...L].sort((p,w)=>w.timestamp-p.timestamp);if(!g.length){r.innerHTML=`
          <div class="empty-state">
            <div class="icon">📋</div>
        ...
        ${g.map(p=>{const w=f[p.receiver_id],k=f[p.giver_id],F=(k==null?void 0:k.name)||p.giver_name||p.giver_id||"—",M=(k==null?void 0:k.role)||"";if(p.kind==="award"){const A=he[p.bean_type]||{icon:"🫘",label:p.bean_type},j=h[p.action_id],se=p.points_value*(p.quantity||1);return`
              <div class="lb-row" style="margin-bottom:8px;flex-direction:column;align-items:flex-start;gap:6px;">
                ...
                <div style="display:flex;justify-content:space-between;width:100%;">
                  <p class="text-dim" style="font-size:0.75rem;">
                    By <span style="color:var(--text-secondary);font-weight:600;">${F}</span>
            ...
            `}else if(p.kind==="revoke"){const A=f[p.receiver_id],j=m[p.offense_id],se=_[p.conduct_tier]||"🌑";return`
              <div class="lb-row" style="margin-bottom:8px;flex-direction:column;align-items:flex-start;gap:6px;border-color:rgba(48,209,88,0.25);background:rgba(48,209,88,0.03);">
                <div style="display:flex;justify-content:space-between;align-items:center;width:100%;">
                  <div style="display:flex;align-items:center;gap:10px;">
                    ...
                    <div>
                      <p style="font-size:0.9rem;font-weight:600;">${(A==null?void 0:A.name)||p.receiver_id} <span style="font-size:0.72rem;color:var(--green);font-weight:400;">· conduct revoked</span></p>
                      <p class="text-dim" style="font-size:0.75rem;">${(A==null?void 0:A.role)||""} · ${(A==null?void 0:A.outlet)||""}</p>
                    </div>
                  </div>
            ...
            `}else{const A=m[p.offense_id],j=_[p.conduct_tier]||"🌑",se=p.revoked?'<span style="color:var(--text-tertiary);font-size:0.7rem;"> · revoked</span>':"";return`
              <div class="lb-row" style="margin-bottom:8px;flex-direction:column;align-items:flex-start;gap:6px;${p.revoked?"opacity:0.45;":"border-color:rgba(255,69,58,0.25);"}">
                ...
                <div style="display:flex;justify-content:space-between;width:100%;">
                  <p class="text-dim" style="font-size:0.75rem;">
                    By <span style="color:var(--text-secondary);font-weight:600;">${F}</span>
                    <span style="color:var(--text-tertiary);"> (${M})</span>
                    · ${(A==null?void 0:A.name)||p.offense_id||"Conduct"}
                    ${p.note?`· "${p.note}"`:""}
        ...
        `:`
          ...
          ${C.map((g,_)=>{const p=b>0?Math.round(g.count/b*100):0;return`
              <div class="lb-row mb-8" style="flex-direction:column;align-items:stretch;gap:8px;padding:14px;">
                <div style="display:flex;align-items:center;gap:10px;">
                  <span style="font-size:1.2rem;min-width:28px;">${L[_]||`#${_+1}`}</span>
                  <div style="flex:1;">
            ...
            <div class="card" style="margin-bottom:12px;border-color:rgba(255,69,58,0.25);" data-id="${v.id}">
              <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px;">
                <div>
                  ...
                  <p class="text-dim text-sm">${(I==null?void 0:I.name)||v.offense_id} · ${m[v.conduct_tier]||v.conduct_tier}</p>
                </div>
  ...
  `;const s=n.querySelector("#vote-content");try{const[r,o,a,l]=await Promise.all([ae(),xn(t,e.id),bi(),yi(t)]),c=vi(t,f=>{u(f,r,o)}),d=new MutationObserver(()=>{document.contains(s)||(c(),d.disconnect())});d.observe(document.body,{childList:!0,subtree:!0});async function u(f,h,m){const v=Object.entries(f).map(([g,_])=>({id:g,..._,emp:h[g]||{}})).filter(g=>g.emp.active!==!1&&g.emp.role&&d_(g.emp.role)).sort((g,_)=>(_.net_points||_.points||0)-(g.net_points||g.points||0)).slice(0,5).map((g,_)=>({...g,rank:_+1}));let b=v.map(g=>l&&l.employee_id&&g.id===l.employee_id?{...g,isWildcard:!0,wildcardNominatedBy:l.nominated_by_name}:g);if(l&&l.employee_id&&!v.find(g=>g.id===l.employee_id)){const g=h[l.employee_id]||{},_=f[l.employee_id]||{};b.push({id:l.employee_id,emp:g,net_points:_.net_points||_.points||0,rank:6,isWildcard:!0,wildcardNominatedBy:l.nominated_by_name})}if(b.length===0){s.innerHTML=`
        ...
        `;return}const I=re(e.role)?await _n(t):{},E={};Object.values(I).forEach(g=>{E[g]=(E[g]||0)+1});const C=Object.values(E).reduce((g,_)=>g+_,0),L=!!m||await xn(t,e.id);s.innerHTML=`
        ${L?`
        ...
        `}
        ${b.map(g=>c_(g,!L,m,re(e.role),E,C)).join("")}
        ${re(e.role)?`
        ...
        `:""}
      `,!L&&i&&s.querySelectorAll(".nominee-vote-btn").forEach(g=>{g.addEventListener("click",async()=>{const _=g.dataset.id;g.disabled=!0;try{const p=await xn(t,e.id);await zl(t,e.id,_),!p&&a.voting_points_enabled!==!1&&await Promise.all([rr(e.id,25),or(e.id,25)]),u(f,h,_)}catch(p){g.disabled=!1,console.error(p)}})}),re(e.role)&&Object.keys(I).length>0&&s.querySelectorAll(".nominee-card-wrap").forEach(g=>{g.style.cursor="pointer",g.addEventListener("click",()=>{const _=g.dataset.nomineeId,p=h[_]||{},w=Object.entries(I).filter(([,A])=>A===_).map(([A])=>A),k=w.map(A=>{var j;return((j=h[A])==null?void 0:j.name)||A}),F=s.querySelector(".voter-modal");F&&F.remove();const M=document.createElement("div");M.className="voter-modal",M.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:999;display:flex;align-items:flex-end;",M.innerHTML=`
              <div style="background:var(--card-bg);border-radius:20px 20px 0 0;width:100%;max-height:70vh;overflow-y:auto;padding:20px;">
                ...
                ${k.length===0?'<p class="text-dim text-sm">No votes yet.</p>':k.map((A,j)=>`
                    <div class="lb-row" style="margin-bottom:6px;">
                      <span style="font-size:0.8rem;color:var(--text-tertiary);width:24px;">${j+1}</span>
                      <p style="font-size:0.9rem;">${A}</p>
                    </div>
                  `).join("")}
              </div>
            `,M.querySelector(".close-modal").addEventListener("click",()=>M.remove()),M.addEventListener("click",A=>{A.target===M&&M.remove()}),document.body.appendChild(M)})})}}catch{s.innerHTML='<p class="text-dim text-sm text-center">Failed to load. Check connection.</p>'}}function c_(n,e,t,i,s,r){var b;const o=n.net_points||n.points||0,a=n.emp,l=n.rank===1&&!n.isWildcard,c=s[n.id]||0,d=r>0?Math.round(c/r*100):0,u=(a.name||"??").split(" ").map(I=>I[0]).join("").slice(0,2).toUpperCase(),f=["#8B5E3C","#5E6E8B","#5E8B6E","#8B5E7A","#7A8B5E","#6E5E8B","#8B7A5E"],h=f[(a.name||"").charCodeAt(0)%f.length],m={1:"👑",2:"🥈",3:"🥉"},v=n.isWildcard?"⭐":m[n.rank]||`#${n.rank}`;return`
