 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const On=new hs("@firebase/auth");function ou(n,...e){On.logLevel<=D.WARN&&On.warn(`Auth (${St}): ${n}`,...e)}function wn(n,...e){On.logLevel<=D.ERROR&&On.error(`Auth (${St}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Un extends qa{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!us()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Un}getInitialEvent(e){return v(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const t of e.values())this.sendListen_(t);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let t="js";e["sdk."+t+"."+ba.replace(/\./g,"-")]=1,us()?e["framework.cordova"]=1:Oo()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=Un.getInstance().currentlyOnline();return Bi(this.interruptReasons_)&&e}}Ee.nextPersistentConnectionId_=0;Ee.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oi{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new A(_t,e),s=new A(_t,t);return this.compare(i,s)!==0}minPost(){return A.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Mi;const rt={};class we{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return v(rt&&j,"ChildrenNode.ts has not been loaded"),Mi=Mi||new we({".priority":rt},{".priority":j}),Mi}get(e){const t=mt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof ne?t:null}hasIndex(e){return ge(this.indexSet_,e.toString())}addIndex(e,t){v(e!==pt,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(A.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=Bn(i,e.getCompare()):a=rt;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const u=Object.assign({},this.indexes_);return u[l]=a,new we(u,c)}addToIndexes(e,t){const i=An(this.indexes_,(s,r)=>{const o=mt(this.indexSet_,r);if(v(o,"Missing index implementation for "+r),s===rt)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(A.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),Bn(a,o.getCompare())}else return rt;else{const a=t.get(e.name);let l=s;return a&&(l=l.remove(new A(e.name,a))),l.insert(e,e.node)}});return new we(i,this.indexSet_)}removeFromIndexes(e,t){const i=An(this.indexes_,s=>{if(s===rt)return s;{const r=t.get(e.name);return r?s.remove(new A(e.name,r)):s}});return new we(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fp extends oi{compare(e,t){const i=e.node.compareTo(t.node);return i===0?nt(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return A.MIN}maxPost(){return A.MAX}makePost(e,t){const i=W(e);return new A(t,i)}toString(){return".value"}}const pp=new fp;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qn(){return{value:null,children:new Map}}function Ja(n,e,t){if(N(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const i=R(e);n.children.has(i)||n.children.set(i,qn());const s=n.children.get(i);e=H(e),Ja(s,e,t)}}function Xi(n,e,t){n.value!==null?t(e,n.value):yp(n,(i,s)=>{const r=new M(e.toString()+"/"+i);Xi(s,r,t)})}function yp(n,e){n.children.forEach((t,i)=>{e(i,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=ce.ACK_USER_WRITE,this.source=Ls()}operationForChild(e){if(N(this.path)){if(this.affectedTree.value!=null)return v(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new M(e));return new jn(O(),t,this.revert)}}else return v(R(this.path)===e,"operationForChild called for unrelated child."),new jn(H(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Yn;function dm(n){v(!Yn,"__referenceConstructor has already been defined"),Yn=n}function um(){return v(Yn,"Reference.ts has not been loaded"),Yn}let hm=1;class vo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new B(null),this.pendingWriteTree_=Hp(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function hl(n,e,t,i,s){return Rp(n.pendingWriteTree_,e,t,i,s),s?kt(n,new et(Ls(),e,t)):[]}function fm(n,e,t,i){Ap(n.pendingWriteTree_,e,t,i);const s=B.fromObject(t);return kt(n,new yt(Ls(),e,s))}function Le(n,e,t=!1){const i=Np(n.pendingWriteTree_,e);if(Pp(n.pendingWriteTree_,e)){let r=new B(null);return i.snap!=null?r=r.set(O(),!0):Q(i.children,o=>{r=r.set(new M(o),!0)}),kt(n,new jn(i.path,r,t))}else return[]}function dn(n,e,t){return kt(n,new et(Ds(),e,t))}function pm(n,e,t){const i=B.fromObject(t);return kt(n,new yt(Ds(),e,i))}function mm(n,e){return kt(n,new Jt(Ds(),e))}function gm(n,e,t){const i=qs(n,t);if(i){const s=js(i),r=s.path,o=s.queryId,a=J(r,e),l=new Jt(Ms(o),a);return zs(n,r,l)}else return[]}function Qn(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||ul(o,e))){const l=cm(o,e,t,i);am(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const u=c.findIndex(f=>f._queryParams.loadsAllData())!==-1,d=n.syncPointTree_.findOnPath(r,(f,h)=>ze(h));if(u&&!d){const f=n.syncPointTree_.subtree(r);if(!f.isEmpty()){const h=ym(f);for(let _=0;_<h.length;++_){const g=h[_],b=g.query,S=gl(n,g);n.listenProvider_.startListening(qt(b),Xt(n,b),S.hashFn,S.onComplete)}}}!d&&c.length>0&&!i&&(u?n.listenProvider_.stopListening(qt(e),null):c.forEach(f=>{const h=n.queryToTagMap.get(di(f));n.listenProvider_.stopListening(qt(f),h)}))}bm(n,c)}return a}function fl(n,e,t,i){const s=qs(n,i);if(s!=null){const r=js(s),o=r.path,a=r.queryId,l=J(o,e),c=new et(Ms(a),l,t);return zs(n,o,c)}else return[]}function _m(n,e,t,i){const s=qs(n,i);if(s){const r=js(s),o=r.path,a=r.queryId,l=J(o,e),c=B.fromObject(t),u=new yt(Ms(a),l,c);return zs(n,o,u)}else return[]}function ss(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(f,h)=>{const _=J(f,s);r=r||Be(h,_),o=o||ze(h)});let a=n.syncPointTree_.get(s);a?(o=o||ze(a),r=r||Be(a,O())):(a=new al,n.syncPointTree_=n.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=x.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((h,_)=>{const g=Be(_,O());g&&(r=r.updateImmediateChild(h,g))}));const c=ul(a,e);if(!c&&!e._queryParams.loadsAllData()){const f=di(e);v(!n.queryToTagMap.has(f),"View does not exist, but we have a tag");const h=wm();n.queryToTagMap.set(f,h),n.tagToQueryMap.set(h,f)}const u=li(n.pendingWriteTree_,s);let d=lm(a,e,t,u,r,l);if(!c&&!o&&!i){const f=dl(a,e);d=d.concat(Em(n,e,f))}return d}function Hs(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=J(o,e),c=Be(a,l);if(c)return c});return tl(s,e,r,t,!0)}function vm(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(c,u)=>{const d=J(c,t);i=i||Be(u,d)});let s=n.syncPointTree_.get(t);s?i=i||Be(s,O()):(s=new al,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new je(i,!0,!1):null,a=li(n.pendingWriteTree_,e._path),l=ll(s,e,a,r?o.getNode():x.EMPTY_NODE,r);return tm(l)}function kt(n,e){return pl(e,n.syncPointTree_,null,li(n.pendingWriteTree_,O()))}function pl(n,e,t,i){if(N(n.path))return ml(n,e,t,i);{const s=e.get(O());t==null&&s!=null&&(t=Be(s,O()));let r=[];const o=R(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,u=nl(i,o);r=r.concat(pl(a,l,c,u))}return s&&(r=r.concat(Bs(s,n,i,t))),r}}function ml(n,e,t,i){const s=e.get(O());t==null&&s!=null&&(t=Be(s,O()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=nl(i,o),u=n.operationForChild(o);u&&(r=r.concat(ml(u,a,l,c)))}),s&&(r=r.concat(Bs(s,n,i,t))),r}function gl(n,e){const t=e.query,i=Xt(n,t);return{hashFn:()=>(em(e)||x.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?gm(n,t._path,i):mm(n,t._path);{const r=mf(s,t);return Qn(n,t,null,r)}}}}function Xt(n,e){const t=di(e);return n.queryToTagMap.get(t)}function di(n){return n._path.toString()+"$"+n._queryIdentifier}function qs(n,e){return n.tagToQueryMap.get(e)}function js(n){const e=n.indexOf("$");return v(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new M(n.substr(0,e))}}function zs(n,e,t){const i=n.syncPointTree_.get(e);v(i,"Missing sync point for query tag that we're tracking");const s=li(n.pendingWriteTree_,e);return Bs(i,t,s,null)}function ym(n){return n.fold((e,t,i)=>{if(t&&ze(t))return[ci(t)];{let s=[];return t&&(s=cl(t)),Q(i,(r,o)=>{s=s.concat(o)}),s}})}function qt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(um())(n._repo,n._path):n}function bm(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=di(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function wm(){return hm++}function Em(n,e,t){const i=e._path,s=Xt(n,e),r=gl(n,t),o=n.listenProvider_.startListening(qt(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)v(!ze(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,d)=>{if(!N(c)&&u&&ze(u))return[ci(u).query];{let f=[];return u&&(f=f.concat(cl(u).map(h=>h.query))),Q(d,(h,_)=>{f=f.concat(_)}),f}});for(let c=0;c<l.length;++c){const u=l[c];n.listenProvider_.stopListening(qt(u),Xt(n,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
👤 From: ${i} · 📋 ${s}`})}async function e_(n,e,t){n.innerHTML=`
  ...
  `}function n_(n){if(n.data_snapshot){const e=n.data_snapshot;return`Giver: ${e.giverName||n.giver_id} · Receiver: ${e.receiverName||n.receiver_id}`}return`Flag ID: ${n.id}`}const i_=[..._n,...Ei,...Ci];function s_(n,e){const t=se(e.role)||e.role==="HR";n.innerHTML=`
    <div class="page">
...
//# sourceMappingURL=index-9Uffqp7-.js.map
