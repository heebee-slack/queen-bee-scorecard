 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const m=function(n,e){if(!n)throw _t(e)},_t=function(n){return new Error("Firebase Database ("+ho.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ic="FirebaseError";class Be extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=Ic,Object.setPrototypeOf(this,Be.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Jt.prototype.create)}}class Jt{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?Cc(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Be(s,a,i)}}function Cc(n,e){return n.replace(Sc,(t,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const Sc=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ft(n){return JSON.parse(n)}function H(n){return JSON.stringify(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bo=function(n){let e={},t={},i={},s="";try{const r=n.split(".");e=Ft(yn(r[0])||""),t=Ft(yn(r[1])||""),s=r[2],i=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:i,signature:s}},Tc=function(n){const e=bo(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},xc=function(n){const e=bo(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const En=new Map,kd=new Map,Di=new Map;function ar(n,e){try{n.container.addComponent(e)}catch(t){ye.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function ut(n){const e=n.name;if(Di.has(e))return ye.debug(`There were multiple attempts to register component ${e}.`),!1;Di.set(e,n);for(const t of En.values())ar(t,n);for(const t of kd.values())ar(t,n);return!0}function os(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function fe(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yt=Td;function Io(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i=Object.assign({name:Li,automaticDataCollectionEnabled:!1},e),s=i.name;if(typeof s!="string"||!s)throw Ne.create("bad-app-name",{appName:String(s)});if(t||(t=_o()),!t)throw Ne.create("no-options");const r=En.get(s);if(r){if(wn(t,r.options)&&wn(i,r.config))return r;throw Ne.create("duplicate-app",{appName:s})}const o=new Mc(s);for(const l of Di.values())o.addComponent(l);const a=new Rd(t,i,o);return En.set(s,a),a}function Co(n=Li){const e=En.get(n);if(!e&&n===Li&&_o())return Io();if(!e)throw Ne.create("no-app",{appName:n});return e}function Pe(n,e,t){var i;let s=(i=xd[n])!==null&&i!==void 0?i:n;t&&(s+=`-${t}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ye.warn(a.join(" "));return}ut(new ze(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nd="firebase-heartbeat-database",Pd=1,Ut="firebase-heartbeat-store";let bi=null;function So(){return bi||(bi=Yc(Nd,Pd,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ut)}catch(t){console.warn(t)}}}}).catch(n=>{throw Ne.create("idb-open",{originalErrorMessage:n.message})})),bi}async function Od(n){try{const t=(await So()).transaction(Ut),i=await t.objectStore(Ut).get(To(n));return await t.done,i}catch(e){if(e instanceof Be)ye.warn(e.message);else{const t=Ne.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ye.warn(t.message)}}}async function lr(n,e){try{const i=(await So()).transaction(Ut,"readwrite");await i.objectStore(Ut).put(e,To(n)),await i.done}catch(t){if(t instanceof Be)ye.warn(t.message);else{const i=Ne.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});ye.warn(i.message)}}}function To(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ud(n){ut(new ze("platform-logger",e=>new Xc(e),"PRIVATE")),ut(new ze("heartbeat",e=>new Md(e),"PRIVATE")),Pe(Oi,or,n),Pe(Oi,or,"esm2017"),Pe("fire-js","")}Ud("");var Bd="firebase",Hd="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Pe(Bd,Hd,"app");function as(n,e){var t={};for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&e.indexOf(i)<0&&(t[i]=n[i]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,i=Object.getOwnPropertySymbols(n);s<i.length;s++)e.indexOf(i[s])<0&&Object.prototype.propertyIsEnumerable.call(n,i[s])&&(t[i[s]]=n[i[s]]);return t}function xo(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const qd=xo,ko=new Jt("auth","Firebase",xo());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const In=new ss("@firebase/auth");function Wd(n,...e){In.logLevel<=O.WARN&&In.warn(`Auth (${yt}): ${n}`,...e)}function hn(n,...e){In.logLevel<=O.ERROR&&In.error(`Auth (${yt}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function be(n,...e){throw ls(n,...e)}function ce(n,...e){return ls(n,...e)}function Ao(n,e,t){const i=Object.assign(Object.assign({},qd()),{[e]:t});return new Jt("auth","Firebase",i).create(e,{appName:n.name})}function Oe(n){return Ao(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function ls(n,...e){if(typeof n!="string"){const t=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=n.name),n._errorFactory.create(t,...i)}return ko.create(n,...e)}function I(n,e,...t){if(!n)throw ls(e,...t)}function pe(n){const e="INTERNAL ASSERTION FAILED: "+n;throw hn(e),new Error(e)}function we(n,e){n||pe(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xt{constructor(e,t){this.shortDelay=e,this.longDelay=t,we(t>e,"Short delay should be less than long delay!"),this.isMobile=is()||yo()}get(){return Vd()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kd=new Xt(3e4,6e4);function Vn(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function bt(n,e,t,i,s={}){return No(n,s,async()=>{let r={},o={};i&&(e==="GET"?o=i:r={body:JSON.stringify(i)});const a=vt(Object.assign({key:n.config.apiKey},o)).slice(1),l=await n._getAdditionalHeaders();l["Content-Type"]="application/json",n.languageCode&&(l["X-Firebase-Locale"]=n.languageCode);const c=Object.assign({method:e,headers:l},r);return _c()||(c.referrerPolicy="no-referrer"),Ro.fetch()(Oo(n,n.config.apiHost,t,a),c)})}async function No(n,e,t){n._canInitEmulator=!1;const i=Object.assign(Object.assign({},Gd),e);try{const s=new Yd(n),r=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw cn(n,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[l,c]=a.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw cn(n,"credential-already-in-use",o);if(l==="EMAIL_EXISTS")throw cn(n,"email-already-in-use",o);if(l==="USER_DISABLED")throw cn(n,"user-disabled",o);const d=i[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(c)throw Ao(n,d,c);be(n,d)}}catch(s){if(s instanceof Be)throw s;be(n,"network-request-failed",{message:String(s)})}}async function Po(n,e,t,i,s={}){const r=await bt(n,e,t,i,s);return"mfaPendingCredential"in r&&be(n,"multi-factor-auth-required",{_serverResponse:r}),r}function Oo(n,e,t,i){const s=`${e}${t}?${i}`;return n.config.emulator?cs(n.config,s):`${n.config.apiScheme}://${s}`}class Yd{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,i)=>{this.timer=setTimeout(()=>i(ce(this.auth,"network-request-failed")),Kd.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function cn(n,e,t){const i={appName:n.name};t.email&&(i.email=t.email),t.phoneNumber&&(i.phoneNumber=t.phoneNumber);const s=ce(n,e,i);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qd(n,e){return bt(n,"POST","/v1/accounts:delete",e)}async function Lo(n,e){return bt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pt(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Jd(n,e=!1){const t=J(n),i=await t.getIdToken(e),s=ds(i);I(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:Pt(wi(s.auth_time)),issuedAtTime:Pt(wi(s.iat)),expirationTime:Pt(wi(s.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function wi(n){return Number(n)*1e3}function ds(n){const[e,t,i]=n.split(".");if(e===void 0||t===void 0||i===void 0)return hn("JWT malformed, contained fewer than 3 sections"),null;try{const s=yn(t);return s?JSON.parse(s):(hn("Failed to decode base64 JWT payload"),null)}catch(s){return hn("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function hr(n){const e=ds(n);return I(e,"internal-error"),I(typeof e.exp<"u","internal-error"),I(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bt(n,e,t=!1){if(t)return e;try{return await e}catch(i){throw i instanceof Be&&Xd(i)&&n.auth.currentUser===n&&await n.auth.signOut(),i}}function Xd({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nu(n,e){const t=await No(n,{},async()=>{const i=vt({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=n.config,o=Oo(n,s,"/v1/token",`key=${r}`),a=await n._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Ro.fetch()(o,{method:"POST",headers:a,body:i})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function iu(n,e){return bt(n,"POST","/v2/accounts:revokeToken",Vn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rt{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){I(e.idToken,"internal-error"),I(typeof e.idToken<"u","internal-error"),I(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):hr(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){I(e.length!==0,"internal-error");const t=hr(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(I(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:i,refreshToken:s,expiresIn:r}=await nu(e,t);this.updateTokensAndExpiration(i,s,Number(r))}updateTokensAndExpiration(e,t,i){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+i*1e3}static fromJSON(e,t){const{refreshToken:i,accessToken:s,expirationTime:r}=t,o=new rt;return i&&(I(typeof i=="string","internal-error",{appName:e}),o.refreshToken=i),s&&(I(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),r&&(I(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new rt,this.toJSON())}_performRefresh(){return pe("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fn(n,e,t){return`firebase:${n}:${e}:${t}`}class ot{constructor(e,t,i){this.persistence=e,this.auth=t,this.userKey=i;const{config:s,name:r}=this.auth;this.fullUserKey=fn(this.userKey,s.apiKey,r),this.fullPersistenceKey=fn("persistence",s.apiKey,r),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?me._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,i="authUser"){if(!t.length)return new ot(ge(pr),e,i);const s=(await Promise.all(t.map(async c=>{if(await c._isAvailable())return c}))).filter(c=>c);let r=s[0]||ge(pr);const o=fn(i,e.config.apiKey,e.name);let a=null;for(const c of t)try{const d=await c._get(o);if(d){const u=me._fromJSON(e,d);c!==r&&(a=u),r=c;break}}catch{}const l=s.filter(c=>c._shouldAllowMigration);return!r._shouldAllowMigration||!l.length?new ot(r,e,i):(r=l[0],a&&await r._set(o,a.toJSON()),await Promise.all(t.map(async c=>{if(c!==r)try{await c._remove(o)}catch{}})),new ot(r,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vo(n,e=[]){let t;switch(n){case"Browser":t=mr(Y());break;case"Worker":t=`${mr(Y())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${yt}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function au(n,e={}){return bt(n,"GET","/v2/passwordPolicy",Vn(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mu(n,e){const t=os(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),r=t.getOptions();if(wn(r,e??{}))return s;be(s,"already-initialized")}return t.initialize({options:e})}function gu(n,e){const t=(e==null?void 0:e.persistence)||[],i=(Array.isArray(t)?t:[t]).map(ge);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}function _u(n,e,t){const i=zn(n);I(i._canInitEmulator,i,"emulator-config-failed"),I(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const s=!1,r=zo(e),{host:o,port:a}=vu(e),l=a===null?"":`:${a}`;i.config.emulator={url:`${r}//${o}${l}/`},i.settings.appVerificationDisabledForTesting=!0,i.emulatorConfig=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:s})}),yu()}function zo(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function vu(n){const e=zo(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const i=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const r=s[1];return{host:r,port:_r(i.substr(r.length+1))}}else{const[r,o]=i.split(":");return{host:r,port:_r(o)}}}function _r(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function yu(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function at(n,e){return Po(n,"POST","/v1/accounts:signInWithIdp",Vn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke extends Zt{constructor(){super("twitter.com")}static credential(e,t){return Ge._fromParams({providerId:ke.PROVIDER_ID,signInMethod:ke.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return ke.credentialFromTaggedObject(e)}static credentialFromError(e){return ke.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:i}=e;if(!t||!i)return null;try{return ke.credential(t,i)}catch{return null}}}ke.TWITTER_SIGN_IN_METHOD="twitter.com";ke.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sn extends Be{constructor(e,t,i,s){var r;super(t.code,t.message),this.operationType=i,this.user=s,Object.setPrototypeOf(this,Sn.prototype),this.customData={appName:e.name,tenantId:(r=e.tenantId)!==null&&r!==void 0?r:void 0,_serverResponse:t.customData._serverResponse,operationType:i}}static _fromErrorAndOperation(e,t,i,s){return new Sn(e,t,i,s)}}function Yo(n,e,t,i){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(r=>{throw r.code==="auth/multi-factor-auth-required"?Sn._fromErrorAndOperation(n,r,e,i):r})}async function Iu(n,e,t=!1){const i=await Bt(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return Me._forOperation(n,"link",i)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qo{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Tn,"1"),this.storage.removeItem(Tn),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ku="pendingRedirect",pn=new Map;class Yu extends sa{constructor(e,t,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,i),this.eventId=null}async execute(){let e=pn.get(this.auth._key());if(!e){try{const i=await Qu(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(t){e=()=>Promise.reject(t)}pn.set(this.auth._key(),e)}return this.bypassAuthState||pn.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Qu(n,e){const t=Zu(e),i=Xu(n);if(!await i._isAvailable())return!1;const s=await i._get(t)==="true";return await i._remove(t),s}function Ju(n,e){pn.set(n._key(),e)}function Xu(n){return ge(n._redirectPersistence)}function Zu(n){return fn(Ku,n.config.apiKey,n.name)}async function eh(n,e,t=!1){if(fe(n.app))return Promise.reject(Oe(n));const i=zn(n),s=Wu(i,e),o=await new Yu(i,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sh(n,e={}){return bt(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ch=new Xt(3e4,6e4);function Er(){const n=de().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function dh(n){return new Promise((e,t)=>{var i,s,r;function o(){Er(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Er(),t(ce(n,"network-request-failed"))},timeout:ch.get()})}if(!((s=(i=de().gapi)===null||i===void 0?void 0:i.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((r=de().gapi)===null||r===void 0)&&r.load)o();else{const a=pu("iframefcb");return de()[a]=()=>{gapi.load?o():t(ce(n,"network-request-failed"))},hu(`${fu()}?onload=${a}`).catch(l=>t(l))}}).catch(e=>{throw mn=null,e})}let mn=null;function uh(n){return mn=mn||dh(n),mn}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hh=new Xt(5e3,15e3),fh="__/auth/iframe",ph="emulator/auth/iframe",mh={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},gh=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function _h(n){const e=n.config;I(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?cs(e,ph):`https://${n.config.authDomain}/${fh}`,i={apiKey:e.apiKey,appName:n.name,v:yt},s=gh.get(n.config.apiHost);s&&(i.eid=s);const r=n._getFrameworks();return r.length&&(i.fw=r.join(",")),`${t}?${vt(i).slice(1)}`}async function vh(n){const e=await uh(n),t=de().gapi;return I(t,n,"internal-error"),e.open({where:document.body,url:_h(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:mh,dontclear:!0},i=>new Promise(async(s,r)=>{await i.restyle({setHideOnLeave:!1});const o=ce(n,"network-request-failed"),a=de().setTimeout(()=>{r(o)},hh.get());function l(){de().clearTimeout(a),s(i)}i.ping(l).then(l,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Th="__/auth/handler",xh="emulator/auth/handler",kh=encodeURIComponent("fac");async function Cr(n,e,t,i,s,r){I(n.config.authDomain,n,"auth-domain-config-required"),I(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:yt,eventId:s};if(e instanceof Ko){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Ri(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,u]of Object.entries({}))o[d]=u}if(e instanceof Zt){const d=e.getScopes().filter(u=>u!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const d of Object.keys(a))a[d]===void 0&&delete a[d];const l=await n._getAppCheckToken(),c=l?`#${kh}=${encodeURIComponent(l)}`:"";return`${Ah(n)}?${vt(a).slice(1)}${c}`}function Ah({config:n}){return n.emulator?cs(n,xh):`https://${n.authDomain}/${Th}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lt=new ss("@firebase/database"),jh=function(){let n=1;return function(){return n++}}(),la=function(n){const e=Pc(n),t=new kc;t.update(e);const i=t.digest();return ts.encodeByteArray(i)},tn=function(...n){let e="";for(let t=0;t<n.length;t++){const i=n[t];Array.isArray(i)||i&&typeof i=="object"&&typeof i.length=="number"?e+=tn.apply(null,i):typeof i=="object"?e+=H(i):e+=i,e+=" "}return e};let Ot=null,Nr=!0;const Vh=function(n,e){m(!0,"Can't turn on custom loggers persistently."),lt.logLevel=O.VERBOSE,Ot=lt.log.bind(lt)},j=function(...n){if(Nr===!0&&(Nr=!1,Ot===null&&Wh.get("logging_enabled")===!0&&Vh()),Ot){const e=tn.apply(null,n);Ot(e)}},nn=function(n){return function(...e){j(n,...e)}},Ui=function(...n){const e="FIREBASE INTERNAL ERROR: "+tn(...n);lt.error(e)},Ee=function(...n){const e=`FIREBASE FATAL ERROR: ${tn(...n)}`;throw lt.error(e),new Error(e)},K=function(...n){const e="FIREBASE WARNING: "+tn(...n);lt.warn(e)},zh=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&K("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},ms=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},Gh=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},ht="[MIN_NAME]",Ke="[MAX_NAME]",Je=function(n,e){if(n===e)return 0;if(n===ht||e===Ke)return-1;if(e===ht||n===Ke)return 1;{const t=Pr(n),i=Pr(e);return t!==null?i!==null?t-i===0?n.length-e.length:t-i:-1:i!==null?1:n<e?-1:1}},Kh=function(n,e){return n===e?0:n<e?-1:1},kt=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+H(e))},gs=function(n){if(typeof n!="object"||n===null)return H(n);const e=[];for(const i in n)e.push(i);e.sort();let t="{";for(let i=0;i<e.length;i++)i!==0&&(t+=","),t+=H(e[i]),t+=":",t+=gs(n[e[i]]);return t+="}",t},ca=function(n,e){const t=n.length;if(t<=e)return[n];const i=[];for(let s=0;s<t;s+=e)s+e>t?i.push(n.substring(s,t)):i.push(n.substring(s,s+e));return i};function V(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const da=function(n){m(!ms(n),"Invalid JSON number");const e=11,t=52,i=(1<<e-1)-1;let s,r,o,a,l;n===0?(r=0,o=0,s=1/n===-1/0?1:0):(s=n<0,n=Math.abs(n),n>=Math.pow(2,1-i)?(a=Math.min(Math.floor(Math.log(n)/Math.LN2),i),r=a+i,o=Math.round(n*Math.pow(2,t-a)-Math.pow(2,t))):(r=0,o=Math.round(n/Math.pow(2,1-i-t))));const c=[];for(l=t;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(r%2?1:0),r=Math.floor(r/2);c.push(s?1:0),c.reverse();const d=c.join("");let u="";for(l=0;l<64;l+=8){let h=parseInt(d.substr(l,8),2).toString(16);h.length===1&&(h="0"+h),u=u+h}return u.toLowerCase()},Yh=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},Qh=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function Jh(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const i=new Error(n+" at "+e._path.toString()+": "+t);return i.code=n.toUpperCase(),i}const Xh=new RegExp("^-?(0*)\\d{1,10}$"),Zh=-2147483648,ef=2147483647,Pr=function(n){if(Xh.test(n)){const e=Number(n);if(e>=Zh&&e<=ef)return e}return null},wt=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw K("Exception was thrown by user callback.",t),e},Math.floor(0))}},tf=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Lt=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lf{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&wt(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Br=32,Hr=768;class L{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let i=0;for(let s=0;s<this.pieces_.length;s++)this.pieces_[s].length>0&&(this.pieces_[i]=this.pieces_[s],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function N(){return new L("")}function k(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function $e(n){return n.pieces_.length-n.pieceNum_}function M(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new L(n.pieces_,e)}function bs(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function Rf(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function qt(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function Aa(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new L(e,0)}function $(n,e){const t=[];for(let i=n.pieceNum_;i<n.pieces_.length;i++)t.push(n.pieces_[i]);if(e instanceof L)for(let i=e.pieceNum_;i<e.pieces_.length;i++)t.push(e.pieces_[i]);else{const i=e.split("/");for(let s=0;s<i.length;s++)i[s].length>0&&t.push(i[s])}return new L(t,0)}function R(n){return n.pieceNum_>=n.pieces_.length}function G(n,e){const t=k(n),i=k(e);if(t===null)return e;if(t===i)return G(M(n),M(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function Nf(n,e){const t=qt(n,0),i=qt(e,0);for(let s=0;s<t.length&&s<i.length;s++){const r=Je(t[s],i[s]);if(r!==0)return r}return t.length===i.length?0:t.length<i.length?-1:1}function ws(n,e){if($e(n)!==$e(e))return!1;for(let t=n.pieceNum_,i=e.pieceNum_;t<=n.pieces_.length;t++,i++)if(n.pieces_[t]!==e.pieces_[i])return!1;return!0}function Z(n,e){let t=n.pieceNum_,i=e.pieceNum_;if($e(n)>$e(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[i])return!1;++t,++i}return!0}class Pf{constructor(e,t){this.errorPrefix_=t,this.parts_=qt(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=jn(this.parts_[i]);Ra(this)}}function Of(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=jn(e),Ra(n)}function Lf(n){const e=n.parts_.pop();n.byteLength_-=jn(e),n.parts_.length>0&&(n.byteLength_-=1)}function Ra(n){if(n.byteLength_>Hr)throw new Error(n.errorPrefix_+"has a key path longer than "+Hr+" bytes ("+n.byteLength_+").");if(n.parts_.length>Br)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Br+") or object contains a cycle "+qe(n))}function qe(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yn{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new A(ht,e),s=new A(ht,t);return this.compare(i,s)!==0}minPost(){return A.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let dn;class Na extends Yn{static get __EMPTY_NODE(){return dn}static set __EMPTY_NODE(e){dn=e}compare(e,t){return Je(e.name,t.name)}isDefinedOn(e){throw _t("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return A.MIN}maxPost(){return new A(Ke,dn)}makePost(e,t){return m(typeof e=="string","KeyIndex indexValue must always be a string."),new A(e,dn)}toString(){return".key"}}const ct=new Na;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ti;const tt={};class _e{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return m(tt&&F,"ChildrenNode.ts has not been loaded"),Ti=Ti||new _e({".priority":tt},{".priority":F}),Ti}get(e){const t=dt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Q?t:null}hasIndex(e){return ue(this.indexSet_,e.toString())}addIndex(e,t){m(e!==ct,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(A.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=Rn(i,e.getCompare()):a=tt;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const d=Object.assign({},this.indexes_);return d[l]=a,new _e(d,c)}addToIndexes(e,t){const i=bn(this.indexes_,(s,r)=>{const o=dt(this.indexSet_,r);if(m(o,"Missing index implementation for "+r),s===tt)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(A.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),Rn(a,o.getCompare())}else return tt;else{const a=t.get(e.name);let l=s;return a&&(l=l.remove(new A(e.name,a))),l.insert(e,e.node)}});return new _e(i,this.indexSet_)}removeFromIndexes(e,t){const i=bn(this.indexes_,s=>{if(s===tt)return s;{const r=t.get(e.name);return r?s.remove(new A(e.name,r)):s}});return new _e(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Rt;class E{constructor(e,t,i){this.children_=e,this.priorityNode_=t,this.indexMap_=i,this.lazyHash_=null,this.priorityNode_&&Oa(this.priorityNode_),this.children_.isEmpty()&&m(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}static get EMPTY_NODE(){return Rt||(Rt=new E(new Q(Is),null,_e.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Rt}updatePriority(e){return this.children_.isEmpty()?this:new E(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?Rt:t}}getChild(e){const t=k(e);return t===null?this:this.getImmediateChild(t).getChild(M(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(m(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const i=new A(e,t);let s,r;t.isEmpty()?(s=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(i,this.children_)):(s=this.children_.insert(e,t),r=this.indexMap_.addToIndexes(i,this.children_));const o=s.isEmpty()?Rt:this.priorityNode_;return new E(s,o,r)}}updateChild(e,t){const i=k(e);if(i===null)return t;{m(k(e)!==".priority"||$e(e)===1,".priority must be the last token in a path");const s=this.getImmediateChild(i).updateChild(M(e),t);return this.updateImmediateChild(i,s)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let i=0,s=0,r=!0;if(this.forEachChild(F,(o,a)=>{t[o]=a.val(e),i++,r&&E.INTEGER_REGEXP_.test(o)?s=Math.max(s,Number(o)):r=!1}),!e&&r&&s<2*i){const o=[];for(const a in t)o[a]=t[a];return o}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+Pa(this.getPriority().val())+":"),this.forEachChild(F,(t,i)=>{const s=i.hash();s!==""&&(e+=":"+t+":"+s)}),this.lazyHash_=e===""?"":la(e)}return this.lazyHash_}getPredecessorChildName(e,t,i){const s=this.resolveIndex_(i);if(s){const r=s.getPredecessorKey(new A(e,t));return r?r.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const i=t.minKey();return i&&i.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new A(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const i=t.maxKey();return i&&i.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new A(t,this.children_.get(t)):null}forEachChild(e,t){const i=this.resolveIndex_(e);return i?i.inorderTraversal(s=>t(s.name,s.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const i=this.resolveIndex_(t);if(i)return i.getIteratorFrom(e,s=>s);{const s=this.children_.getIteratorFrom(e.name,A.Wrap);let r=s.peek();for(;r!=null&&t.compare(r,e)<0;)s.getNext(),r=s.peek();return s}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const i=this.resolveIndex_(t);if(i)return i.getReverseIteratorFrom(e,s=>s);{const s=this.children_.getReverseIteratorFrom(e.name,A.Wrap);let r=s.peek();for(;r!=null&&t.compare(r,e)>0;)s.getNext(),r=s.peek();return s}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===sn?-1:0}withIndex(e){if(e===ct||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new E(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===ct||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const i=this.getIterator(F),s=t.getIterator(F);let r=i.getNext(),o=s.getNext();for(;r&&o;){if(r.name!==o.name||!r.node.equals(o.node))return!1;r=i.getNext(),o=s.getNext()}return r===null&&o===null}else return!1;else return!1}}resolveIndex_(e){return e===ct?null:this.indexMap_.get(e.toString())}}E.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class Gf extends E{constructor(){super(new Q(Is),E.EMPTY_NODE,_e.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return E.EMPTY_NODE}isEmpty(){return!1}}const sn=new Gf;Object.defineProperties(A,{MIN:{value:new A(ht,E.EMPTY_NODE)},MAX:{value:new A(Ke,sn)}});Na.__EMPTY_NODE=E.EMPTY_NODE;q.__childrenNodeConstructor=E;Hf(sn);Wf(sn);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yf extends Yn{constructor(e){super(),this.indexPath_=e,m(!R(e)&&k(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const i=this.extractChild(e.node),s=this.extractChild(t.node),r=i.compareTo(s);return r===0?Je(e.name,t.name):r}makePost(e,t){const i=B(e),s=E.EMPTY_NODE.updateChild(this.indexPath_,i);return new A(t,s)}maxPost(){const e=E.EMPTY_NODE.updateChild(this.indexPath_,sn);return new A(Ke,e)}toString(){return qt(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qf extends Yn{compare(e,t){const i=e.node.compareTo(t.node);return i===0?Je(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return A.MIN}maxPost(){return A.MAX}makePost(e,t){const i=B(e);return new A(t,i)}toString(){return".value"}}const Jf=new Qf;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ma(n){return{type:"value",snapshotNode:n}}function ft(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Wt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function jt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function Xf(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cs{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){m(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(Wt(t,a)):m(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(ft(t,i)):o.trackChildChange(jt(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(F,(s,r)=>{t.hasChild(s)||i.trackChildChange(Wt(s,r))}),t.isLeafNode()||t.forEachChild(F,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(jt(s,r,o))}else i.trackChildChange(ft(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?E.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vt{constructor(e){this.indexedFilter_=new Cs(e.getIndex()),this.index_=e.getIndex(),this.startPost_=Vt.getStartPost_(e),this.endPost_=Vt.getEndPost_(e),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){const t=this.startIsInclusive_?this.index_.compare(this.getStartPost(),e)<=0:this.index_.compare(this.getStartPost(),e)<0,i=this.endIsInclusive_?this.index_.compare(e,this.getEndPost())<=0:this.index_.compare(e,this.getEndPost())<0;return t&&i}updateChild(e,t,i,s,r,o){return this.matches(new A(t,i))||(i=E.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,i,s,r,o)}updateFullNode(e,t,i){t.isLeafNode()&&(t=E.EMPTY_NODE);let s=t.withIndex(this.index_);s=s.updatePriority(E.EMPTY_NODE);const r=this;return t.forEachChild(F,(o,a)=>{r.matches(new A(o,a))||(s=s.updateImmediateChild(o,E.EMPTY_NODE))}),this.indexedFilter_.updateFullNode(e,s,i)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}else return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}else return e.getIndex().maxPost()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zf{constructor(e){this.withinDirectionalStart=t=>this.reverse_?this.withinEndPost(t):this.withinStartPost(t),this.withinDirectionalEnd=t=>this.reverse_?this.withinStartPost(t):this.withinEndPost(t),this.withinStartPost=t=>{const i=this.index_.compare(this.rangedFilter_.getStartPost(),t);return this.startIsInclusive_?i<=0:i<0},this.withinEndPost=t=>{const i=this.index_.compare(t,this.rangedFilter_.getEndPost());return this.endIsInclusive_?i<=0:i<0},this.rangedFilter_=new Vt(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft(),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}updateChild(e,t,i,s,r,o){return this.rangedFilter_.matches(new A(t,i))||(i=E.EMPTY_NODE),e.getImmediateChild(t).equals(i)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,i,s,r,o):this.fullLimitUpdateChild_(e,t,i,r,o)}updateFullNode(e,t,i){let s;if(t.isLeafNode()||t.isEmpty())s=E.EMPTY_NODE.withIndex(this.index_);else if(this.limit_*2<t.numChildren()&&t.isIndexed(this.index_)){s=E.EMPTY_NODE.withIndex(this.index_);let r;this.reverse_?r=t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):r=t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let o=0;for(;r.hasNext()&&o<this.limit_;){const a=r.getNext();if(this.withinDirectionalStart(a))if(this.withinDirectionalEnd(a))s=s.updateImmediateChild(a.name,a.node),o++;else break;else continue}}else{s=t.withIndex(this.index_),s=s.updatePriority(E.EMPTY_NODE);let r;this.reverse_?r=s.getReverseIterator(this.index_):r=s.getIterator(this.index_);let o=0;for(;r.hasNext();){const a=r.getNext();o<this.limit_&&this.withinDirectionalStart(a)&&this.withinDirectionalEnd(a)?o++:s=s.updateImmediateChild(a.name,E.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,s,i)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,i,s,r){let o;if(this.reverse_){const u=this.index_.getCompare();o=(h,f)=>u(f,h)}else o=this.index_.getCompare();const a=e;m(a.numChildren()===this.limit_,"");const l=new A(t,i),c=this.reverse_?a.getFirstChild(this.index_):a.getLastChild(this.index_),d=this.rangedFilter_.matches(l);if(a.hasChild(t)){const u=a.getImmediateChild(t);let h=s.getChildAfterChild(this.index_,c,this.reverse_);for(;h!=null&&(h.name===t||a.hasChild(h.name));)h=s.getChildAfterChild(this.index_,h,this.reverse_);const f=h==null?1:o(h,l);if(d&&!i.isEmpty()&&f>=0)return r!=null&&r.trackChildChange(jt(t,i,u)),a.updateImmediateChild(t,i);{r!=null&&r.trackChildChange(Wt(t,u));const v=a.updateImmediateChild(t,E.EMPTY_NODE);return h!=null&&this.rangedFilter_.matches(h)?(r!=null&&r.trackChildChange(ft(h.name,h.node)),v.updateImmediateChild(h.name,h.node)):v}}else return i.isEmpty()?e:d&&o(c,l)>=0?(r!=null&&(r.trackChildChange(Wt(c.name,c.node)),r.trackChildChange(ft(t,i))),a.updateImmediateChild(t,i).updateImmediateChild(c.name,E.EMPTY_NODE)):e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nn extends xa{constructor(e,t,i,s){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=i,this.appCheckTokenProvider_=s,this.log_=nn("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(m(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,i,s){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Nn.getListenId_(e,i),a={};this.listens_[o]=a;const l=Vr(e._queryParams);this.restRequest_(r+".json",l,(c,d)=>{let u=d;if(c===404&&(u=null,c=null),c===null&&this.onDataUpdate_(r,u,!1,i),dt(this.listens_,o)===a){let h;c?c===401?h="permission_denied":h="rest_error:"+c:h="ok",s(h,null)}})}unlisten(e,t){const i=Nn.getListenId_(e,t);delete this.listens_[i]}get(e){const t=Vr(e._queryParams),i=e._path.toString(),s=new Qt;return this.restRequest_(i+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(i,a,!1,null),s.resolve(a)):s.reject(new Error(a))}),s.promise}refreshAuthToken(e){}restRequest_(e,t={},i){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([s,r])=>{s&&s.accessToken&&(t.auth=s.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+vt(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(i&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=Ft(a.responseText)}catch{K("Failed to parse JSON response for "+o+": "+a.responseText)}i(null,l)}else a.status!==401&&a.status!==404&&K("Got unsuccessful REST response for "+o+" Status: "+a.status),i(a.status);i=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pn(){return{value:null,children:new Map}}function $a(n,e,t){if(R(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const i=k(e);n.children.has(i)||n.children.set(i,Pn());const s=n.children.get(i);e=M(e),$a(s,e,t)}}function qi(n,e,t){n.value!==null?t(e,n.value):np(n,(i,s)=>{const r=new L(e.toString()+"/"+i);qi(s,r,t)})}function np(n,e){n.children.forEach((t,i)=>{e(i,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gr=10*1e3,sp=30*1e3,rp=5*60*1e3;class op{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new ip(e);const i=Gr+(sp-Gr)*Math.random();Lt(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;V(e,(s,r)=>{r>0&&ue(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),Lt(this.reportStats_.bind(this),Math.floor(Math.random()*2*rp))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class On{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=se.ACK_USER_WRITE,this.source=Ts()}operationForChild(e){if(R(this.path)){if(this.affectedTree.value!=null)return m(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new L(e));return new On(N(),t,this.revert)}}else return m(k(this.path)===e,"operationForChild called for unrelated child."),new On(M(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zt{constructor(e,t){this.source=e,this.path=t,this.type=se.LISTEN_COMPLETE}operationForChild(e){return R(this.path)?new zt(this.source,N()):new zt(this.source,M(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ye{constructor(e,t,i){this.source=e,this.path=t,this.snap=i,this.type=se.OVERWRITE}operationForChild(e){return R(this.path)?new Ye(this.source,N(),this.snap.getImmediateChild(e)):new Ye(this.source,M(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pt{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=se.MERGE}operationForChild(e){if(R(this.path)){const t=this.children.subtree(new L(e));return t.isEmpty()?null:t.value?new Ye(this.source,N(),t.value):new pt(this.source,N(),t)}else return m(k(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new pt(this.source,M(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ap{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function lp(n,e,t,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Xf(o.childName,o.snapshotNode))}),Nt(n,s,"child_removed",e,i,t),Nt(n,s,"child_added",e,i,t),Nt(n,s,"child_moved",r,i,t),Nt(n,s,"child_changed",e,i,t),Nt(n,s,"value",e,i,t),s}function Nt(n,e,t,i,s,r){const o=i.filter(a=>a.type===t);o.sort((a,l)=>dp(n,a,l)),o.forEach(a=>{const l=cp(n,a,r);s.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,n.query_))})})}function cp(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function dp(n,e,t){if(e.childName==null||t.childName==null)throw _t("Should only compare child_ events.");const i=new A(e.childName,e.snapshotNode),s=new A(t.childName,t.snapshotNode);return n.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qn(n,e){return{eventCache:n,serverCache:e}}function Dt(n,e,t,i){return Qn(new Fe(e,t,i),n.serverCache)}function Fa(n,e,t,i){return Qn(n.eventCache,new Fe(e,t,i))}function Ln(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Qe(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class re{constructor(e){this.writeTree_=e}static empty(){return new re(new D(null))}}function Mt(n,e,t){if(R(e))return new re(new D(t));{const i=n.writeTree_.findRootMostValueAndPath(e);if(i!=null){const s=i.path;let r=i.value;const o=G(s,e);return r=r.updateChild(o,t),new re(n.writeTree_.set(s,r))}else{const s=new D(t),r=n.writeTree_.setTree(e,s);return new re(r)}}}function Wi(n,e,t){let i=n;return V(t,(s,r)=>{i=Mt(i,$(e,s),r)}),i}function Kr(n,e){if(R(e))return re.empty();{const t=n.writeTree_.setTree(e,new D(null));return new re(t)}}function ji(n,e){return Xe(n,e)!=null}function Xe(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(G(t.path,e)):null}function Yr(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(F,(i,s)=>{e.push(new A(i,s))}):n.writeTree_.children.inorderTraversal((i,s)=>{s.value!=null&&e.push(new A(i,s.value))}),e}function Le(n,e){if(R(e))return n;{const t=Xe(n,e);return t!=null?new re(new D(t)):new re(n.writeTree_.subtree(e))}}function Vi(n){return n.writeTree_.isEmpty()}function mt(n,e){return Ua(N(),n.writeTree_,e)}function Ua(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let i=null;return e.children.inorderTraversal((s,r)=>{s===".priority"?(m(r.value!==null,"Priority writes must always be leaf nodes"),i=r.value):t=Ua($(n,s),r,t)}),!t.getChild(n).isEmpty()&&i!==null&&(t=t.updateChild($(n,".priority"),i)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jn(n,e){return Wa(e,n)}function hp(n,e,t,i,s){m(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=Mt(n.visibleWrites,e,t)),n.lastWriteId=i}function fp(n,e,t,i){m(i>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:i,visible:!0}),n.visibleWrites=Wi(n.visibleWrites,e,t),n.lastWriteId=i}function pp(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function mp(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);m(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&gp(a,i.path)?s=!1:Z(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return _p(n),!0;if(i.snap)n.visibleWrites=Kr(n.visibleWrites,i.path);else{const a=i.children;V(a,l=>{n.visibleWrites=Kr(n.visibleWrites,$(i.path,l))})}return!0}else return!1}function gp(n,e){if(n.snap)return Z(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Z($(n.path,t),e))return!0;return!1}function _p(n){n.visibleWrites=Ba(n.allWrites,vp,N()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function vp(n){return n.visible}function Ba(n,e,t){let i=re.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)Z(t,o)?(a=G(t,o),i=Mt(i,a,r.snap)):Z(o,t)&&(a=G(o,t),i=Mt(i,N(),r.snap.getChild(a)));else if(r.children){if(Z(t,o))a=G(t,o),i=Wi(i,a,r.children);else if(Z(o,t))if(a=G(o,t),R(a))i=Wi(i,N(),r.children);else{const l=dt(r.children,k(a));if(l){const c=l.getChild(M(a));i=Mt(i,N(),c)}}}else throw _t("WriteRecord should have .snap or .children")}}return i}function Ha(n,e,t,i,s){if(!i&&!s){const r=Xe(n.visibleWrites,e);if(r!=null)return r;{const o=Le(n.visibleWrites,e);if(Vi(o))return t;if(t==null&&!ji(o,N()))return null;{const a=t||E.EMPTY_NODE;return mt(o,a)}}}else{const r=Le(n.visibleWrites,e);if(!s&&Vi(r))return t;if(!s&&t==null&&!ji(r,N()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(Z(c.path,e)||Z(e,c.path))},a=Ba(n.allWrites,o,e),l=t||E.EMPTY_NODE;return mt(a,l)}}}function yp(n,e,t){let i=E.EMPTY_NODE;const s=Xe(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(F,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=Le(n.visibleWrites,e);return t.forEachChild(F,(o,a)=>{const l=mt(Le(r,new L(o)),a);i=i.updateImmediateChild(o,l)}),Yr(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=Le(n.visibleWrites,e);return Yr(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function bp(n,e,t,i,s){m(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=$(e,t);if(ji(n.visibleWrites,r))return null;{const o=Le(n.visibleWrites,r);return Vi(o)?s.getChild(t):mt(o,s.getChild(t))}}function wp(n,e,t,i){const s=$(e,t),r=Xe(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=Le(n.visibleWrites,s);return mt(o,i.getNode().getImmediateChild(t))}else return null}function Ep(n,e){return Xe(n.visibleWrites,e)}function Ip(n,e,t,i,s,r,o){let a;const l=Le(n.visibleWrites,e),c=Xe(l,N());if(c!=null)a=c;else if(t!=null)a=mt(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const d=[],u=o.getCompare(),h=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let f=h.getNext();for(;f&&d.length<s;)u(f,i)!==0&&d.push(f),f=h.getNext();return d}else return[]}function Cp(){return{visibleWrites:re.empty(),allWrites:[],lastWriteId:-1}}function Dn(n,e,t,i){return Ha(n.writeTree,n.treePath,e,t,i)}function As(n,e){return yp(n.writeTree,n.treePath,e)}function Qr(n,e,t,i){return bp(n.writeTree,n.treePath,e,t,i)}function Mn(n,e){return Ep(n.writeTree,$(n.treePath,e))}function Sp(n,e,t,i,s,r){return Ip(n.writeTree,n.treePath,e,t,i,s,r)}function Rs(n,e,t){return wp(n.writeTree,n.treePath,e,t)}function qa(n,e){return Wa($(n.treePath,e),n.writeTree)}function Wa(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xp{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const ja=new xp;class Ns{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new Fe(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Rs(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Qe(this.viewCache_),r=Sp(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kp(n){return{filter:n}}function Ap(n,e){m(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),m(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function Rp(n,e,t,i,s){const r=new Tp;let o,a;if(t.type===se.OVERWRITE){const c=t;c.source.fromUser?o=zi(n,e,c.path,c.snap,i,s,r):(m(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!R(c.path),o=$n(n,e,c.path,c.snap,i,s,a,r))}else if(t.type===se.MERGE){const c=t;c.source.fromUser?o=Pp(n,e,c.path,c.children,i,s,r):(m(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=Gi(n,e,c.path,c.children,i,s,a,r))}else if(t.type===se.ACK_USER_WRITE){const c=t;c.revert?o=Dp(n,e,c.path,i,s,r):o=Op(n,e,c.path,c.affectedTree,i,s,r)}else if(t.type===se.LISTEN_COMPLETE)o=Lp(n,e,t.path,i,r);else throw _t("Unknown operation type: "+t.type);const l=r.getChanges();return Np(e,o,l),{viewCache:o,changes:l}}function Np(n,e,t){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=Ln(n);(t.length>0||!n.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&t.push(Ma(Ln(e)))}}function Va(n,e,t,i,s,r){const o=e.eventCache;if(Mn(i,t)!=null)return e;{let a,l;if(R(t))if(m(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=Qe(e),d=c instanceof E?c:E.EMPTY_NODE,u=As(i,d);a=n.filter.updateFullNode(e.eventCache.getNode(),u,r)}else{const c=Dn(i,Qe(e));a=n.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=k(t);if(c===".priority"){m($e(t)===1,"Can't have a priority with additional path components");const d=o.getNode();l=e.serverCache.getNode();const u=Qr(i,t,d,l);u!=null?a=n.filter.updatePriority(d,u):a=o.getNode()}else{const d=M(t);let u;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const h=Qr(i,t,o.getNode(),l);h!=null?u=o.getNode().getImmediateChild(c).updateChild(d,h):u=o.getNode().getImmediateChild(c)}else u=Rs(i,c,e.serverCache);u!=null?a=n.filter.updateChild(o.getNode(),c,u,d,s,r):a=o.getNode()}}return Dt(e,a,o.isFullyInitialized()||R(t),n.filter.filtersNodes())}}function $n(n,e,t,i,s,r,o,a){const l=e.serverCache;let c;const d=o?n.filter:n.filter.getIndexedFilter();if(R(t))c=d.updateFullNode(l.getNode(),i,null);else if(d.filtersNodes()&&!l.isFiltered()){const f=l.getNode().updateChild(t,i);c=d.updateFullNode(l.getNode(),f,null)}else{const f=k(t);if(!l.isCompleteForPath(t)&&$e(t)>1)return e;const p=M(t),y=l.getNode().getImmediateChild(f).updateChild(p,i);f===".priority"?c=d.updatePriority(l.getNode(),y):c=d.updateChild(l.getNode(),f,y,p,ja,null)}const u=Fa(e,c,l.isFullyInitialized()||R(t),d.filtersNodes()),h=new Ns(s,u,r);return Va(n,u,t,s,h,a)}function zi(n,e,t,i,s,r,o){const a=e.eventCache;let l,c;const d=new Ns(s,e,r);if(R(t))c=n.filter.updateFullNode(e.eventCache.getNode(),i,o),l=Dt(e,c,!0,n.filter.filtersNodes());else{const u=k(t);if(u===".priority")c=n.filter.updatePriority(e.eventCache.getNode(),i),l=Dt(e,c,a.isFullyInitialized(),a.isFiltered());else{const h=M(t),f=a.getNode().getImmediateChild(u);let p;if(R(h))p=i;else{const v=d.getCompleteChild(u);v!=null?bs(h)===".priority"&&v.getChild(Aa(h)).isEmpty()?p=v:p=v.updateChild(h,i):p=E.EMPTY_NODE}if(f.equals(p))l=e;else{const v=n.filter.updateChild(a.getNode(),u,p,h,d,o);l=Dt(e,v,a.isFullyInitialized(),n.filter.filtersNodes())}}}return l}function Jr(n,e){return n.eventCache.isCompleteForChild(e)}function Pp(n,e,t,i,s,r,o){let a=e;return i.foreach((l,c)=>{const d=$(t,l);Jr(e,k(d))&&(a=zi(n,a,d,c,s,r,o))}),i.foreach((l,c)=>{const d=$(t,l);Jr(e,k(d))||(a=zi(n,a,d,c,s,r,o))}),a}function Xr(n,e,t){return t.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function Gi(n,e,t,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;R(t)?c=i:c=new D(null).setTree(t,i);const d=e.serverCache.getNode();return c.children.inorderTraversal((u,h)=>{if(d.hasChild(u)){const f=e.serverCache.getNode().getImmediateChild(u),p=Xr(n,f,h);l=$n(n,l,new L(u),p,s,r,o,a)}}),c.children.inorderTraversal((u,h)=>{const f=!e.serverCache.isCompleteForChild(u)&&h.value===null;if(!d.hasChild(u)&&!f){const p=e.serverCache.getNode().getImmediateChild(u),v=Xr(n,p,h);l=$n(n,l,new L(u),v,s,r,o,a)}}),l}function Op(n,e,t,i,s,r,o){if(Mn(s,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(R(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return $n(n,e,t,l.getNode().getChild(t),s,r,a,o);if(R(t)){let c=new D(null);return l.getNode().forEachChild(ct,(d,u)=>{c=c.set(new L(d),u)}),Gi(n,e,t,c,s,r,a,o)}else return e}else{let c=new D(null);return i.foreach((d,u)=>{const h=$(t,d);l.isCompleteForPath(h)&&(c=c.set(d,l.getNode().getChild(h)))}),Gi(n,e,t,c,s,r,a,o)}}function Lp(n,e,t,i,s){const r=e.serverCache,o=Fa(e,r.getNode(),r.isFullyInitialized()||R(t),r.isFiltered());return Va(n,o,t,i,ja,s)}function Dp(n,e,t,i,s,r){let o;if(Mn(i,t)!=null)return e;{const a=new Ns(i,e,s),l=e.eventCache.getNode();let c;if(R(t)||k(t)===".priority"){let d;if(e.serverCache.isFullyInitialized())d=Dn(i,Qe(e));else{const u=e.serverCache.getNode();m(u instanceof E,"serverChildren would be complete if leaf node"),d=As(i,u)}d=d,c=n.filter.updateFullNode(l,d,r)}else{const d=k(t);let u=Rs(i,d,e.serverCache);u==null&&e.serverCache.isCompleteForChild(d)&&(u=l.getImmediateChild(d)),u!=null?c=n.filter.updateChild(l,d,u,M(t),a,r):e.eventCache.getNode().hasChild(d)?c=n.filter.updateChild(l,d,E.EMPTY_NODE,M(t),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Dn(i,Qe(e)),o.isLeafNode()&&(c=n.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||Mn(i,N())!=null,Dt(e,c,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bs{constructor(e="",t=null,i={children:{},childCount:0}){this.name=e,this.parent=t,this.node=i}}function Hs(n,e){let t=e instanceof L?e:new L(e),i=n,s=k(t);for(;s!==null;){const r=dt(i.node.children,s)||{children:{},childCount:0};i=new Bs(s,i,r),t=M(t),s=k(t)}return i}function It(n){return n.node.value}function rl(n,e){n.node.value=e,Yi(n)}function ol(n){return n.node.childCount>0}function cm(n){return It(n)===void 0&&!ol(n)}function ei(n,e){V(n.node.children,(t,i)=>{e(new Bs(t,n,i))})}function al(n,e,t,i){t&&e(n),ei(n,s=>{al(s,e,!0)})}function dm(n,e,t){let i=n.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function on(n){return new L(n.parent===null?n.name:on(n.parent)+"/"+n.name)}function Yi(n){n.parent!==null&&um(n.parent,n.name,n)}function um(n,e,t){const i=cm(t),s=ue(n.node.children,e);i&&s?(delete n.node.children[e],n.node.childCount--,Yi(n)):!i&&!s&&(n.node.children[e]=t.node,n.node.childCount++,Yi(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bm{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function ni(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!ws(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function hl(n,e,t){ni(n,t),fl(n,i=>ws(i,e))}function ee(n,e,t){ni(n,t),fl(n,i=>Z(i,e)||Z(e,i))}function fl(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(wm(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function wm(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();Ot&&j("event: "+t.toString()),wt(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Em="repo_interrupt",Im=25;class Cm{constructor(e,t,i,s){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new bm,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Pn(),this.transactionQueueTree_=new Bs,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Sm(n,e,t){if(n.stats_=vs(n.repoInfo_),n.forceRestClient_||tf())n.server_=new Nn(n.repoInfo_,(i,s,r,o)=>{so(n,i,s,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>ro(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{H(t)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}n.persistentConnection_=new ve(n.repoInfo_,e,(i,s,r,o)=>{so(n,i,s,r,o)},i=>{ro(n,i)},i=>{Tm(n,i)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(i=>{n.server_.refreshAuthToken(i)}),n.appCheckProvider_.addTokenChangeListener(i=>{n.server_.refreshAppCheckToken(i.token)}),n.statsReporter_=af(n.repoInfo_,()=>new op(n.stats_,n.server_)),n.infoData_=new tp,n.infoSyncTree_=new no({startListening:(i,s,r,o)=>{let a=[];const l=n.infoData_.getNode(i._path);return l.isEmpty()||(a=rn(n.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Ws(n,"connected",!1),n.serverSyncTree_=new no({startListening:(i,s,r,o)=>(n.server_.listen(i,r,s,(a,l)=>{const c=o(a,l);ee(n.eventQueue_,i._path,c)}),[]),stopListening:(i,s)=>{n.server_.unlisten(i,s)}})}function pl(n){const t=n.infoData_.getNode(new L(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function ii(n){return om({timestamp:pl(n)})}function so(n,e,t,i,s){n.dataUpdateCount++;const r=new L(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(s)if(i){const l=bn(t,c=>B(c));o=em(n.serverSyncTree_,r,l,s)}else{const l=B(t);o=Za(n.serverSyncTree_,r,l,s)}else if(i){const l=bn(t,c=>B(c));o=Jp(n.serverSyncTree_,r,l)}else{const l=B(t);o=rn(n.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=gt(n,r)),ee(n.eventQueue_,a,o)}function ro(n,e){Ws(n,"connected",e),e===!1&&Rm(n)}function Tm(n,e){V(e,(t,i)=>{Ws(n,t,i)})}function Ws(n,e,t){const i=new L("/.info/"+e),s=B(t);n.infoData_.updateSnapshot(i,s);const r=rn(n.infoSyncTree_,i,s);ee(n.eventQueue_,i,r)}function js(n){return n.nextWriteId_++}function xm(n,e,t){const i=tm(n.serverSyncTree_,e);return i!=null?Promise.resolve(i):n.server_.get(e).then(s=>{const r=B(s).withIndex(e._queryParams.getIndex());Ki(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=rn(n.serverSyncTree_,e._path,r);else{const a=Gt(n.serverSyncTree_,e);o=Za(n.serverSyncTree_,e._path,r,a)}return ee(n.eventQueue_,e._path,o),Bn(n.serverSyncTree_,e,t,null,!0),r},s=>(an(n,"get for query "+H(e)+" failed: "+s),Promise.reject(new Error(s))))}function km(n,e,t,i,s){an(n,"set",{path:e.toString(),value:t,priority:i});const r=ii(n),o=B(t,i),a=Os(n.serverSyncTree_,e),l=sl(o,a,r),c=js(n),d=Xa(n.serverSyncTree_,e,l,c,!0);ni(n.eventQueue_,d),n.server_.put(e.toString(),o.val(!0),(h,f)=>{const p=h==="ok";p||K("set at "+e+" failed: "+h);const v=Ae(n.serverSyncTree_,c,!p);ee(n.eventQueue_,e,v),Qi(n,s,h,f)});const u=zs(n,e);gt(n,u),ee(n.eventQueue_,u,[])}function Am(n,e,t,i){an(n,"update",{path:e.toString(),value:t});let s=!0;const r=ii(n),o={};if(V(t,(a,l)=>{s=!1,o[a]=il($(e,a),B(l),n.serverSyncTree_,r)}),s)j("update() called with empty data.  Don't do anything."),Qi(n,i,"ok",void 0);else{const a=js(n),l=Qp(n.serverSyncTree_,e,o,a);ni(n.eventQueue_,l),n.server_.merge(e.toString(),t,(c,d)=>{const u=c==="ok";u||K("update at "+e+" failed: "+c);const h=Ae(n.serverSyncTree_,a,!u),f=h.length>0?gt(n,e):e;ee(n.eventQueue_,f,h),Qi(n,i,c,d)}),V(t,c=>{const d=zs(n,$(e,c));gt(n,d)}),ee(n.eventQueue_,e,[])}}function Rm(n){an(n,"onDisconnectEvents");const e=ii(n),t=Pn();qi(n.onDisconnect_,N(),(s,r)=>{const o=il(s,r,n.serverSyncTree_,e);$a(t,s,o)});let i=[];qi(t,N(),(s,r)=>{i=i.concat(rn(n.serverSyncTree_,s,r));const o=zs(n,s);gt(n,o)}),n.onDisconnect_=Pn(),ee(n.eventQueue_,N(),i)}function Nm(n,e,t){let i;k(e._path)===".info"?i=Ki(n.infoSyncTree_,e,t):i=Ki(n.serverSyncTree_,e,t),hl(n.eventQueue_,e._path,i)}function ml(n,e,t){let i;k(e._path)===".info"?i=Bn(n.infoSyncTree_,e,t):i=Bn(n.serverSyncTree_,e,t),hl(n.eventQueue_,e._path,i)}function Pm(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Em)}function an(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),j(t,...e)}function Qi(n,e,t,i){e&&wt(()=>{if(t==="ok")e(null);else{const s=(t||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function gl(n,e,t){return Os(n.serverSyncTree_,e,t)||E.EMPTY_NODE}function Vs(n,e=n.transactionQueueTree_){if(e||si(n,e),It(e)){const t=vl(n,e);m(t.length>0,"Sending zero length transaction queue"),t.every(s=>s.status===0)&&Om(n,on(e),t)}else ol(e)&&ei(e,t=>{Vs(n,t)})}function Om(n,e,t){const i=t.map(c=>c.currentWriteId),s=gl(n,e,i);let r=s;const o=s.hash();for(let c=0;c<t.length;c++){const d=t[c];m(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const u=G(e,d.path);r=r.updateChild(u,d.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;n.server_.put(l.toString(),a,c=>{an(n,"transaction put response",{path:l.toString(),status:c});let d=[];if(c==="ok"){const u=[];for(let h=0;h<t.length;h++)t[h].status=2,d=d.concat(Ae(n.serverSyncTree_,t[h].currentWriteId)),t[h].onComplete&&u.push(()=>t[h].onComplete(null,!0,t[h].currentOutputSnapshotResolved)),t[h].unwatcher();si(n,Hs(n.transactionQueueTree_,e)),Vs(n,n.transactionQueueTree_),ee(n.eventQueue_,e,d);for(let h=0;h<u.length;h++)wt(u[h])}else{if(c==="datastale")for(let u=0;u<t.length;u++)t[u].status===3?t[u].status=4:t[u].status=0;else{K("transaction at "+l.toString()+" failed: "+c);for(let u=0;u<t.length;u++)t[u].status=4,t[u].abortReason=c}gt(n,e)}},o)}function gt(n,e){const t=_l(n,e),i=on(t),s=vl(n,t);return Lm(n,s,i),i}function Lm(n,e,t){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=G(t,l.path);let d=!1,u;if(m(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)d=!0,u=l.abortReason,s=s.concat(Ae(n.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=Im)d=!0,u="maxretry",s=s.concat(Ae(n.serverSyncTree_,l.currentWriteId,!0));else{const h=gl(n,l.path,o);l.currentInputSnapshot=h;const f=e[a].update(h.val());if(f!==void 0){ti("transaction failed: Data returned ",f,l.path);let p=B(f);typeof f=="object"&&f!=null&&ue(f,".priority")||(p=p.updatePriority(h.getPriority()));const y=l.currentWriteId,x=ii(n),g=sl(p,h,x);l.currentOutputSnapshotRaw=p,l.currentOutputSnapshotResolved=g,l.currentWriteId=js(n),o.splice(o.indexOf(y),1),s=s.concat(Xa(n.serverSyncTree_,l.path,g,l.currentWriteId,l.applyLocally)),s=s.concat(Ae(n.serverSyncTree_,y,!0))}else d=!0,u="nodata",s=s.concat(Ae(n.serverSyncTree_,l.currentWriteId,!0))}ee(n.eventQueue_,t,s),s=[],d&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(u==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(u),!1,null))))}si(n,n.transactionQueueTree_);for(let a=0;a<i.length;a++)wt(i[a]);Vs(n,n.transactionQueueTree_)}function _l(n,e){let t,i=n.transactionQueueTree_;for(t=k(e);t!==null&&It(i)===void 0;)i=Hs(i,t),e=M(e),t=k(e);return i}function vl(n,e){const t=[];return yl(n,e,t),t.sort((i,s)=>i.order-s.order),t}function yl(n,e,t){const i=It(e);if(i)for(let s=0;s<i.length;s++)t.push(i[s]);ei(e,s=>{yl(n,s,t)})}function si(n,e){const t=It(e);if(t){let i=0;for(let s=0;s<t.length;s++)t[s].status!==2&&(t[i]=t[s],i++);t.length=i,rl(e,t.length>0?t:void 0)}ei(e,i=>{si(n,i)})}function zs(n,e){const t=on(_l(n,e)),i=Hs(n.transactionQueueTree_,e);return dm(i,s=>{Ai(n,s)}),Ai(n,i),al(i,s=>{Ai(n,s)}),t}function Ai(n,e){const t=It(e);if(t){const i=[];let s=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(m(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(m(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),s=s.concat(Ae(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&i.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?rl(e,void 0):t.length=r+1,ee(n.eventQueue_,on(e),s);for(let o=0;o<i.length;o++)wt(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gs{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return R(this._path)?null:bs(this._path)}get ref(){return new Ie(this._repo,this._path)}get _queryIdentifier(){const e=zr(this._queryParams),t=gs(e);return t==="{}"?"default":t}get _queryObject(){return zr(this._queryParams)}isEqual(e){if(e=J(e),!(e instanceof Gs))return!1;const t=this._repo===e._repo,i=ws(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+Rf(this._path)}}class Ie extends Gs{constructor(e,t){super(e,t,new Ss,!1)}get parent(){const e=Aa(this._path);return e===null?null:new Ie(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Kt{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new L(e),i=Yt(this.ref,e);return new Kt(this._node.getChild(t),i,F)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new Kt(s,Yt(this.ref,i),F)))}hasChild(e){const t=new L(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function S(n,e){return n=J(n),n._checkNotDeleted("ref"),e!==void 0?Yt(n._root,e):n._root}function Yt(n,e){return n=J(n),k(n._path)===null?vm("child","path",e):dl("child","path",e),new Ie(n._repo,$(n._path,e))}function ri(n,e){n=J(n),ul("push",n._path),cl("push",e,n._path,!0);const t=pl(n._repo),i=Fm(t),s=Yt(n,i),r=Yt(n,i);let o;return o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function U(n,e){n=J(n),ul("set",n._path),cl("set",e,n._path,!1);const t=new Qt;return km(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Ct(n,e){_m("update",e,n._path);const t=new Qt;return Am(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function te(n){n=J(n);const e=new bl(()=>{}),t=new oi(e);return xm(n._repo,n,t).then(i=>new Kt(i,new Ie(n._repo,n._path),n._queryParams.getIndex()))}class oi{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new Um("value",this,new Kt(e.snapshotNode,new Ie(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Bm(this,e,t):null}matches(e){return e instanceof oi?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Hm(n,e,t,i,s){const r=new bl(t,void 0),o=new oi(r);return Nm(n._repo,n,o),()=>ml(n._repo,n,o)}function wl(n,e,t,i){return Hm(n,"value",e)}function El(n,e,t){ml(n._repo,n,null)}qp(Ie);Gp(Ie);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Jm(n){Bh(yt),ut(new ze("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Vm(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),Pe(Ar,Rr,n),Pe(Ar,Rr,"esm2017")}ve.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};ve.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Jm();const Xm={apiKey:"AIzaSyCzdkKcfNvafQ3x9NDUsTn8UOww7_v3nn0",authDomain:"who-s-the-queen-bee.firebaseapp.com",databaseURL:"https://who-s-the-queen-bee-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"who-s-the-queen-bee",storageBucket:"who-s-the-queen-bee.firebasestorage.app",messagingSenderId:"808367557368",appId:"1:808367557368:web:7af8a2948e62494c5e490d"},Il=Io(Xm),Zm=Fh(Il),T=Ym(Il),eg="modulepreload",tg=function(n){return"/queen-bee-scorecard/"+n},lo={},Cl=function(e,t,i){let s=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),a=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(t.map(l=>{if(l=tg(l),l in lo)return;lo[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":eg,c||(u.as="script"),u.crossOrigin="",u.href=l,a&&u.setAttribute("nonce",a),document.head.appendChild(u),c)return new Promise((h,f)=>{u.addEventListener("load",h),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return s.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return e().catch(r)})};async function Ze(){const n=await te(S(T,"employees"));return n.exists()?n.val():{}}async function ai(n,e){await Ct(S(T,`employees/${n}`),e)}function St(n=new Date){return`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}`}async function li(n,e=St()){const t=await te(S(T,`monthly_points/${e}/${n}`));return t.exists()?t.val():{points:0,rank:null,db_count:0,db_pts_deducted:0,net_points:0}}async function Sl(n,e,t=St()){const i=await li(n,t),s={...i,points:(i.points||0)+e,net_points:(i.net_points||0)+e};return await U(S(T,`monthly_points/${t}/${n}`),s),s}function ci(n=St(),e){const t=S(T,`monthly_points/${n}`);return wl(t,i=>e(i.exists()?i.val():{})),()=>El(t)}async function di(n){const e=await te(S(T,`vault/${n}`));return e.exists()?e.val():{total_earned:0,total_deducted:0,net:0,last_reset_date:null}}async function Tl(n,e){const t=await di(n),i={...t,total_earned:(t.total_earned||0)+e,net:(t.net||0)+e};return await U(S(T,`vault/${n}`),i),i}async function xl(n){const e=ri(S(T,"awards")),t={...n,timestamp:Date.now()};return await U(e,t),e.key}async function kl(n){const e=await te(S(T,"awards"));if(!e.exists())return[];const t=e.val();return Object.entries(t).map(([i,s])=>({id:i,...s})).filter(i=>i.receiver_id===n).sort((i,s)=>s.timestamp-i.timestamp)}async function Ks(n){const e=await te(S(T,"awards"));if(!e.exists())return[];const t=e.val();return Object.entries(t).map(([i,s])=>({id:i,...s})).filter(i=>i.giver_id===n).sort((i,s)=>s.timestamp-i.timestamp)}async function Al(n){const e=ri(S(T,"dark_beans")),t={...n,timestamp:Date.now(),appealed:!1,appeal_status:null};return await U(e,t),e.key}async function Ys(n,e,t){const i=await te(S(T,`offense_escalation/${n}/${e}/${t}`));return i.exists()?i.val().instance_count:0}async function Rl(n,e,t){const i=await Ys(n,e,t);return await U(S(T,`offense_escalation/${n}/${e}/${t}`),{instance_count:i+1}),i+1}async function ln(){const n=await te(S(T,"action_menu"));return n.exists()?n.val():{}}async function Nl(n,e){await Ct(S(T,`action_menu/${n}`),e)}async function Qs(){const n=await te(S(T,"offense_menu"));return n.exists()?n.val():{}}async function Pl(n,e){await Ct(S(T,`offense_menu/${n}`),e)}async function Ol(n,e,t){await U(S(T,`votes/${n}/${e}`),t)}async function Ll(n=St()){const e=await te(S(T,`votes/${n}`));return e.exists()?e.val():{}}async function Xi(n,e){return(await te(S(T,`votes/${n}/${e}`))).exists()}async function Zi(n){const e=ri(S(T,"audit_flags")),t={...n,timestamp:Date.now(),status:"open",acted_by:null,acted_at:null};return await U(e,t),e.key}async function Dl(n,e,t){await Ct(S(T,`audit_flags/${n}`),{status:e,acted_by:t,acted_at:Date.now()})}async function Ml(){const n=await te(S(T,"audit_flags"));return n.exists()?Object.entries(n.val()).map(([e,t])=>({id:e,...t})).sort((e,t)=>t.timestamp-e.timestamp):[]}async function $l(n){const e=ri(S(T,"pending_registrations"));return await U(e,{...n,submitted_at:Date.now(),status:"pending"}),e.key}async function Fl(n,e,t){const i="emp_"+n.slice(-8);return await U(S(T,`employees/${i}`),{name:e.name,email:e.email,role:e.role,outlet:e.outlet,pin_hash:e.pin_hash,active:!0}),await Ct(S(T,`pending_registrations/${n}`),{status:"approved",approved_by:t,approved_at:Date.now()}),i}async function Ul(n,e){await Ct(S(T,`pending_registrations/${n}`),{status:"rejected",rejected_by:e,rejected_at:Date.now()})}function Js(n){const e=S(T,"pending_registrations");return wl(e,t=>{if(!t.exists()){n([]);return}const i=Object.entries(t.val()).map(([s,r])=>({id:s,...r})).filter(s=>s.status==="pending");n(i)}),()=>El(e)}async function Bl(n,e,t,i=St()){const s=await li(n,i),r={...s,db_count:(s.db_count||0)+e,db_pts_deducted:(s.db_pts_deducted||0)+t,net_points:Math.max(0,(s.net_points||s.points||0)-t)};return await U(S(T,`monthly_points/${i}/${n}`),r),r}async function Hl(n,e){const t=await di(n),i={...t,total_deducted:(t.total_deducted||0)+e,net:Math.max(0,(t.net||0)-e)};return await U(S(T,`vault/${n}`),i),i}async function ql(){await Promise.all([U(S(T,"awards"),null),U(S(T,"monthly_points"),null),U(S(T,"vault"),null),U(S(T,"dark_beans"),null),U(S(T,"audit_flags"),null),U(S(T,"offense_escalation"),null),U(S(T,"votes"),null),U(S(T,"nominations"),null)])}async function Wl(){await Promise.all([U(S(T,"employees"),null),U(S(T,"pending_registrations"),null)])}async function jl(){const n=await te(S(T,"config"));return n.exists()?n.val():{}}const ng=Object.freeze(Object.defineProperty({__proto__:null,addMonthlyPoints:Sl,addVaultPoints:Tl,approveRegistration:Fl,castVote:Ol,createAuditFlag:Zi,createAward:xl,createDarkBean:Al,deductMonthlyPoints:Bl,deductVaultPoints:Hl,getActions:ln,getAllEmployees:Ze,getAllFlags:Ml,getAwardsByEmployee:kl,getAwardsByGiver:Ks,getConfig:jl,getMonthlyPoints:li,getOffenseInstance:Ys,getOffenses:Qs,getVault:di,getVotes:Ll,hasVoted:Xi,incrementOffenseInstance:Rl,listenLeaderboard:ci,listenPendingRegistrations:Js,monthKey:St,nukeAllStaff:Wl,nukeTransactionalData:ql,rejectRegistration:Ul,submitRegistration:$l,updateFlagStatus:Dl,upsertAction:Nl,upsertEmployee:ai,upsertOffense:Pl},Symbol.toStringTag,{value:"Module"})),ui="hb_bs_session",ig=2*60*60*1e3,sg=30*1e3;function Vl(n){const e={...n,loginAt:Date.now()};localStorage.setItem(ui,JSON.stringify(e))}function zl(){try{const n=localStorage.getItem(ui);if(!n)return null;const e=JSON.parse(n);return Date.now()-e.loginAt>ig?(Gl(),null):e}catch{return null}}function Gl(){localStorage.removeItem(ui)}function rg(){const n=zl();n&&(n.loginAt=Date.now(),localStorage.setItem(ui,JSON.stringify(n)))}function Kl(){return setInterval(rg,sg)}async function og(n){const t=new TextEncoder().encode(n),i=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}async function ag(n,e){const{getAllEmployees:t}=await Cl(async()=>{const{getAllEmployees:o}=await Promise.resolve().then(()=>ng);return{getAllEmployees:o}},void 0),i=await t(),s=Object.entries(i).map(([o,a])=>({id:o,...a})).find(o=>o.email===n&&o.active!==!1);if(!s)throw new Error("Employee not found");const r=await og(e);if(s.pin_hash!==r)throw new Error("Incorrect PIN");return Vl(s),s}function Hn(){return!!(window.PublicKeyCredential&&navigator.credentials)}async function lg(n){if(!Hn())return!1;try{const e=crypto.getRandomValues(new Uint8Array(32)),t=new TextEncoder().encode(n.id),i=await navigator.credentials.create({publicKey:{challenge:e,rp:{name:"Heebee Bean System"},user:{id:t,name:n.email,displayName:n.name},pubKeyCredParams:[{type:"public-key",alg:-7}],authenticatorSelection:{authenticatorAttachment:"platform",userVerification:"required"},timeout:6e4,attestation:"none"}});return i?(await ai(n.id,{webauthn_id:dg(i.rawId)}),!0):!1}catch(e){return console.warn("WebAuthn registration failed, using PIN only:",e.message),!1}}async function cg(n){if(!Hn()||!n.webauthn_id)return!1;try{const e=crypto.getRandomValues(new Uint8Array(32)),t=ug(n.webauthn_id);return await navigator.credentials.get({publicKey:{challenge:e,allowCredentials:[{type:"public-key",id:t}],userVerification:"required",timeout:6e4}})?(Vl(n),n):!1}catch(e){return console.warn("WebAuthn auth failed, fall back to PIN:",e.message),!1}}function dg(n){return btoa(String.fromCharCode(...new Uint8Array(n)))}function ug(n){const e=atob(n),t=new Uint8Array(e.length);for(let i=0;i<e.length;i++)t[i]=e.charCodeAt(i);return t.buffer}function hg(){Gl()}const oe={green:{id:"green",icon:"🫘",label:"Green Bean",pts:1,dailyCap:3},silver:{id:"silver",icon:"☕",label:"Silver Bean",pts:5,dailyCap:3},gold:{id:"gold",icon:"🥇",label:"Gold Bean",pts:10,dailyCap:3},crystal:{id:"crystal",icon:"💎",label:"Crystal Bean",pts:25,dailyCap:10}},hi=["Trainee","Barista","Senior Barista","Kitchen Helper","Commi 3","Commi 2","Commi 1","DCDP","CDP"],fi=["Floor Manager","Sous Chef","Cafe Manager","Head Chef","Area Manager","HOD","CEO","COO","Owner"],pi=["HR","Accountant","Admin Staff"],Yl={"Floor Manager":["green"],"Sous Chef":["green"],"Cafe Manager":["silver"],"Head Chef":["silver"],"Area Manager":["gold"],HOD:["gold"],CEO:["green","silver","gold","crystal"],COO:["green","silver","gold","crystal"],Owner:["green","silver","gold","crystal"]},_n={green:{id:"green",icon:"🟢",label:"Minor",base_db:1,pts:5},silver:{id:"silver",icon:"🟠",label:"Moderate",base_db:3,pts:15},gold:{id:"gold",icon:"🔴",label:"Serious",base_db:5,pts:25},crystal:{id:"crystal",icon:"⚫",label:"Severe",base_db:10,pts:50}},Ql={"Floor Manager":["green"],"Sous Chef":["green"],"Cafe Manager":["green","silver"],"Head Chef":["green","silver"],"Area Manager":["green","silver","gold"],HOD:["green","silver","gold"],CEO:["green","silver","gold","crystal"],COO:["green","silver","gold","crystal"],Owner:["green","silver","gold","crystal"]},es=5,Jl=[{id:"act_01",name:"Daily Task Completion",applicable_bean_tier:"any",active:!0},{id:"act_02",name:"Perfect Attendance",applicable_bean_tier:"any",active:!0},{id:"act_03",name:"Upsell Achievement",applicable_bean_tier:"silver",active:!0},{id:"act_04",name:"Training Completion",applicable_bean_tier:"any",active:!0},{id:"act_05",name:"Customer Recovery Handle",applicable_bean_tier:"silver",active:!0},{id:"act_06",name:"Outlet Opening Standard",applicable_bean_tier:"any",active:!0},{id:"act_07",name:"Special Initiative",applicable_bean_tier:"gold",active:!0}],Xl=[{id:"off_01",name:"Late Arrival",base_db:1,escalation:"double",submission_cap:8,active:!0},{id:"off_02",name:"No-Show No Notice",base_db:5,escalation:"double",submission_cap:20,active:!0},{id:"off_03",name:"Negligence",base_db:2,escalation:"double",submission_cap:16,active:!0},{id:"off_04",name:"Duty Denial",base_db:3,escalation:"double",submission_cap:24,active:!0},{id:"off_05",name:"Misconduct",base_db:4,escalation:"double",submission_cap:32,active:!0},{id:"off_06",name:"Serious/Insubordination",base_db:10,escalation:"double",submission_cap:40,active:!0}],Xs=[{id:"SHB",name:"Sarabha Nagar",brand:"Heebee Coffee"},{id:"GHB",name:"Ghumar Mandi",brand:"Heebee Coffee"},{id:"JLD",name:"Model Town, Jalandhar",brand:"Heebee Coffee"},{id:"POUR",name:"Pour by Heebee",brand:"Pour"}];function Zl(n){return hi.includes(n)}function Zs(n){return fi.includes(n)}function ec(n){return pi.includes(n)}function qn(n){return n==="HR"}function le(n){return["CEO","COO","Owner"].includes(n)}function tc(n){const e={},t={};n.forEach(({giver_id:s,receiver_id:r,points_value:o})=>{e[s]=(e[s]||0)+o;const a=`${s}::${r}`;t[a]=(t[a]||0)+o});const i=[];return Object.entries(t).forEach(([s,r])=>{const[o,a]=s.split("::"),l=e[o]||0;l>0&&r/l>.6&&i.push({type:"bias_concentration",giver_id:o,receiver_id:a,pct:Math.round(r/l*100)})}),i}function nc(n){return n>=100?"disciplinary":n>=51?"owners_notified":n>=26?"suggest_disqualify":n>=10?"silent_flag":null}function ic(n){const e={green:0,silver:0,gold:0,crystal:0};return n.forEach(({bean_type:t})=>{e[t]!==void 0&&e[t]++}),Object.entries(e).filter(([,t])=>t>0).map(([t,i])=>`${oe[t].icon} ${i}`).join(" · ")}const fg=Object.freeze(Object.defineProperty({__proto__:null,ADMIN_ROLES:pi,BEAN_TIERS:oe,CONDUCT_TIERS:_n,DB_POINTS_EACH:es,DEFAULT_ACTIONS:Jl,DEFAULT_OFFENSES:Xl,GIVER_ROLES:fi,OUTLETS:Xs,RECEIVER_ROLES:hi,ROLE_BEAN_PERMISSIONS:Yl,ROLE_CONDUCT_PERMISSIONS:Ql,checkBiasConcentration:tc,formatBeanCounts:ic,getDBThresholdLevel:nc,isAdmin:ec,isGiver:Zs,isHR:qn,isOwner:le,isReceiver:Zl},Symbol.toStringTag,{value:"Module"})),pg=[...hi,...fi,...pi];async function mg(n){const e=new TextEncoder().encode(n),t=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(t)).map(i=>i.toString(16).padStart(2,"0")).join("")}function gg(n,e){n.innerHTML=`
  ...
  `}function Ag(n,e,t){let i={};n.innerHTML=`
    <div class="page">
      <h1 style="font-size:1.4rem;margin-bottom:2px;">Leaderboard</h1>
      <p class="text-dim text-sm" style="margin-bottom:20px;">${Rg()} · Live</p>
      <div id="lb-list">
...
👤 From: ${i} · 📋 ${s}`})}async function Lg(n,e,t){n.innerHTML=`
  ...
  `;let i="award",s={},r={},o={},a=[];try{[s,r,o]=await Promise.all([Ze(),ln(),Qs()]),a=Object.entries(s).map(([d,u])=>({id:d,...u})).filter(d=>Zl(d.role)&&d.active!==!1).sort((d,u)=>d.name.localeCompare(u.name))}catch{n.querySelector("#award-content").innerHTML='<p class="text-dim text-sm text-center">Failed to load. Check connection.</p>';return}n.querySelectorAll(".award-tab").forEach(d=>{d.addEventListener("click",()=>{i=d.dataset.tab,n.querySelectorAll(".award-tab").forEach(u=>{u.className=u.dataset.tab===i?"btn btn-primary award-tab":"btn btn-ghost award-tab",u.style.flex="1",u.style.padding="10px"}),i==="award"?l():c()})}),l();function l(){const d=n.querySelector("#award-content"),u=Yl[e.role]||[],h=Object.entries(r).map(([_,C])=>({id:_,...C})).filter(_=>_.active!==!1);if(a.length===0){d.innerHTML=`
    ...
    `;const p=d.querySelector("#emp-list-c"),v=d.querySelector("#search-emp-c");let y=a;function x(){p.innerHTML=y.map(w=>{var _,C;return`
      ...
      `,_.disabled=!1}const b=d.querySelector("#conduct-error"),P=d.querySelector("#btn-conduct-submit");P.addEventListener("click",async()=>{if(!(!f.receiver||!f.tier||!f.offenseId)){P.disabled=!0,P.textContent="Issuing…",b.classList.add("hidden");try{const w=Ve(),_=await Rl(f.receiver.id,w,f.offenseId),C=_n[f.tier],X=Math.pow(2,_-1),z=C.base_db*X,ne=z*es,ae=h.find(xt=>xt.id===f.offenseId);await Al({giver_id:e.id,giver_name:e.name,receiver_id:f.receiver.id,offense_id:f.offenseId,conduct_tier:f.tier,db_count:z,pts_deducted:ne,month_key:w,note:d.querySelector("#inp-conduct-note").value.trim(),instance:_,multiplier:X});const he=await Bl(f.receiver.id,z,ne,w);await Hl(f.receiver.id,ne);const et=he.db_count||0,Tt=nc(et);Tt&&await Zi({type:"db_threshold",receiver_id:f.receiver.id,giver_id:e.id,suggestion_text:`${f.receiver.name} has accumulated ${et} Dark Beans this month (${Tt.replace(/_/g," ")}).`,suggestion:Tt==="disciplinary"?"Consider formal disciplinary action.":"Review conduct history and consider counselling."}).catch(()=>{}),d.innerHTML=`
          <div class="text-center" style="padding:60px 20px;">
  ...
  `;const o=n.querySelector("#screen-container");r[0].id;function a(c){n.querySelectorAll(".nav-item").forEach(d=>{d.classList.toggle("active",d.dataset.screen===c)}),l(c)}function l(c){switch(o.innerHTML="",c){case"dashboard":wg(o,e,t,{onLogout:i,navigate:a});break;case"leaderboard":Ag(o,e);break;case"award":Lg(o,e);break;case"audit":Dg(o,e);break;case"approvals":Fg(o,e);break;case"vote":qg(o,e);break;default:o.innerHTML=`
          <div class="page">
            <div class="empty-state">
              <div class="icon">🚧</div>
