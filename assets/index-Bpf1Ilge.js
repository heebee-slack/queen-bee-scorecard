 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mc="FirebaseError";class qe extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=Mc,Object.setPrototypeOf(this,qe.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,nn.prototype.create)}}class nn{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?$c(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new qe(s,a,i)}}function $c(n,e){return n.replace(Fc,(t,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const Fc=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zt(n,e,t=!1){if(t)return e;try{return await e}catch(i){throw i instanceof qe&&uu(i)&&n.auth.currentUser===n&&await n.auth.signOut(),i}}function uu({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ii(n,e){return{eventCache:n,serverCache:e}}function Bt(n,e,t,i){return ii(new Be(e,t,i),n.serverCache)}function Va(n,e,t,i){return ii(n.eventCache,new Be(e,t,i))}function qn(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function tt(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Gn;function om(n){_(!Gn,"__referenceConstructor has already been defined"),Gn=n}function am(){return _(Gn,"Reference.ts has not been loaded"),Gn}let lm=1;class uo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new D(null),this.pendingWriteTree_=$p(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ol(n,e,t,i,s){return Sp(n.pendingWriteTree_,e,t,i,s),s?kt(n,new et(As(),e,t)):[]}function cm(n,e,t,i){Tp(n.pendingWriteTree_,e,t,i);const s=D.fromObject(t);return kt(n,new yt(As(),e,s))}function Ne(n,e,t=!1){const i=xp(n.pendingWriteTree_,e);if(kp(n.pendingWriteTree_,e)){let r=new D(null);return i.snap!=null?r=r.set(P(),!0):G(i.children,o=>{r=r.set(new L(o),!0)}),kt(n,new Hn(i.path,r,t))}else return[]}function dn(n,e,t){return kt(n,new et(Ns(),e,t))}function dm(n,e,t){const i=D.fromObject(t);return kt(n,new yt(Ns(),e,i))}function um(n,e){return kt(n,new Jt(Ns(),e))}function hm(n,e,t){const i=Fs(n,t);if(i){const s=Us(i),r=s.path,o=s.queryId,a=Y(r,e),l=new Jt(Ps(o),a);return Bs(n,r,l)}else return[]}function Kn(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||rl(o,e))){const l=rm(o,e,t,i);im(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const d=c.findIndex(f=>f._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(f,h)=>He(h));if(d&&!u){const f=n.syncPointTree_.subtree(r);if(!f.isEmpty()){const h=mm(f);for(let p=0;p<h.length;++p){const m=h[p],b=m.query,x=dl(n,m);n.listenProvider_.startListening(qt(b),Xt(n,b),x.hashFn,x.onComplete)}}}!u&&c.length>0&&!i&&(d?n.listenProvider_.stopListening(qt(e),null):c.forEach(f=>{const h=n.queryToTagMap.get(oi(f));n.listenProvider_.stopListening(qt(f),h)}))}gm(n,c)}return a}function al(n,e,t,i){const s=Fs(n,i);if(s!=null){const r=Us(s),o=r.path,a=r.queryId,l=Y(o,e),c=new et(Ps(a),l,t);return Bs(n,o,c)}else return[]}function fm(n,e,t,i){const s=Fs(n,i);if(s){const r=Us(s),o=r.path,a=r.queryId,l=Y(o,e),c=D.fromObject(t),d=new yt(Ps(a),l,c);return Bs(n,o,d)}else return[]}function Zi(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(f,h)=>{const p=Y(f,s);r=r||$e(h,p),o=o||He(h)});let a=n.syncPointTree_.get(s);a?(o=o||He(a),r=r||$e(a,P())):(a=new tl,n.syncPointTree_=n.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=S.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((h,p)=>{const m=$e(p,P());m&&(r=r.updateImmediateChild(h,m))}));const c=rl(a,e);if(!c&&!e._queryParams.loadsAllData()){const f=oi(e);_(!n.queryToTagMap.has(f),"View does not exist, but we have a tag");const h=_m();n.queryToTagMap.set(f,h),n.tagToQueryMap.set(h,f)}const d=si(n.pendingWriteTree_,s);let u=sm(a,e,t,d,r,l);if(!c&&!o&&!i){const f=sl(a,e);u=u.concat(vm(n,e,f))}return u}function $s(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=Y(o,e),c=$e(a,l);if(c)return c});return Ya(s,e,r,t,!0)}function pm(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(c,d)=>{const u=Y(c,t);i=i||$e(d,u)});let s=n.syncPointTree_.get(t);s?i=i||$e(s,P()):(s=new tl,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new Be(i,!0,!1):null,a=si(n.pendingWriteTree_,e._path),l=nl(s,e,a,r?o.getNode():S.EMPTY_NODE,r);return Jp(l)}function kt(n,e){return ll(e,n.syncPointTree_,null,si(n.pendingWriteTree_,P()))}function ll(n,e,t,i){if(N(n.path))return cl(n,e,t,i);{const s=e.get(P());t==null&&s!=null&&(t=$e(s,P()));let r=[];const o=R(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,d=Qa(i,o);r=r.concat(ll(a,l,c,d))}return s&&(r=r.concat(Ms(s,n,i,t))),r}}function cl(n,e,t,i){const s=e.get(P());t==null&&s!=null&&(t=$e(s,P()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=Qa(i,o),d=n.operationForChild(o);d&&(r=r.concat(cl(d,a,l,c)))}),s&&(r=r.concat(Ms(s,n,i,t))),r}function dl(n,e){const t=e.query,i=Xt(n,t);return{hashFn:()=>(Qp(e)||S.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?hm(n,t._path,i):um(n,t._path);{const r=uf(s,t);return Kn(n,t,null,r)}}}}function Xt(n,e){const t=oi(e);return n.queryToTagMap.get(t)}function oi(n){return n._path.toString()+"$"+n._queryIdentifier}function Fs(n,e){return n.tagToQueryMap.get(e)}function Us(n){const e=n.indexOf("$");return _(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new L(n.substr(0,e))}}function Bs(n,e,t){const i=n.syncPointTree_.get(e);_(i,"Missing sync point for query tag that we're tracking");const s=si(n.pendingWriteTree_,e);return Ms(i,t,s,null)}function mm(n){return n.fold((e,t,i)=>{if(t&&He(t))return[ri(t)];{let s=[];return t&&(s=il(t)),G(i,(r,o)=>{s=s.concat(o)}),s}})}function qt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(am())(n._repo,n._path):n}function gm(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=oi(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function _m(){return lm++}function vm(n,e,t){const i=e._path,s=Xt(n,e),r=dl(n,t),o=n.listenProvider_.startListening(qt(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)_(!He(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,d,u)=>{if(!N(c)&&d&&He(d))return[ri(d).query];{let f=[];return d&&(f=f.concat(il(d).map(h=>h.query))),G(u,(h,p)=>{f=f.concat(p)}),f}});for(let c=0;c<l.length;++c){const d=l[c];n.listenProvider_.stopListening(qt(d),Xt(n,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function dg(n){Zh(St),gt(new Je("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return sg(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),Le($r,Fr,n),Le($r,Fr,"esm2017")}ye.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};ye.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};dg();const ug={apiKey:"AIzaSyCzdkKcfNvafQ3x9NDUsTn8UOww7_v3nn0",authDomain:"who-s-the-queen-bee.firebaseapp.com",databaseURL:"https://who-s-the-queen-bee-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"who-s-the-queen-bee",storageBucket:"who-s-the-queen-bee.firebasestorage.app",messagingSenderId:"808367557368",appId:"1:808367557368:web:7af8a2948e62494c5e490d"},Rl=No(ug),hg=Jh(Rl),C=lg(Rl),fg="modulepreload",pg=function(n){return"/queen-bee-scorecard/"+n},_o={},Al=function(e,t,i){let s=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),a=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(t.map(l=>{if(l=pg(l),l in _o)return;_o[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":fg,c||(u.as="script"),u.crossOrigin="",u.href=l,a&&u.setAttribute("nonce",a),document.head.appendChild(u),c)return new Promise((f,h)=>{u.addEventListener("load",f),u.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return s.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return e().catch(r)})};async function je(){const n=await ee(I(C,"employees"));return n.exists()?n.val():{}}async function fi(n,e){await Ce(I(C,`employees/${n}`),e)}function We(n=new Date){return`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}`}async function pn(n,e=We()){const t=await ee(I(C,`monthly_points/${e}/${n}`));return t.exists()?t.val():{points:0,rank:null,db_count:0,db_pts_deducted:0,net_points:0}}async function Nl(n,e,t=We()){const i=await pn(n,t),s={...i,points:(i.points||0)+e,net_points:(i.net_points||0)+e};return await $(I(C,`monthly_points/${t}/${n}`),s),s}function pi(n=We(),e){const t=I(C,`monthly_points/${n}`);return Xs(t,i=>e(i.exists()?i.val():{})),()=>Zs(t)}async function mn(n){const e=await ee(I(C,`vault/${n}`));return e.exists()?e.val():{total_earned:0,total_deducted:0,net:0,last_reset_date:null}}async function Pl(n,e){const t=await mn(n),i={...t,total_earned:(t.total_earned||0)+e,net:(t.net||0)+e};return await $(I(C,`vault/${n}`),i),i}async function Ol(n){const e=fn(I(C,"awards")),t={...n,timestamp:Date.now()};return await $(e,t),e.key}async function Ll(n){const e=await ee(I(C,"awards"));if(!e.exists())return[];const t=e.val();return Object.entries(t).map(([i,s])=>({id:i,...s})).filter(i=>i.receiver_id===n).sort((i,s)=>s.timestamp-i.timestamp)}async function er(n){const e=await ee(I(C,"awards"));if(!e.exists())return[];const t=e.val();return Object.entries(t).map(([i,s])=>({id:i,...s})).filter(i=>i.giver_id===n).sort((i,s)=>s.timestamp-i.timestamp)}async function Dl(n){const e=fn(I(C,"dark_beans")),t={...n,timestamp:Date.now(),appealed:!1,appeal_status:null};return await $(e,t),e.key}async function Ml(n,e=We()){const t=await ee(I(C,"dark_beans"));if(!t.exists())return[];const i=t.val();return Object.entries(i).map(([s,r])=>({id:s,...r})).filter(s=>s.receiver_id===n&&s.month_key===e).sort((s,r)=>r.timestamp-s.timestamp)}async function tr(n,e,t){const i=await ee(I(C,`offense_escalation/${n}/${e}/${t}`));return i.exists()?i.val().instance_count:0}async function $l(n,e,t){const i=await tr(n,e,t);return await $(I(C,`offense_escalation/${n}/${e}/${t}`),{instance_count:i+1}),i+1}async function gn(){const n=await ee(I(C,"action_menu"));return n.exists()?n.val():{}}async function Fl(n,e){await Ce(I(C,`action_menu/${n}`),e)}async function At(){const n=await ee(I(C,"offense_menu"));return n.exists()?n.val():{}}async function Ul(n,e){await Ce(I(C,`offense_menu/${n}`),e)}async function Bl(n,e,t){await $(I(C,`votes/${n}/${e}`),t)}async function Hl(n=We()){const e=await ee(I(C,`votes/${n}`));return e.exists()?e.val():{}}async function is(n,e){return(await ee(I(C,`votes/${n}/${e}`))).exists()}async function Mt(n){const e=fn(I(C,"audit_flags")),t={...n,timestamp:Date.now(),status:"open",acted_by:null,acted_at:null};return await $(e,t),e.key}async function ql(n,e,t){await Ce(I(C,`audit_flags/${n}`),{status:e,acted_by:t,acted_at:Date.now()})}async function jl(){const n=await ee(I(C,"audit_flags"));return n.exists()?Object.entries(n.val()).map(([e,t])=>({id:e,...t})).sort((e,t)=>t.timestamp-e.timestamp):[]}async function Wl(n){const e=fn(I(C,"pending_registrations"));return await $(e,{...n,submitted_at:Date.now(),status:"pending"}),e.key}async function zl(n,e,t){const i="emp_"+n.slice(-8);return await $(I(C,`employees/${i}`),{name:e.name,email:e.email,role:e.role,outlet:e.outlet,pin_hash:e.pin_hash,active:!0}),await Ce(I(C,`pending_registrations/${n}`),{status:"approved",approved_by:t,approved_at:Date.now()}),i}async function Vl(n,e){await Ce(I(C,`pending_registrations/${n}`),{status:"rejected",rejected_by:e,rejected_at:Date.now()})}function nr(n){const e=I(C,"pending_registrations");return Xs(e,t=>{if(!t.exists()){n([]);return}const i=Object.entries(t.val()).map(([s,r])=>({id:s,...r})).filter(s=>s.status==="pending");n(i)}),()=>Zs(e)}async function Gl(n,e,t,i=We()){const s=await pn(n,i),r={...s,db_count:(s.db_count||0)+e,db_pts_deducted:(s.db_pts_deducted||0)+t,net_points:Math.max(0,(s.net_points||s.points||0)-t)};return await $(I(C,`monthly_points/${i}/${n}`),r),r}async function Kl(n,e){const t=await mn(n),i={...t,total_deducted:(t.total_deducted||0)+e,net:Math.max(0,(t.net||0)-e)};return await $(I(C,`vault/${n}`),i),i}async function Yl(n,e,t,i=We()){const s=await pn(n,i),r={...s,db_count:Math.max(0,(s.db_count||0)-e),db_pts_deducted:Math.max(0,(s.db_pts_deducted||0)-t),net_points:(s.net_points||s.points||0)+t};return await $(I(C,`monthly_points/${i}/${n}`),r),r}async function Ql(n,e){const t=await mn(n),i={...t,total_deducted:Math.max(0,(t.total_deducted||0)-e),net:(t.net||0)+e};return await $(I(C,`vault/${n}`),i),i}async function Jl(n){const e=await ee(I(C,"dark_beans"));return e.exists()?Object.entries(e.val()).map(([t,i])=>({id:t,...i})).filter(t=>t.giver_id===n&&!t.revoked).sort((t,i)=>i.timestamp-t.timestamp):[]}async function Xl(n){const e=fn(I(C,"revoke_requests"));return await $(e,{...n,submitted_at:Date.now(),status:"pending"}),e.key}function ir(n){const e=I(C,"revoke_requests");return Xs(e,t=>{if(!t.exists()){n([]);return}const i=Object.entries(t.val()).map(([s,r])=>({id:s,...r})).filter(s=>s.status==="pending");n(i)}),()=>Zs(e)}async function Zl(n,e,t){await Promise.all([Yl(e.receiver_id,e.db_count,e.pts_deducted,e.month_key),Ql(e.receiver_id,e.pts_deducted),Ce(I(C,`dark_beans/${e.dark_bean_id}`),{revoked:!0,revoked_at:Date.now(),revoked_by:t}),Ce(I(C,`revoke_requests/${n}`),{status:"approved",approved_by:t,approved_at:Date.now()})])}async function ec(n,e){await Ce(I(C,`revoke_requests/${n}`),{status:"rejected",rejected_by:e,rejected_at:Date.now()})}async function tc(){await Promise.all([$(I(C,"awards"),null),$(I(C,"monthly_points"),null),$(I(C,"vault"),null),$(I(C,"dark_beans"),null),$(I(C,"audit_flags"),null),$(I(C,"offense_escalation"),null),$(I(C,"votes"),null),$(I(C,"nominations"),null),$(I(C,"revoke_requests"),null)])}async function nc(){await Promise.all([$(I(C,"employees"),null),$(I(C,"pending_registrations"),null)])}async function ic(){const n=await ee(I(C,"config"));return n.exists()?n.val():{}}const mg=Object.freeze(Object.defineProperty({__proto__:null,addMonthlyPoints:Nl,addVaultPoints:Pl,approveRegistration:zl,approveRevokeRequest:Zl,castVote:Bl,createAuditFlag:Mt,createAward:Ol,createDarkBean:Dl,createRevokeRequest:Xl,deductMonthlyPoints:Gl,deductVaultPoints:Kl,getActions:gn,getAllEmployees:je,getAllFlags:jl,getAwardsByEmployee:Ll,getAwardsByGiver:er,getConfig:ic,getDarkBeansByEmployee:Ml,getDarkBeansByGiver:Jl,getMonthlyPoints:pn,getOffenseInstance:tr,getOffenses:At,getVault:mn,getVotes:Hl,hasVoted:is,incrementOffenseInstance:$l,listenLeaderboard:pi,listenPendingRegistrations:nr,listenRevokeRequests:ir,monthKey:We,nukeAllStaff:nc,nukeTransactionalData:tc,rejectRegistration:Vl,rejectRevokeRequest:ec,reverseDeduction:Yl,reverseVaultDeduction:Ql,submitRegistration:Wl,updateFlagStatus:ql,upsertAction:Fl,upsertEmployee:fi,upsertOffense:Ul},Symbol.toStringTag,{value:"Module"})),mi="hb_bs_session",gg=2*60*60*1e3,_g=30*1e3;function sc(n){const e={...n,loginAt:Date.now()};localStorage.setItem(mi,JSON.stringify(e))}function rc(){try{const n=localStorage.getItem(mi);if(!n)return null;const e=JSON.parse(n);return Date.now()-e.loginAt>gg?(oc(),null):e}catch{return null}}function oc(){localStorage.removeItem(mi)}function vg(){const n=rc();n&&(n.loginAt=Date.now(),localStorage.setItem(mi,JSON.stringify(n)))}function ac(){return setInterval(vg,_g)}async function yg(n){const t=new TextEncoder().encode(n),i=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}async function bg(n,e){const{getAllEmployees:t}=await Al(async()=>{const{getAllEmployees:o}=await Promise.resolve().then(()=>mg);return{getAllEmployees:o}},void 0),i=await t(),s=Object.entries(i).map(([o,a])=>({id:o,...a})).find(o=>o.email===n&&o.active!==!1);if(!s)throw new Error("Employee not found");const r=await yg(e);if(s.pin_hash!==r)throw new Error("Incorrect PIN");return sc(s),s}function Yn(){return!!(window.PublicKeyCredential&&navigator.credentials)}async function wg(n){if(!Yn())return!1;try{const e=crypto.getRandomValues(new Uint8Array(32)),t=new TextEncoder().encode(n.id),i=await navigator.credentials.create({publicKey:{challenge:e,rp:{name:"Heebee Bean System"},user:{id:t,name:n.email,displayName:n.name},pubKeyCredParams:[{type:"public-key",alg:-7}],authenticatorSelection:{authenticatorAttachment:"platform",userVerification:"required"},timeout:6e4,attestation:"none"}});return i?(await fi(n.id,{webauthn_id:Ig(i.rawId)}),!0):!1}catch(e){return console.warn("WebAuthn registration failed, using PIN only:",e.message),!1}}async function Eg(n){if(!Yn()||!n.webauthn_id)return!1;try{const e=crypto.getRandomValues(new Uint8Array(32)),t=Cg(n.webauthn_id);return await navigator.credentials.get({publicKey:{challenge:e,allowCredentials:[{type:"public-key",id:t}],userVerification:"required",timeout:6e4}})?(sc(n),n):!1}catch(e){return console.warn("WebAuthn auth failed, fall back to PIN:",e.message),!1}}function Ig(n){return btoa(String.fromCharCode(...new Uint8Array(n)))}function Cg(n){const e=atob(n),t=new Uint8Array(e.length);for(let i=0;i<e.length;i++)t[i]=e.charCodeAt(i);return t.buffer}function Sg(){oc()}const le={green:{id:"green",icon:"🫘",label:"Green Bean",pts:1,dailyCap:3},silver:{id:"silver",icon:"☕",label:"Silver Bean",pts:5,dailyCap:3},gold:{id:"gold",icon:"🥇",label:"Gold Bean",pts:10,dailyCap:3},crystal:{id:"crystal",icon:"💎",label:"Crystal Bean",pts:25,dailyCap:10}},gi=["Trainee","Barista","Senior Barista","Kitchen Helper","Commi 3","Commi 2","Commi 1","DCDP","CDP"],_i=["Floor Manager","Sous Chef","Cafe Manager","Head Chef","Area Manager","HOD","CEO","COO","Owner"],vi=["HR","Accountant","Admin Staff"],lc={"Floor Manager":["green"],"Sous Chef":["green"],"Cafe Manager":["silver"],"Head Chef":["silver"],"Area Manager":["gold"],HOD:["gold"],CEO:["green","silver","gold","crystal"],COO:["green","silver","gold","crystal"],Owner:["green","silver","gold","crystal"]},Sn={green:{id:"green",icon:"🟢",label:"Minor",base_db:1,pts:5},silver:{id:"silver",icon:"🟠",label:"Moderate",base_db:3,pts:15},gold:{id:"gold",icon:"🔴",label:"Serious",base_db:5,pts:25},crystal:{id:"crystal",icon:"⚫",label:"Severe",base_db:10,pts:50}},cc={"Floor Manager":["green"],"Sous Chef":["green"],"Cafe Manager":["green","silver"],"Head Chef":["green","silver"],"Area Manager":["green","silver","gold"],HOD:["green","silver","gold"],HR:["green","silver","gold","crystal"],CEO:["green","silver","gold","crystal"],COO:["green","silver","gold","crystal"],Owner:["green","silver","gold","crystal"]},ss=5,dc=[{id:"act_01",name:"Daily Task Completion",applicable_bean_tier:"any",active:!0},{id:"act_02",name:"Perfect Attendance",applicable_bean_tier:"any",active:!0},{id:"act_03",name:"Upsell Achievement",applicable_bean_tier:"silver",active:!0},{id:"act_04",name:"Training Completion",applicable_bean_tier:"any",active:!0},{id:"act_05",name:"Customer Recovery Handle",applicable_bean_tier:"silver",active:!0},{id:"act_06",name:"Outlet Opening Standard",applicable_bean_tier:"any",active:!0},{id:"act_07",name:"Special Initiative",applicable_bean_tier:"gold",active:!0}],uc=[{id:"off_01",name:"Late Arrival",base_db:1,escalation:"double",submission_cap:8,active:!0},{id:"off_02",name:"No-Show No Notice",base_db:5,escalation:"double",submission_cap:20,active:!0},{id:"off_03",name:"Negligence",base_db:2,escalation:"double",submission_cap:16,active:!0},{id:"off_04",name:"Duty Denial",base_db:3,escalation:"double",submission_cap:24,active:!0},{id:"off_05",name:"Misconduct",base_db:4,escalation:"double",submission_cap:32,active:!0},{id:"off_06",name:"Serious/Insubordination",base_db:10,escalation:"double",submission_cap:40,active:!0}],sr=[{id:"SHB",name:"Sarabha Nagar",brand:"Heebee Coffee"},{id:"GHB",name:"Ghumar Mandi",brand:"Heebee Coffee"},{id:"JLD",name:"Model Town, Jalandhar",brand:"Heebee Coffee"},{id:"POUR",name:"Pour by Heebee",brand:"Pour"}];function hc(n){return gi.includes(n)}function rr(n){return _i.includes(n)}function fc(n){return vi.includes(n)}function ct(n){return n==="HR"}function ce(n){return["CEO","COO","Owner"].includes(n)}function pc(n){const e={},t={};n.forEach(({giver_id:s,receiver_id:r,points_value:o})=>{e[s]=(e[s]||0)+o;const a=`${s}::${r}`;t[a]=(t[a]||0)+o});const i=[];return Object.entries(t).forEach(([s,r])=>{const[o,a]=s.split("::"),l=e[o]||0;l>0&&r/l>.6&&i.push({type:"bias_concentration",giver_id:o,receiver_id:a,pct:Math.round(r/l*100)})}),i}function mc(n){return n>=100?"disciplinary":n>=51?"owners_notified":n>=26?"suggest_disqualify":n>=10?"silent_flag":null}function gc(n){const e={green:0,silver:0,gold:0,crystal:0};return n.forEach(({bean_type:t})=>{e[t]!==void 0&&e[t]++}),Object.entries(e).filter(([,t])=>t>0).map(([t,i])=>`${le[t].icon} ${i}`).join(" · ")}const Tg=Object.freeze(Object.defineProperty({__proto__:null,ADMIN_ROLES:vi,BEAN_TIERS:le,CONDUCT_TIERS:Sn,DB_POINTS_EACH:ss,DEFAULT_ACTIONS:dc,DEFAULT_OFFENSES:uc,GIVER_ROLES:_i,OUTLETS:sr,RECEIVER_ROLES:gi,ROLE_BEAN_PERMISSIONS:lc,ROLE_CONDUCT_PERMISSIONS:cc,checkBiasConcentration:pc,formatBeanCounts:gc,getDBThresholdLevel:mc,isAdmin:fc,isGiver:rr,isHR:ct,isOwner:ce,isReceiver:hc},Symbol.toStringTag,{value:"Module"})),xg=[...gi,..._i,...vi];async function kg(n){const e=new TextEncoder().encode(n),t=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(t)).map(i=>i.toString(16).padStart(2,"0")).join("")}function Rg(n,e){n.innerHTML=`
  ...
  `;const t=n.querySelector("#reg-name"),i=n.querySelector("#reg-email"),s=n.querySelector("#reg-role"),r=n.querySelector("#reg-outlet"),o=[0,1,2,3].map(u=>n.querySelector(`#reg-pin-${u}`)),a=n.querySelector("#reg-error"),l=n.querySelector("#reg-success"),c=n.querySelector("#btn-reg-submit");o.forEach((u,f)=>{u.addEventListener("input",h=>{const p=h.target.value.replace(/\D/g,"");h.target.value=p,p&&f<3&&o[f+1].focus()}),u.addEventListener("keydown",h=>{h.key==="Backspace"&&!u.value&&f>0&&(o[f-1].focus(),o[f-1].value="")})}),n.querySelector("#btn-reg-back").addEventListener("click",e),c.addEventListener("click",async()=>{a.classList.add("hidden");const u=t.value.trim(),f=i.value.trim().toLowerCase(),h=s.value,p=r.value,m=o.map(b=>b.value).join("");if(!u)return d("Enter your full name");if(!f.includes("@"))return d("Enter a valid email");if(!h)return d("Select your role");if(!p)return d("Select your outlet");if(m.length<4)return d("Enter a 4-digit PIN");c.disabled=!0,c.textContent="Submitting…";try{const b=await kg(m);await Wl({name:u,email:f,role:h,outlet:p,pin_hash:b}),l.textContent="Request sent! Your manager will approve your account shortly.",l.classList.remove("hidden"),c.textContent="Submitted!",setTimeout(e,3e3)}catch{d("Something went wrong. Please try again."),c.disabled=!1,c.textContent="Submit Registration"}});function d(u){a.textContent=u,a.classList.remove("hidden")}}function _c(n,e){n.innerHTML=`
...
👤 From: ${i} · 📋 ${s}`})}async function Yg(n,e,t){n.innerHTML=`
  ...
  `;let i=e.role==="HR"?"conduct":"award",s={},r={},o={},a=[];try{[s,r,o]=await Promise.all([je(),gn(),At()]),a=Object.entries(s).map(([d,u])=>({id:d,...u})).filter(d=>hc(d.role)&&d.active!==!1).sort((d,u)=>d.name.localeCompare(u.name))}catch{n.querySelector("#award-content").innerHTML='<p class="text-dim text-sm text-center">Failed to load. Check connection.</p>';return}n.querySelectorAll(".award-tab").forEach(d=>{d.addEventListener("click",()=>{i=d.dataset.tab,n.querySelectorAll(".award-tab").forEach(u=>{u.className=u.dataset.tab===i?"btn btn-primary award-tab":"btn btn-ghost award-tab",u.style.flex="1",u.style.padding="10px"}),i==="award"?l():c()})}),e.role==="HR"?c():l();function l(){const d=n.querySelector("#award-content"),u=lc[e.role]||[],f=Object.entries(r).map(([v,T])=>({id:v,...T})).filter(v=>v.active!==!1);if(a.length===0){d.innerHTML=`
    ...
    `;const p=d.querySelector("#emp-list"),m=d.querySelector("#search-emp");let b=a;function x(){p.innerHTML=b.map(v=>{var T,B;return`
        <div class="lb-row emp-row" data-id="${v.id}" style="cursor:pointer;margin-bottom:6px;${((T=h.receiver)==null?void 0:T.id)===v.id?"border-color:var(--gold);background:rgba(201,168,76,0.06);":""}">
          <div style="flex:1;">
            <p style="font-size:0.9rem;">${v.name}</p>
            <p class="text-xs text-dim">${v.role} · ${v.outlet}</p>
          </div>
          ${((B=h.receiver)==null?void 0:B.id)===v.id?'<span class="text-gold">✓</span>':""}
        </div>
      `}).join(""),p.querySelectorAll(".emp-row").forEach(v=>{v.addEventListener("click",()=>{h.receiver=a.find(T=>T.id===v.dataset.id),x(),y()})})}m.addEventListener("input",()=>{const v=m.value.toLowerCase();b=v?a.filter(T=>T.name.toLowerCase().includes(v)):a,x()}),x(),d.querySelectorAll(".bean-type-btn").forEach(v=>{v.addEventListener("click",()=>{h.beanType=v.dataset.type,d.querySelectorAll(".bean-type-btn").forEach(T=>{T.style.borderColor=T.dataset.type===h.beanType?"var(--gold)":"var(--border)",T.style.background=T.dataset.type===h.beanType?"rgba(201,168,76,0.1)":"var(--glass-bg)"}),y()})}),d.querySelectorAll(".action-btn").forEach(v=>{v.addEventListener("click",()=>{h.actionId=v.dataset.id,d.querySelectorAll(".action-btn").forEach(T=>{T.style.background=T.dataset.id===h.actionId?"rgba(201,168,76,0.15)":"",T.style.borderColor=T.dataset.id===h.actionId?"rgba(201,168,76,0.4)":"",T.style.color=T.dataset.id===h.actionId?"var(--gold)":""}),y()})});const g=d.querySelector("#qty-display");d.querySelector("#btn-minus").addEventListener("click",()=>{h.quantity>1&&(h.quantity--,g.textContent=h.quantity)}),d.querySelector("#btn-plus").addEventListener("click",()=>{const v=h.beanType?le[h.beanType].dailyCap:10;h.quantity<v&&(h.quantity++,g.textContent=h.quantity)});const E=d.querySelector("#btn-submit"),w=d.querySelector("#award-error");function y(){E.disabled=!(h.receiver&&h.beanType&&h.actionId)}E.addEventListener("click",async()=>{if(!(!h.receiver||!h.beanType||!h.actionId)){E.disabled=!0,E.textContent="Awarding…",w.classList.add("hidden");try{const v=le[h.beanType],T=v.pts*h.quantity;await Ol({giver_id:e.id,giver_name:e.name,receiver_id:h.receiver.id,bean_type:h.beanType,points_value:v.pts,action_id:h.actionId,reason_text:d.querySelector("#inp-reason").value.trim(),outlet:e.outlet,quantity:h.quantity}),await Promise.all([Nl(h.receiver.id,T),Pl(h.receiver.id,T)]),await Kg({receiverName:h.receiver.name,beanType:h.beanType,pts:T,giverName:e.name,actionName:h.actionId});const B=await er(e.id),z=Qe(),K=B.filter(se=>{const fe=new Date(se.timestamp);return`${fe.getFullYear()}-${String(fe.getMonth()+1).padStart(2,"0")}`===z}),X=pc(K);for(const se of X)await Mt({type:"bias_concentration",giver_id:se.giver_id,receiver_id:se.receiver_id,suggestion_text:`${e.name} has directed ${se.pct}% of their beans to one person this month.`,suggestion:"Review award distribution to ensure fairness across the team."}).catch(()=>{});d.innerHTML=`
          <div class="text-center" style="padding:60px 20px;">
            <div style="font-size:3rem;margin-bottom:16px;">${v.icon}</div>
            <h2 style="margin-bottom:8px;">${v.label} Awarded!</h2>
            <p class="text-dim">+${T} pts to <strong>${h.receiver.name}</strong></p>
    ...
    `;const p=d.querySelector("#emp-list-c"),m=d.querySelector("#search-emp-c");let b=a;function x(){p.innerHTML=b.map(y=>{var v,T;return`
        <div class="lb-row emp-row-c" data-id="${y.id}" style="cursor:pointer;margin-bottom:6px;${((v=h.receiver)==null?void 0:v.id)===y.id?"border-color:rgba(255,69,58,0.5);background:rgba(255,69,58,0.06);":""}">
          <div style="flex:1;"><p style="font-size:0.9rem;">${y.name}</p><p class="text-xs text-dim">${y.role} · ${y.outlet}</p></div>
          ${((T=h.receiver)==null?void 0:T.id)===y.id?'<span style="color:var(--red);">✓</span>':""}
        </div>
      `}).join(""),p.querySelectorAll(".emp-row-c").forEach(y=>{y.addEventListener("click",()=>{h.receiver=a.find(v=>v.id===y.dataset.id),x(),g()})})}m.addEventListener("input",()=>{const y=m.value.toLowerCase();b=y?a.filter(v=>v.name.toLowerCase().includes(y)):a,x()}),x(),d.querySelectorAll(".conduct-tier-btn").forEach(y=>{y.addEventListener("click",()=>{h.tier=y.dataset.type,d.querySelectorAll(".conduct-tier-btn").forEach(v=>{v.style.borderColor=v.dataset.type===h.tier?"rgba(255,69,58,0.6)":"var(--border)",v.style.background=v.dataset.type===h.tier?"rgba(255,69,58,0.1)":"var(--glass-bg)"}),g()})}),d.querySelectorAll(".offense-btn").forEach(y=>{y.addEventListener("click",()=>{h.offenseId=y.dataset.id,d.querySelectorAll(".offense-btn").forEach(v=>{v.style.background=v.dataset.id===h.offenseId?"rgba(255,69,58,0.12)":"",v.style.borderColor=v.dataset.id===h.offenseId?"rgba(255,69,58,0.4)":"",v.style.color=v.dataset.id===h.offenseId?"var(--red)":""}),g()})});async function g(){const y=d.querySelector("#conduct-preview"),v=d.querySelector("#btn-conduct-submit");if(!h.receiver||!h.tier||!h.offenseId){y.classList.add("hidden"),v.disabled=!0;return}y.innerHTML='<div class="spinner" style="margin:0 auto;"></div>',y.classList.remove("hidden");const T=Sn[h.tier],B=Qe(),z=await tr(h.receiver.id,B,h.offenseId)+1,K=Math.pow(2,z-1),X=T.base_db*K,se=X*ss,st=["1st","2nd","3rd","4th","5th"][z-1]||`${z}th`,Nt=f.find(ar=>ar.id===h.offenseId);y.innerHTML=`
      ...
      `,v.disabled=!1}const E=d.querySelector("#conduct-error"),w=d.querySelector("#btn-conduct-submit");w.addEventListener("click",async()=>{if(!(!h.receiver||!h.tier||!h.offenseId)){w.disabled=!0,w.textContent="Issuing…",E.classList.add("hidden");try{const y=Qe(),v=Pg(),T=Sn[h.tier],B=f.find(ze=>ze.id===h.offenseId),K=(await Ml(h.receiver.id,y)).filter(ze=>ze.offense_id===h.offenseId&&!ze.revoked),X=await $l(h.receiver.id,y,h.offenseId),se=Math.pow(2,X-1),fe=T.base_db*se,st=fe*ss;await Dl({giver_id:e.id,giver_name:e.name,receiver_id:h.receiver.id,offense_id:h.offenseId,conduct_tier:h.tier,db_count:fe,pts_deducted:st,month_key:y,note:d.querySelector("#inp-conduct-note").value.trim(),instance:X,multiplier:se});const Nt=await Gl(h.receiver.id,fe,st,y);await Kl(h.receiver.id,st),K.filter(ze=>{const bi=new Date(ze.timestamp),yc=`${bi.getFullYear()}-${String(bi.getMonth()+1).padStart(2,"0")}-${String(bi.getDate()).padStart(2,"0")}`;return ze.giver_id!==e.id&&yc===v}).length>0&&await Mt({type:"cross_conduct",receiver_id:h.receiver.id,giver_id:e.id,suggestion_text:`${h.receiver.name} received "${B==null?void 0:B.name}" conduct from multiple managers on the same day. Possible duplicate issuance.`,suggestion:"Confirm with both managers this is not a duplicate. Consider revoking one."}).catch(()=>{}),K.length>=3&&await Mt({type:"conduct_frequency",receiver_id:h.receiver.id,giver_id:e.id,suggestion_text:`${h.receiver.name} has now received "${B==null?void 0:B.name}" conduct ${K.length+1} times this month.`,suggestion:"High frequency of same conduct. Escalate to formal HR review or disciplinary process."}).catch(()=>{});const lr=Nt.db_count||0,yi=mc(lr);yi&&await Mt({type:"db_threshold",receiver_id:h.receiver.id,giver_id:e.id,suggestion_text:`${h.receiver.name} has accumulated ${lr} Dark Beans this month (${yi.replace(/_/g," ")}).`,suggestion:yi==="disciplinary"?"Consider formal disciplinary action.":"Review conduct history and consider counselling."}).catch(()=>{}),d.innerHTML=`
          <div class="text-center" style="padding:60px 20px;">
  ...
  `;let s="flags";const r=n.querySelector("#audit-content");n.querySelectorAll(".audit-tab").forEach(d=>{d.addEventListener("click",()=>{s=d.dataset.tab,n.querySelectorAll(".audit-tab").forEach(u=>{u.className=u.dataset.tab===s?"btn btn-primary audit-tab":"btn btn-ghost audit-tab",u.style.flex="1",u.style.padding="10px"}),o(s)})});async function o(d){r.innerHTML='<div class="loading-center" style="min-height:30vh;"><div class="spinner"></div></div>',d==="flags"&&await a(),d==="log"&&await l(),d==="reset"&&c()}async function a(){try{const d=await jl(),u=d.filter(h=>h.status==="open"),f=d.filter(h=>h.status!=="open");if(!d.length){r.innerHTML=`
      ...
      `,r.querySelectorAll(".flag-action-btn").forEach(h=>{h.addEventListener("click",async()=>{const{flagId:p,action:m}=h.dataset;h.disabled=!0,await ql(p,m,e.id),await o("flags")})})}catch{r.innerHTML='<p class="text-dim text-sm text-center">Failed to load flags.</p>'}}async function l(){try{const d="https://who-s-the-queen-bee-default-rtdb.asia-southeast1.firebasedatabase.app",[u,f,h,p,m]=await Promise.all([je(),gn(),At(),fetch(`${d}/awards.json`).then(w=>w.json()),fetch(`${d}/dark_beans.json`).then(w=>w.json())]),b=p?Object.entries(p).map(([w,y])=>({id:w,kind:"award",...y})):[],x=m?Object.entries(m).map(([w,y])=>({id:w,kind:"conduct",...y})):[],g=[...b,...x].sort((w,y)=>y.timestamp-w.timestamp);if(!g.length){r.innerHTML=`
        ...
        ${g.map(w=>{const y=u[w.receiver_id],v=u[w.giver_id],T=(v==null?void 0:v.name)||w.giver_name||w.giver_id||"—",B=(v==null?void 0:v.role)||"";if(w.kind==="award"){const z=le[w.bean_type]||{icon:"🫘",label:w.bean_type},K=f[w.action_id],X=w.points_value*(w.quantity||1);return`
            ...
            `}else{const z=h[w.offense_id],K=E[w.conduct_tier]||"🌑",X=w.revoked?'<span style="color:var(--text-tertiary);font-size:0.7rem;"> · revoked</span>':"";return`
  ...
  `;const s=n.querySelector("#vote-content");try{const[r,o]=await Promise.all([je(),is(t,e.id)]),a=pi(t,d=>{c(d,r,o)}),l=new MutationObserver(()=>{document.contains(s)||(a(),l.disconnect())});l.observe(document.body,{childList:!0,subtree:!0});async function c(d,u,f){const h=Object.entries(d).map(([g,E])=>({id:g,...E,emp:u[g]||{}})).filter(g=>g.emp.active!==!1&&g.emp.role&&s_(g.emp.role)).sort((g,E)=>(E.net_points||E.points||0)-(g.net_points||g.points||0)).slice(0,5).map((g,E)=>({...g,rank:E+1}));if(h.length===0){s.innerHTML=`
        ...
        `;return}const p=ce(e.role)?await Hl(t):{},m={};Object.values(p).forEach(g=>{m[g]=(m[g]||0)+1});const b=Object.values(m).reduce((g,E)=>g+E,0),x=!!f||await is(t,e.id);if(!i){s.innerHTML=`
          ...
          ${h.map(g=>yo(g,!1,null,!1,m,b)).join("")}
        `;return}s.innerHTML=`
        ${x?`
        ...
        `}
        ${h.map(g=>yo(g,!x,f,ce(e.role),m,b)).join("")}
        ${ce(e.role)?`
