 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function J(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function as(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(J())}function Ac(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Nc(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function xo(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Pc(){const n=J();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Oc(){return bo.NODE_ADMIN===!0}function Lc(){try{return typeof indexedDB=="object"}catch{return!1}}function Dc(){return new Promise((n,e)=>{try{let t=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(i),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{var r;e(((r=s.error)===null||r===void 0?void 0:r.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xd(n){gt(new Je("platform-logger",e=>new ud(e),"PRIVATE")),gt(new Je("heartbeat",e=>new Yd(e),"PRIVATE")),De(Fi,pr,n),De(Fi,pr,"esm2017"),De("fire-js","")}Xd("");var Zd="firebase",eu="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nn=new ls("@firebase/auth");function nu(n,...e){Nn.logLevel<=O.WARN&&Nn.warn(`Auth (${St}): ${n}`,...e)}function bn(n,...e){Nn.logLevel<=O.ERROR&&Nn.error(`Auth (${St}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{constructor(e,t){this.shortDelay=e,this.longDelay=t,Ee(t>e,"Short delay should be less than long delay!"),this.isMobile=as()||xo()}get(){return su()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ir(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Ko(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(zo(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Qo(e))return"Blackberry";if(Jo(e))return"Webos";if(Vo(e))return"Safari";if((e.includes("chrome/")||Go(e))&&!e.includes("edge/"))return"Chrome";if(Yo(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function zo(n=J()){return/firefox\//i.test(n)}function Vo(n=J()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Go(n=J()){return/crios\//i.test(n)}function Ko(n=J()){return/iemobile/i.test(n)}function Yo(n=J()){return/android/i.test(n)}function Qo(n=J()){return/blackberry/i.test(n)}function Jo(n=J()){return/webos/i.test(n)}function ms(n=J()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function _u(n=J()){var e;return ms(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function vu(){return Pc()&&document.documentMode===10}function Xo(n=J()){return ms(n)||Yo(n)||Jo(n)||Qo(n)||/windows phone/i.test(n)||Ko(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bu(n,e={}){return Tt(n,"GET","/v2/passwordPolicy",Xn(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ku(n,e){const t=ds(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),r=t.getOptions();if(Rn(r,e??{}))return s;we(s,"already-initialized")}return t.initialize({options:e})}function Ru(n,e){const t=(e==null?void 0:e.persistence)||[],i=(Array.isArray(t)?t:[t]).map(_e);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}function Au(n,e,t){const i=Zn(n);k(i._canInitEmulator,i,"emulator-config-failed"),k(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const s=!1,r=ea(e),{host:o,port:a}=Nu(e),l=a===null?"":`:${a}`;i.config.emulator={url:`${r}//${o}${l}/`},i.settings.appVerificationDisabledForTesting=!0,i.emulatorConfig=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:s})}),Pu()}function ea(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Nu(n){const e=ea(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const i=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const r=s[1];return{host:r,port:Sr(i.substr(r.length+1))}}else{const[r,o]=i.split(":");return{host:r,port:Sr(o)}}}function Sr(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Pu(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ws="5",ya="v",ba="s",wa="r",Ea="f",Ia=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Ca="ls",Sa="p",zi="ac",Ta="websocket",xa="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ni{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new A(_t,e),s=new A(_t,t);return this.compare(i,s)!==0}minPost(){return A.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vi;function ep(n){Vi=n}const Ba=function(n){return typeof n=="number"?"number:"+va(n):"string:"+n},Ha=function(n){if(n.isLeafNode()){const e=n.val();_(typeof e=="string"||typeof e=="number"||typeof e=="object"&&he(e,".sv"),"Priority must be a string or number.")}else _(n===Vi||n.isEmpty(),"priority of unexpected type.");_(n===Vi||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cp extends ni{compare(e,t){const i=e.node.compareTo(t.node);return i===0?nt(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return A.MIN}maxPost(){return A.MAX}makePost(e,t){const i=H(e);return new A(t,i)}toString(){return".value"}}const dp=new cp;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ks{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){_(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(Kt(t,a)):_(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(vt(t,i)):o.trackChildChange(Yt(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(U,(s,r)=>{t.hasChild(s)||i.trackChildChange(Kt(s,r))}),t.isLeafNode()||t.forEachChild(U,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(Yt(s,r,o))}else i.trackChildChange(vt(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?S.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var oe;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(oe||(oe={}));function As(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Ns(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Ps(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hn{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=oe.ACK_USER_WRITE,this.source=As()}operationForChild(e){if(N(this.path)){if(this.affectedTree.value!=null)return _(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new L(e));return new Hn(P(),t,this.revert)}}else return _(R(this.path)===e,"operationForChild called for unrelated child."),new Hn(M(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ii(n,e){return{eventCache:n,serverCache:e}}function Bt(n,e,t,i){return ii(new He(e,t,i),n.serverCache)}function Va(n,e,t,i){return ii(n.eventCache,new He(e,t,i))}function qn(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function tt(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function si(n,e){return Ja(e,n)}function Sp(n,e,t,i,s){_(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=Ht(n.visibleWrites,e,t)),n.lastWriteId=i}function Tp(n,e,t,i){_(i>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:i,visible:!0}),n.visibleWrites=Ki(n.visibleWrites,e,t),n.lastWriteId=i}function xp(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function kp(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);_(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&Rp(a,i.path)?s=!1:ne(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return Ap(n),!0;if(i.snap)n.visibleWrites=no(n.visibleWrites,i.path);else{const a=i.children;G(a,l=>{n.visibleWrites=no(n.visibleWrites,F(i.path,l))})}return!0}else return!1}function Rp(n,e){if(n.snap)return ne(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&ne(F(n.path,t),e))return!0;return!1}function Ap(n){n.visibleWrites=Ka(n.allWrites,Np,P()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function Np(n){return n.visible}function Ka(n,e,t){let i=ae.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)ne(t,o)?(a=Y(t,o),i=Ht(i,a,r.snap)):ne(o,t)&&(a=Y(o,t),i=Ht(i,P(),r.snap.getChild(a)));else if(r.children){if(ne(t,o))a=Y(t,o),i=Ki(i,a,r.children);else if(ne(o,t))if(a=Y(o,t),N(a))i=Ki(i,P(),r.children);else{const l=mt(r.children,R(a));if(l){const c=l.getChild(M(a));i=Ht(i,P(),c)}}}else throw It("WriteRecord should have .snap or .children")}}return i}function Ya(n,e,t,i,s){if(!i&&!s){const r=it(n.visibleWrites,e);if(r!=null)return r;{const o=$e(n.visibleWrites,e);if(Qi(o))return t;if(t==null&&!Yi(o,P()))return null;{const a=t||S.EMPTY_NODE;return bt(o,a)}}}else{const r=$e(n.visibleWrites,e);if(!s&&Qi(r))return t;if(!s&&t==null&&!Yi(r,P()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(ne(c.path,e)||ne(e,c.path))},a=Ka(n.allWrites,o,e),l=t||S.EMPTY_NODE;return bt(a,l)}}}function Pp(n,e,t){let i=S.EMPTY_NODE;const s=it(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(U,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=$e(n.visibleWrites,e);return t.forEachChild(U,(o,a)=>{const l=bt($e(r,new L(o)),a);i=i.updateImmediateChild(o,l)}),io(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=$e(n.visibleWrites,e);return io(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function Op(n,e,t,i,s){_(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=F(e,t);if(Yi(n.visibleWrites,r))return null;{const o=$e(n.visibleWrites,r);return Qi(o)?s.getChild(t):bt(o,s.getChild(t))}}function Lp(n,e,t,i){const s=F(e,t),r=it(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=$e(n.visibleWrites,s);return bt(o,i.getNode().getImmediateChild(t))}else return null}function Dp(n,e){return it(n.visibleWrites,e)}function Mp(n,e,t,i,s,r,o){let a;const l=$e(n.visibleWrites,e),c=it(l,P());if(c!=null)a=c;else if(t!=null)a=bt(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const d=[],u=o.getCompare(),h=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let f=h.getNext();for(;f&&d.length<s;)u(f,i)!==0&&d.push(f),f=h.getNext();return d}else return[]}function $p(){return{visibleWrites:ae.empty(),allWrites:[],lastWriteId:-1}}function jn(n,e,t,i){return Ya(n.writeTree,n.treePath,e,t,i)}function Os(n,e){return Pp(n.writeTree,n.treePath,e)}function so(n,e,t,i){return Op(n.writeTree,n.treePath,e,t,i)}function Wn(n,e){return Dp(n.writeTree,F(n.treePath,e))}function Fp(n,e,t,i,s,r){return Mp(n.writeTree,n.treePath,e,t,i,s,r)}function Ls(n,e,t){return Lp(n.writeTree,n.treePath,e,t)}function Qa(n,e){return Ja(F(n.treePath,e),n.writeTree)}function Ja(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bp{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const Xa=new Bp;class Ds{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new He(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ls(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:tt(this.viewCache_),r=Fp(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Gn;function om(n){_(!Gn,"__referenceConstructor has already been defined"),Gn=n}function am(){return _(Gn,"Reference.ts has not been loaded"),Gn}let lm=1;class uo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new D(null),this.pendingWriteTree_=$p(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ol(n,e,t,i,s){return Sp(n.pendingWriteTree_,e,t,i,s),s?kt(n,new et(As(),e,t)):[]}function cm(n,e,t,i){Tp(n.pendingWriteTree_,e,t,i);const s=D.fromObject(t);return kt(n,new yt(As(),e,s))}function Pe(n,e,t=!1){const i=xp(n.pendingWriteTree_,e);if(kp(n.pendingWriteTree_,e)){let r=new D(null);return i.snap!=null?r=r.set(P(),!0):G(i.children,o=>{r=r.set(new L(o),!0)}),kt(n,new Hn(i.path,r,t))}else return[]}function dn(n,e,t){return kt(n,new et(Ns(),e,t))}function dm(n,e,t){const i=D.fromObject(t);return kt(n,new yt(Ns(),e,i))}function um(n,e){return kt(n,new Jt(Ns(),e))}function hm(n,e,t){const i=Fs(n,t);if(i){const s=Us(i),r=s.path,o=s.queryId,a=Y(r,e),l=new Jt(Ps(o),a);return Bs(n,r,l)}else return[]}function Kn(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||rl(o,e))){const l=rm(o,e,t,i);im(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const d=c.findIndex(h=>h._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(h,f)=>qe(f));if(d&&!u){const h=n.syncPointTree_.subtree(r);if(!h.isEmpty()){const f=mm(h);for(let p=0;p<f.length;++p){const m=f[p],b=m.query,x=dl(n,m);n.listenProvider_.startListening(qt(b),Xt(n,b),x.hashFn,x.onComplete)}}}!u&&c.length>0&&!i&&(d?n.listenProvider_.stopListening(qt(e),null):c.forEach(h=>{const f=n.queryToTagMap.get(oi(h));n.listenProvider_.stopListening(qt(h),f)}))}gm(n,c)}return a}function al(n,e,t,i){const s=Fs(n,i);if(s!=null){const r=Us(s),o=r.path,a=r.queryId,l=Y(o,e),c=new et(Ps(a),l,t);return Bs(n,o,c)}else return[]}function fm(n,e,t,i){const s=Fs(n,i);if(s){const r=Us(s),o=r.path,a=r.queryId,l=Y(o,e),c=D.fromObject(t),d=new yt(Ps(a),l,c);return Bs(n,o,d)}else return[]}function Zi(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(h,f)=>{const p=Y(h,s);r=r||Fe(f,p),o=o||qe(f)});let a=n.syncPointTree_.get(s);a?(o=o||qe(a),r=r||Fe(a,P())):(a=new tl,n.syncPointTree_=n.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=S.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((f,p)=>{const m=Fe(p,P());m&&(r=r.updateImmediateChild(f,m))}));const c=rl(a,e);if(!c&&!e._queryParams.loadsAllData()){const h=oi(e);_(!n.queryToTagMap.has(h),"View does not exist, but we have a tag");const f=_m();n.queryToTagMap.set(h,f),n.tagToQueryMap.set(f,h)}const d=si(n.pendingWriteTree_,s);let u=sm(a,e,t,d,r,l);if(!c&&!o&&!i){const h=sl(a,e);u=u.concat(vm(n,e,h))}return u}function $s(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=Y(o,e),c=Fe(a,l);if(c)return c});return Ya(s,e,r,t,!0)}function pm(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(c,d)=>{const u=Y(c,t);i=i||Fe(d,u)});let s=n.syncPointTree_.get(t);s?i=i||Fe(s,P()):(s=new tl,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new He(i,!0,!1):null,a=si(n.pendingWriteTree_,e._path),l=nl(s,e,a,r?o.getNode():S.EMPTY_NODE,r);return Jp(l)}function kt(n,e){return ll(e,n.syncPointTree_,null,si(n.pendingWriteTree_,P()))}function ll(n,e,t,i){if(N(n.path))return cl(n,e,t,i);{const s=e.get(P());t==null&&s!=null&&(t=Fe(s,P()));let r=[];const o=R(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,d=Qa(i,o);r=r.concat(ll(a,l,c,d))}return s&&(r=r.concat(Ms(s,n,i,t))),r}}function cl(n,e,t,i){const s=e.get(P());t==null&&s!=null&&(t=Fe(s,P()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=Qa(i,o),d=n.operationForChild(o);d&&(r=r.concat(cl(d,a,l,c)))}),s&&(r=r.concat(Ms(s,n,i,t))),r}function dl(n,e){const t=e.query,i=Xt(n,t);return{hashFn:()=>(Qp(e)||S.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?hm(n,t._path,i):um(n,t._path);{const r=uf(s,t);return Kn(n,t,null,r)}}}}function Xt(n,e){const t=oi(e);return n.queryToTagMap.get(t)}function oi(n){return n._path.toString()+"$"+n._queryIdentifier}function Fs(n,e){return n.tagToQueryMap.get(e)}function Us(n){const e=n.indexOf("$");return _(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new L(n.substr(0,e))}}function Bs(n,e,t){const i=n.syncPointTree_.get(e);_(i,"Missing sync point for query tag that we're tracking");const s=si(n.pendingWriteTree_,e);return Ms(i,t,s,null)}function mm(n){return n.fold((e,t,i)=>{if(t&&qe(t))return[ri(t)];{let s=[];return t&&(s=il(t)),G(i,(r,o)=>{s=s.concat(o)}),s}})}function qt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(am())(n._repo,n._path):n}function gm(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=oi(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function _m(){return lm++}function vm(n,e,t){const i=e._path,s=Xt(n,e),r=dl(n,t),o=n.listenProvider_.startListening(qt(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)_(!qe(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,d,u)=>{if(!N(c)&&d&&qe(d))return[ri(d).query];{let h=[];return d&&(h=h.concat(il(d).map(f=>f.query))),G(u,(f,p)=>{h=h.concat(p)}),h}});for(let c=0;c<l.length;++c){const d=l[c];n.listenProvider_.stopListening(qt(d),Xt(n,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sm=/[\[\].#$\/\u0000-\u001F\u007F]/,Tm=/[\[\].#$\u0000-\u001F\u007F]/,Oi=10*1024*1024,Vs=function(n){return typeof n=="string"&&n.length!==0&&!Sm.test(n)},gl=function(n){return typeof n=="string"&&n.length!==0&&!Tm.test(n)},xm=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),gl(n)},km=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!ys(n)||n&&typeof n=="object"&&he(n,".sv")},_l=function(n,e,t,i){i&&e===void 0||li(Qn(n,"value"),e,t)},li=function(n,e,t){const i=t instanceof L?new zf(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+Ge(i));if(typeof e=="function")throw new Error(n+"contains a function "+Ge(i)+" with contents = "+e.toString());if(ys(e))throw new Error(n+"contains "+e.toString()+" "+Ge(i));if(typeof e=="string"&&e.length>Oi/3&&Jn(e)>Oi)throw new Error(n+"contains a string greater than "+Oi+" utf8 bytes "+Ge(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(G(e,(o,a)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Vs(o)))throw new Error(n+" contains an invalid key ("+o+") "+Ge(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Vf(i,o),li(n,a,i),Gf(i)}),s&&r)throw new Error(n+' contains ".value" child '+Ge(i)+" in addition to actual children.")}},Rm=function(n,e){let t,i;for(t=0;t<e.length;t++){i=e[t];const r=Gt(i);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!Vs(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+i.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(Wf);let s=null;for(t=0;t<e.length;t++){if(i=e[t],s!==null&&ne(s,i))throw new Error(n+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}},Am=function(n,e,t,i){const s=Qn(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(s+" must be an object containing the children to replace.");const r=[];G(e,(o,a)=>{const l=new L(o);if(li(s,a,F(t,l)),Cs(l)===".priority"&&!km(a))throw new Error(s+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(l)}),Rm(s,r)},vl=function(n,e,t,i){if(!gl(t))throw new Error(Qn(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Nm=function(n,e,t,i){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),vl(n,e,t)},yl=function(n,e){if(R(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Pm=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Vs(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!xm(t))throw new Error(Qn(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dm="repo_interrupt",Mm=25;class $m{constructor(e,t,i,s){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Om,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Bn(),this.transactionQueueTree_=new Ws,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Fm(n,e,t){if(n.stats_=Es(n.repoInfo_),n.forceRestClient_||mf())n.server_=new Un(n.repoInfo_,(i,s,r,o)=>{fo(n,i,s,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>po(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{q(t)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}n.persistentConnection_=new ye(n.repoInfo_,e,(i,s,r,o)=>{fo(n,i,s,r,o)},i=>{po(n,i)},i=>{Um(n,i)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(i=>{n.server_.refreshAuthToken(i)}),n.appCheckProvider_.addTokenChangeListener(i=>{n.server_.refreshAppCheckToken(i.token)}),n.statsReporter_=bf(n.repoInfo_,()=>new yp(n.stats_,n.server_)),n.infoData_=new pp,n.infoSyncTree_=new uo({startListening:(i,s,r,o)=>{let a=[];const l=n.infoData_.getNode(i._path);return l.isEmpty()||(a=dn(n.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Gs(n,"connected",!1),n.serverSyncTree_=new uo({startListening:(i,s,r,o)=>(n.server_.listen(i,r,s,(a,l)=>{const c=o(a,l);ie(n.eventQueue_,i._path,c)}),[]),stopListening:(i,s)=>{n.server_.unlisten(i,s)}})}function El(n){const t=n.infoData_.getNode(new L(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function di(n){return ym({timestamp:El(n)})}function fo(n,e,t,i,s){n.dataUpdateCount++;const r=new L(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(s)if(i){const l=kn(t,c=>H(c));o=fm(n.serverSyncTree_,r,l,s)}else{const l=H(t);o=al(n.serverSyncTree_,r,l,s)}else if(i){const l=kn(t,c=>H(c));o=dm(n.serverSyncTree_,r,l)}else{const l=H(t);o=dn(n.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=wt(n,r)),ie(n.eventQueue_,a,o)}function po(n,e){Gs(n,"connected",e),e===!1&&jm(n)}function Um(n,e){G(e,(t,i)=>{Gs(n,t,i)})}function Gs(n,e,t){const i=new L("/.info/"+e),s=H(t);n.infoData_.updateSnapshot(i,s);const r=dn(n.infoSyncTree_,i,s);ie(n.eventQueue_,i,r)}function Ks(n){return n.nextWriteId_++}function Bm(n,e,t){const i=pm(n.serverSyncTree_,e);return i!=null?Promise.resolve(i):n.server_.get(e).then(s=>{const r=H(s).withIndex(e._queryParams.getIndex());Zi(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=dn(n.serverSyncTree_,e._path,r);else{const a=Xt(n.serverSyncTree_,e);o=al(n.serverSyncTree_,e._path,r,a)}return ie(n.eventQueue_,e._path,o),Kn(n.serverSyncTree_,e,t,null,!0),r},s=>(hn(n,"get for query "+q(e)+" failed: "+s),Promise.reject(new Error(s))))}function Hm(n,e,t,i,s){hn(n,"set",{path:e.toString(),value:t,priority:i});const r=di(n),o=H(t,i),a=$s(n.serverSyncTree_,e),l=hl(o,a,r),c=Ks(n),d=ol(n.serverSyncTree_,e,l,c,!0);ci(n.eventQueue_,d),n.server_.put(e.toString(),o.val(!0),(h,f)=>{const p=h==="ok";p||Q("set at "+e+" failed: "+h);const m=Pe(n.serverSyncTree_,c,!p);ie(n.eventQueue_,e,m),ts(n,s,h,f)});const u=Qs(n,e);wt(n,u),ie(n.eventQueue_,u,[])}function qm(n,e,t,i){hn(n,"update",{path:e.toString(),value:t});let s=!0;const r=di(n),o={};if(G(t,(a,l)=>{s=!1,o[a]=ul(F(e,a),H(l),n.serverSyncTree_,r)}),s)V("update() called with empty data.  Don't do anything."),ts(n,i,"ok",void 0);else{const a=Ks(n),l=cm(n.serverSyncTree_,e,o,a);ci(n.eventQueue_,l),n.server_.merge(e.toString(),t,(c,d)=>{const u=c==="ok";u||Q("update at "+e+" failed: "+c);const h=Pe(n.serverSyncTree_,a,!u),f=h.length>0?wt(n,e):e;ie(n.eventQueue_,f,h),ts(n,i,c,d)}),G(t,c=>{const d=Qs(n,F(e,c));wt(n,d)}),ie(n.eventQueue_,e,[])}}function jm(n){hn(n,"onDisconnectEvents");const e=di(n),t=Bn();Gi(n.onDisconnect_,P(),(s,r)=>{const o=ul(s,r,n.serverSyncTree_,e);za(t,s,o)});let i=[];Gi(t,P(),(s,r)=>{i=i.concat(dn(n.serverSyncTree_,s,r));const o=Qs(n,s);wt(n,o)}),n.onDisconnect_=Bn(),ie(n.eventQueue_,P(),i)}function Wm(n,e,t){let i;R(e._path)===".info"?i=Zi(n.infoSyncTree_,e,t):i=Zi(n.serverSyncTree_,e,t),bl(n.eventQueue_,e._path,i)}function Il(n,e,t){let i;R(e._path)===".info"?i=Kn(n.infoSyncTree_,e,t):i=Kn(n.serverSyncTree_,e,t),bl(n.eventQueue_,e._path,i)}function zm(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Dm)}function hn(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),V(t,...e)}function ts(n,e,t,i){e&&xt(()=>{if(t==="ok")e(null);else{const s=(t||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function Cl(n,e,t){return $s(n.serverSyncTree_,e,t)||S.EMPTY_NODE}function Ys(n,e=n.transactionQueueTree_){if(e||ui(n,e),Rt(e)){const t=Tl(n,e);_(t.length>0,"Sending zero length transaction queue"),t.every(s=>s.status===0)&&Vm(n,un(e),t)}else pl(e)&&ai(e,t=>{Ys(n,t)})}function Vm(n,e,t){const i=t.map(c=>c.currentWriteId),s=Cl(n,e,i);let r=s;const o=s.hash();for(let c=0;c<t.length;c++){const d=t[c];_(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const u=Y(e,d.path);r=r.updateChild(u,d.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;n.server_.put(l.toString(),a,c=>{hn(n,"transaction put response",{path:l.toString(),status:c});let d=[];if(c==="ok"){const u=[];for(let h=0;h<t.length;h++)t[h].status=2,d=d.concat(Pe(n.serverSyncTree_,t[h].currentWriteId)),t[h].onComplete&&u.push(()=>t[h].onComplete(null,!0,t[h].currentOutputSnapshotResolved)),t[h].unwatcher();ui(n,zs(n.transactionQueueTree_,e)),Ys(n,n.transactionQueueTree_),ie(n.eventQueue_,e,d);for(let h=0;h<u.length;h++)xt(u[h])}else{if(c==="datastale")for(let u=0;u<t.length;u++)t[u].status===3?t[u].status=4:t[u].status=0;else{Q("transaction at "+l.toString()+" failed: "+c);for(let u=0;u<t.length;u++)t[u].status=4,t[u].abortReason=c}wt(n,e)}},o)}function wt(n,e){const t=Sl(n,e),i=un(t),s=Tl(n,t);return Gm(n,s,i),i}function Gm(n,e,t){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=Y(t,l.path);let d=!1,u;if(_(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)d=!0,u=l.abortReason,s=s.concat(Pe(n.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=Mm)d=!0,u="maxretry",s=s.concat(Pe(n.serverSyncTree_,l.currentWriteId,!0));else{const h=Cl(n,l.path,o);l.currentInputSnapshot=h;const f=e[a].update(h.val());if(f!==void 0){li("transaction failed: Data returned ",f,l.path);let p=H(f);typeof f=="object"&&f!=null&&he(f,".priority")||(p=p.updatePriority(h.getPriority()));const b=l.currentWriteId,x=di(n),g=hl(p,h,x);l.currentOutputSnapshotRaw=p,l.currentOutputSnapshotResolved=g,l.currentWriteId=Ks(n),o.splice(o.indexOf(b),1),s=s.concat(ol(n.serverSyncTree_,l.path,g,l.currentWriteId,l.applyLocally)),s=s.concat(Pe(n.serverSyncTree_,b,!0))}else d=!0,u="nodata",s=s.concat(Pe(n.serverSyncTree_,l.currentWriteId,!0))}ie(n.eventQueue_,t,s),s=[],d&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(u==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(u),!1,null))))}ui(n,n.transactionQueueTree_);for(let a=0;a<i.length;a++)xt(i[a]);Ys(n,n.transactionQueueTree_)}function Sl(n,e){let t,i=n.transactionQueueTree_;for(t=R(e);t!==null&&Rt(i)===void 0;)i=zs(i,t),e=M(e),t=R(e);return i}function Tl(n,e){const t=[];return xl(n,e,t),t.sort((i,s)=>i.order-s.order),t}function xl(n,e,t){const i=Rt(e);if(i)for(let s=0;s<i.length;s++)t.push(i[s]);ai(e,s=>{xl(n,s,t)})}function ui(n,e){const t=Rt(e);if(t){let i=0;for(let s=0;s<t.length;s++)t[s].status!==2&&(t[i]=t[s],i++);t.length=i,fl(e,t.length>0?t:void 0)}ai(e,i=>{ui(n,i)})}function Qs(n,e){const t=un(Sl(n,e)),i=zs(n.transactionQueueTree_,e);return Im(i,s=>{Li(n,s)}),Li(n,i),ml(i,s=>{Li(n,s)}),t}function Li(n,e){const t=Rt(e);if(t){const i=[];let s=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(_(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(_(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),s=s.concat(Pe(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&i.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?fl(e,void 0):t.length=r+1,ie(n.eventQueue_,un(e),s);for(let o=0;o<i.length;o++)xt(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Js{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return N(this._path)?null:Cs(this._path)}get ref(){return new Te(this._repo,this._path)}get _queryIdentifier(){const e=eo(this._queryParams),t=bs(e);return t==="{}"?"default":t}get _queryObject(){return eo(this._queryParams)}isEqual(e){if(e=te(e),!(e instanceof Js))return!1;const t=this._repo===e._repo,i=Ss(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+jf(this._path)}}class Te extends Js{constructor(e,t){super(e,t,new Rs,!1)}get parent(){const e=$a(this._path);return e===null?null:new Te(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Zt{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new L(e),i=en(this.ref,e);return new Zt(this._node.getChild(t),i,U)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new Zt(s,en(this.ref,i),U)))}hasChild(e){const t=new L(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function I(n,e){return n=te(n),n._checkNotDeleted("ref"),e!==void 0?en(n._root,e):n._root}function en(n,e){return n=te(n),R(n._path)===null?Nm("child","path",e):vl("child","path",e),new Te(n._repo,F(n._path,e))}function fn(n,e){n=te(n),yl("push",n._path),_l("push",e,n._path,!0);const t=El(n._repo),i=Jm(t),s=en(n,i),r=en(n,i);let o;return o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function $(n,e){n=te(n),yl("set",n._path),_l("set",e,n._path,!1);const t=new tn;return Hm(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Ce(n,e){Am("update",e,n._path);const t=new tn;return qm(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function ee(n){n=te(n);const e=new kl(()=>{}),t=new hi(e);return Bm(n._repo,n,t).then(i=>new Zt(i,new Te(n._repo,n._path),n._queryParams.getIndex()))}class hi{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new Xm("value",this,new Zt(e.snapshotNode,new Te(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Zm(this,e,t):null}matches(e){return e instanceof hi?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function eg(n,e,t,i,s){const r=new kl(t,void 0),o=new hi(r);return Wm(n._repo,n,o),()=>Il(n._repo,n,o)}function Xs(n,e,t,i){return eg(n,"value",e)}function Zs(n,e,t){Il(n._repo,n,null)}tm(Te);om(Te);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
👤 From: ${i} · 📋 ${s}`})}async function Yg(n,e,t){n.innerHTML=`
  ...
  `;let i=e.role==="HR"?"conduct":"award",s={},r={},o={},a=[];try{[s,r,o]=await Promise.all([Se(),gn(),At()]),a=Object.entries(s).map(([d,u])=>({id:d,...u})).filter(d=>hc(d.role)&&d.active!==!1).sort((d,u)=>d.name.localeCompare(u.name))}catch{n.querySelector("#award-content").innerHTML='<p class="text-dim text-sm text-center">Failed to load. Check connection.</p>';return}n.querySelectorAll(".award-tab").forEach(d=>{d.addEventListener("click",()=>{i=d.dataset.tab,n.querySelectorAll(".award-tab").forEach(u=>{u.className=u.dataset.tab===i?"btn btn-primary award-tab":"btn btn-ghost award-tab",u.style.flex="1",u.style.padding="10px"}),i==="award"?l():c()})}),e.role==="HR"?c():l();function l(){const d=n.querySelector("#award-content"),u=lc[e.role]||[],h=Object.entries(r).map(([v,T])=>({id:v,...T})).filter(v=>v.active!==!1);if(a.length===0){d.innerHTML=`
    ...
    `;const p=d.querySelector("#emp-list-c"),m=d.querySelector("#search-emp-c");let b=a;function x(){p.innerHTML=b.map(y=>{var v,T;return`
      ...
      `,v.disabled=!1}const E=d.querySelector("#conduct-error"),w=d.querySelector("#btn-conduct-submit");w.addEventListener("click",async()=>{if(!(!f.receiver||!f.tier||!f.offenseId)){w.disabled=!0,w.textContent="Issuing…",E.classList.add("hidden");try{const y=Qe(),v=Pg(),T=Sn[f.tier],B=h.find(ze=>ze.id===f.offenseId),K=(await Ml(f.receiver.id,y)).filter(ze=>ze.offense_id===f.offenseId&&!ze.revoked),X=await $l(f.receiver.id,y,f.offenseId),se=Math.pow(2,X-1),fe=T.base_db*se,st=fe*ss;await Dl({giver_id:e.id,giver_name:e.name,receiver_id:f.receiver.id,offense_id:f.offenseId,conduct_tier:f.tier,db_count:fe,pts_deducted:st,month_key:y,note:d.querySelector("#inp-conduct-note").value.trim(),instance:X,multiplier:se});const Nt=await Gl(f.receiver.id,fe,st,y);await Kl(f.receiver.id,st),K.filter(ze=>{const bi=new Date(ze.timestamp),yc=`${bi.getFullYear()}-${String(bi.getMonth()+1).padStart(2,"0")}-${String(bi.getDate()).padStart(2,"0")}`;return ze.giver_id!==e.id&&yc===v}).length>0&&await Mt({type:"cross_conduct",receiver_id:f.receiver.id,giver_id:e.id,suggestion_text:`${f.receiver.name} received "${B==null?void 0:B.name}" conduct from multiple managers on the same day. Possible duplicate issuance.`,suggestion:"Confirm with both managers this is not a duplicate. Consider revoking one."}).catch(()=>{}),K.length>=3&&await Mt({type:"conduct_frequency",receiver_id:f.receiver.id,giver_id:e.id,suggestion_text:`${f.receiver.name} has now received "${B==null?void 0:B.name}" conduct ${K.length+1} times this month.`,suggestion:"High frequency of same conduct. Escalate to formal HR review or disciplinary process."}).catch(()=>{});const lr=Nt.db_count||0,yi=mc(lr);yi&&await Mt({type:"db_threshold",receiver_id:f.receiver.id,giver_id:e.id,suggestion_text:`${f.receiver.name} has accumulated ${lr} Dark Beans this month (${yi.replace(/_/g," ")}).`,suggestion:yi==="disciplinary"?"Consider formal disciplinary action.":"Review conduct history and consider counselling."}).catch(()=>{}),d.innerHTML=`
          <div class="text-center" style="padding:60px 20px;">
...
//# sourceMappingURL=index-D-xV2td3.js.map
