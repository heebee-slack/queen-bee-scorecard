 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const y=function(n,e){if(!n)throw It(e)},It=function(n){return new Error("Firebase Database ("+xo.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function te(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function hs(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(te())}function Lc(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Dc(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Oo(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Mc(){const n=te();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function $c(){return xo.NODE_ADMIN===!0}function Fc(){try{return typeof indexedDB=="object"}catch{return!1}}function Uc(){return new Promise((n,e)=>{try{let t=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(i),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{var r;e(((r=s.error)===null||r===void 0?void 0:r.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bc="FirebaseError";class Ve extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=Bc,Object.setPrototypeOf(this,Ve.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,on.prototype.create)}}class on{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?Hc(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Ve(s,a,i)}}function Hc(n,e){return n.replace(qc,(t,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const qc=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lo=function(n){let e={},t={},i={},s="";try{const r=n.split(".");e=Vt(An(r[0])||""),t=Vt(An(r[1])||""),s=r[2],i=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:i,signature:s}},jc=function(n){const e=Lo(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},zc=function(n){const e=Lo(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xt=jd;function $o(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i=Object.assign({name:Wi,automaticDataCollectionEnabled:!1},e),s=i.name;if(typeof s!="string"||!s)throw $e.create("bad-app-name",{appName:String(s)});if(t||(t=No()),!t)throw $e.create("no-options");const r=On.get(s);if(r){if(Pn(t,r.options)&&Pn(i,r.config))return r;throw $e.create("duplicate-app",{appName:s})}const o=new Zc(s);for(const l of Vi.values())o.addComponent(l);const a=new Gd(t,i,o);return On.set(s,a),a}function Fo(n=Wi){const e=On.get(n);if(!e&&n===Wi&&No())return $o();if(!e)throw $e.create("no-app",{appName:n});return e}function Fe(n,e,t){var i;let s=(i=zd[n])!==null&&i!==void 0?i:n;t&&(s+=`-${t}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ie.warn(a.join(" "));return}_t(new Ze(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kd="firebase-heartbeat-database",Yd=1,Gt="firebase-heartbeat-store";let Ni=null;function Uo(){return Ni||(Ni=hd(Kd,Yd,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Gt)}catch(t){console.warn(t)}}}}).catch(n=>{throw $e.create("idb-open",{originalErrorMessage:n.message})})),Ni}async function Qd(n){try{const t=(await Uo()).transaction(Gt),i=await t.objectStore(Gt).get(Bo(n));return await t.done,i}catch(e){if(e instanceof Ve)Ie.warn(e.message);else{const t=$e.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ie.warn(t.message)}}}async function Cr(n,e){try{const i=(await Uo()).transaction(Gt,"readwrite");await i.objectStore(Gt).put(e,Bo(n)),await i.done}catch(t){if(t instanceof Ve)Ie.warn(t.message);else{const i=$e.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Ie.warn(i.message)}}}function Bo(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ln=new fs("@firebase/auth");function ou(n,...e){Ln.logLevel<=U.WARN&&Ln.warn(`Auth (${xt}): ${n}`,...e)}function En(n,...e){Ln.logLevel<=U.ERROR&&Ln.error(`Auth (${xt}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class an{constructor(e,t){this.shortDelay=e,this.longDelay=t,xe(t>e,"Short delay should be less than long delay!"),this.isMobile=hs()||Oo()}get(){return lu()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uu=new an(3e4,6e4);function ii(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function Tt(n,e,t,i,s={}){return Wo(n,s,async()=>{let r={},o={};i&&(e==="GET"?o=i:r={body:JSON.stringify(i)});const a=St(Object.assign({key:n.config.apiKey},o)).slice(1),l=await n._getAdditionalHeaders();l["Content-Type"]="application/json",n.languageCode&&(l["X-Firebase-Locale"]=n.languageCode);const c=Object.assign({method:e,headers:l},r);return Lc()||(c.referrerPolicy="no-referrer"),zo.fetch()(Go(n,n.config.apiHost,t,a),c)})}async function Wo(n,e,t){n._canInitEmulator=!1;const i=Object.assign(Object.assign({},du),e);try{const s=new hu(n),r=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw yn(n,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[l,c]=a.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw yn(n,"credential-already-in-use",o);if(l==="EMAIL_EXISTS")throw yn(n,"email-already-in-use",o);if(l==="USER_DISABLED")throw yn(n,"user-disabled",o);const d=i[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(c)throw jo(n,d,c);Se(n,d)}}catch(s){if(s instanceof Ve)throw s;Se(n,"network-request-failed",{message:String(s)})}}async function Vo(n,e,t,i,s={}){const r=await Tt(n,e,t,i,s);return"mfaPendingCredential"in r&&Se(n,"multi-factor-auth-required",{_serverResponse:r}),r}function Go(n,e,t,i){const s=`${e}${t}?${i}`;return n.config.emulator?vs(n.config,s):`${n.config.apiScheme}://${s}`}class hu{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,i)=>{this.timer=setTimeout(()=>i(fe(this.auth,"network-request-failed")),uu.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function yn(n,e,t){const i={appName:n.name};t.email&&(i.email=t.email),t.phoneNumber&&(i.phoneNumber=t.phoneNumber);const s=fe(n,e,i);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fu(n,e){return Tt(n,"POST","/v1/accounts:delete",e)}async function Ko(n,e){return Tt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bt(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function pu(n,e=!1){const t=se(n),i=await t.getIdToken(e),s=ys(i);R(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:Bt(Pi(s.auth_time)),issuedAtTime:Bt(Pi(s.iat)),expirationTime:Bt(Pi(s.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function Pi(n){return Number(n)*1e3}function ys(n){const[e,t,i]=n.split(".");if(e===void 0||t===void 0||i===void 0)return En("JWT malformed, contained fewer than 3 sections"),null;try{const s=An(t);return s?JSON.parse(s):(En("Failed to decode base64 JWT payload"),null)}catch(s){return En("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function Tr(n){const e=ys(n);return R(e,"internal-error"),R(typeof e.exp<"u","internal-error"),R(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kt(n,e,t=!1){if(t)return e;try{return await e}catch(i){throw i instanceof Ve&&mu(i)&&n.auth.currentUser===n&&await n.auth.signOut(),i}}function mu({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yu(n,e){const t=await Wo(n,{},async()=>{const i=St({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=n.config,o=Go(n,s,"/v1/token",`key=${r}`),a=await n._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",zo.fetch()(o,{method:"POST",headers:a,body:i})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function bu(n,e){return Tt(n,"POST","/v2/accounts:revokeToken",ii(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ut{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){R(e.idToken,"internal-error"),R(typeof e.idToken<"u","internal-error"),R(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):Tr(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){R(e.length!==0,"internal-error");const t=Tr(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(R(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:i,refreshToken:s,expiresIn:r}=await yu(e,t);this.updateTokensAndExpiration(i,s,Number(r))}updateTokensAndExpiration(e,t,i){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+i*1e3}static fromJSON(e,t){const{refreshToken:i,accessToken:s,expirationTime:r}=t,o=new ut;return i&&(R(typeof i=="string","internal-error",{appName:e}),o.refreshToken=i),s&&(R(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),r&&(R(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new ut,this.toJSON())}_performRefresh(){return ye("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ae(n,e){R(typeof n=="string"||typeof n>"u","internal-error",{appName:e})}class be{constructor(e){var{uid:t,auth:i,stsTokenManager:s}=e,r=gs(e,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new gu(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=t,this.auth=i,this.stsTokenManager=s,this.accessToken=s.accessToken,this.displayName=r.displayName||null,this.email=r.email||null,this.emailVerified=r.emailVerified||!1,this.phoneNumber=r.phoneNumber||null,this.photoURL=r.photoURL||null,this.isAnonymous=r.isAnonymous||!1,this.tenantId=r.tenantId||null,this.providerData=r.providerData?[...r.providerData]:[],this.metadata=new Ki(r.createdAt||void 0,r.lastLoginAt||void 0)}async getIdToken(e){const t=await Kt(this,this.stsTokenManager.getToken(this.auth,e));return R(t,this.auth,"internal-error"),this.accessToken!==t&&(this.accessToken=t,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),t}getIdTokenResult(e){return pu(this,e)}reload(){return _u(this)}_assign(e){this!==e&&(R(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(t=>Object.assign({},t)),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const t=new be(Object.assign(Object.assign({},this),{auth:e,stsTokenManager:this.stsTokenManager._clone()}));return t.metadata._copy(this.metadata),t}_onReload(e){R(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,t=!1){let i=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),i=!0),t&&await Dn(this),await this.auth._persistUserIfCurrent(this),i&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(ve(this.auth.app))return Promise.reject(Ue(this.auth));const e=await this.getIdToken();return await Kt(this,fu(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return Object.assign(Object.assign({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>Object.assign({},e)),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,t){var i,s,r,o,a,l,c,d;const u=(i=t.displayName)!==null&&i!==void 0?i:void 0,f=(s=t.email)!==null&&s!==void 0?s:void 0,h=(r=t.phoneNumber)!==null&&r!==void 0?r:void 0,m=(o=t.photoURL)!==null&&o!==void 0?o:void 0,_=(a=t.tenantId)!==null&&a!==void 0?a:void 0,w=(l=t._redirectEventId)!==null&&l!==void 0?l:void 0,S=(c=t.createdAt)!==null&&c!==void 0?c:void 0,E=(d=t.lastLoginAt)!==null&&d!==void 0?d:void 0,{uid:x,emailVerified:A,isAnonymous:g,providerData:b,stsTokenManager:p}=t;R(x&&p,e,"internal-error");const v=ut.fromJSON(this.name,p);R(typeof x=="string",e,"internal-error"),Ae(u,e.name),Ae(f,e.name),R(typeof A=="boolean",e,"internal-error"),R(typeof g=="boolean",e,"internal-error"),Ae(h,e.name),Ae(m,e.name),Ae(_,e.name),Ae(w,e.name),Ae(S,e.name),Ae(E,e.name);const k=new be({uid:x,auth:e,email:f,emailVerified:A,displayName:u,isAnonymous:g,photoURL:m,phoneNumber:h,tenantId:_,stsTokenManager:v,createdAt:S,lastLoginAt:E});return b&&Array.isArray(b)&&(k.providerData=b.map(M=>Object.assign({},M))),w&&(k._redirectEventId=w),k}static async _fromIdTokenResponse(e,t,i=!1){const s=new ut;s.updateFromServerResponse(t);const r=new be({uid:t.localId,auth:e,stsTokenManager:s,isAnonymous:i});return await Dn(r),r}static async _fromGetAccountInfoResponse(e,t,i){const s=t.users[0];R(s.localId!==void 0,"internal-error");const r=s.providerUserInfo!==void 0?Yo(s.providerUserInfo):[],o=!(s.email&&s.passwordHash)&&!(r!=null&&r.length),a=new ut;a.updateFromIdToken(i);const l=new be({uid:s.localId,auth:e,stsTokenManager:a,isAnonymous:o}),c={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:r,metadata:new Ki(s.createdAt,s.lastLoginAt),isAnonymous:!(s.email&&s.passwordHash)&&!(r!=null&&r.length)};return Object.assign(l,c),l}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ar(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(ea(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Jo(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(na(e))return"Blackberry";if(ia(e))return"Webos";if(Xo(e))return"Safari";if((e.includes("chrome/")||Zo(e))&&!e.includes("edge/"))return"Chrome";if(ta(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function Jo(n=te()){return/firefox\//i.test(n)}function Xo(n=te()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Zo(n=te()){return/crios\//i.test(n)}function ea(n=te()){return/iemobile/i.test(n)}function ta(n=te()){return/android/i.test(n)}function na(n=te()){return/blackberry/i.test(n)}function ia(n=te()){return/webos/i.test(n)}function bs(n=te()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function wu(n=te()){var e;return bs(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Eu(){return Mc()&&document.documentMode===10}function sa(n=te()){return bs(n)||ta(n)||ia(n)||na(n)||/windows phone/i.test(n)||ea(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ra(n,e=[]){let t;switch(n){case"Browser":t=Ar(te());break;case"Worker":t=`${Ar(te())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${xt}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Iu(n,e={}){return Tt(n,"GET","/v2/passwordPolicy",ii(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ft(n,e){return Vo(n,"POST","/v1/accounts:signInWithIdp",ii(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ln extends la{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Le extends ln{constructor(){super("twitter.com")}static credential(e,t){return et._fromParams({providerId:Le.PROVIDER_ID,signInMethod:Le.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Le.credentialFromTaggedObject(e)}static credentialFromError(e){return Le.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:i}=e;if(!t||!i)return null;try{return Le.credential(t,i)}catch{return null}}}Le.TWITTER_SIGN_IN_METHOD="twitter.com";Le.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fu(n,e){return Vo(n,"POST","/v1/accounts:signUp",ii(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mn extends Ve{constructor(e,t,i,s){var r;super(t.code,t.message),this.operationType=i,this.user=s,Object.setPrototypeOf(this,Mn.prototype),this.customData={appName:e.name,tenantId:(r=e.tenantId)!==null&&r!==void 0?r:void 0,_serverResponse:t.customData._serverResponse,operationType:i}}static _fromErrorAndOperation(e,t,i,s){return new Mn(e,t,i,s)}}function ca(n,e,t,i){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(r=>{throw r.code==="auth/multi-factor-auth-required"?Mn._fromErrorAndOperation(n,r,e,i):r})}async function Bu(n,e,t=!1){const i=await Kt(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return qe._forOperation(n,"link",i)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qu(n,e,t=!1){if(ve(n.app))return Promise.reject(Ue(n));const i="signIn",s=await ca(n,i,e),r=await qe._fromIdTokenResponse(n,i,s);return t||await n._updateCurrentUser(r.user),r}function ju(n,e,t,i){return se(n).onIdTokenChanged(e,t,i)}function zu(n,e,t){return se(n).beforeAuthStateChanged(e,t)}const $n="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class da{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem($n,"1"),this.storage.removeItem($n),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ri{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const t=this.receivers.find(s=>s.isListeningto(e));if(t)return t;const i=new ri(e);return this.receivers.push(i),i}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const t=e,{eventId:i,eventType:s,data:r}=t.data,o=this.handlersMap[s];if(!(o!=null&&o.size))return;t.ports[0].postMessage({status:"ack",eventId:i,eventType:s});const a=Array.from(o).map(async c=>c(t.origin,r)),l=await Ku(a);t.ports[0].postMessage({status:"done",eventId:i,eventType:s,response:l})}_subscribe(e,t){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}_unsubscribe(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),(!t||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}ri.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oh(n,e){return e?we(e):(R(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uh="pendingRedirect",In=new Map;class hh extends va{constructor(e,t,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,i),this.eventId=null}async execute(){let e=In.get(this.auth._key());if(!e){try{const i=await fh(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(t){e=()=>Promise.reject(t)}In.set(this.auth._key(),e)}return this.bypassAuthState||In.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function fh(n,e){const t=gh(e),i=mh(n);if(!await i._isAvailable())return!1;const s=await i._get(t)==="true";return await i._remove(t),s}function ph(n,e){In.set(n._key(),e)}function mh(n){return we(n._redirectPersistence)}function gh(n){return Cn(uh,n.config.apiKey,n.name)}async function _h(n,e,t=!1){if(ve(n.app))return Promise.reject(Ue(n));const i=si(n),s=oh(i,e),o=await new hh(i,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wh(n,e={}){return Tt(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rh=new an(5e3,15e3),Ah="__/auth/iframe",Nh="emulator/auth/iframe",Ph={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Oh=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Lh(n){const e=n.config;R(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?vs(e,Nh):`https://${n.config.authDomain}/${Ah}`,i={apiKey:e.apiKey,appName:n.name,v:xt},s=Oh.get(n.config.apiHost);s&&(i.eid=s);const r=n._getFrameworks();return r.length&&(i.fw=r.join(",")),`${t}?${St(i).slice(1)}`}async function Dh(n){const e=await kh(n),t=pe().gapi;return R(t,n,"internal-error"),e.open({where:document.body,url:Lh(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Ph,dontclear:!0},i=>new Promise(async(s,r)=>{await i.restyle({setHideOnLeave:!1});const o=fe(n,"network-request-failed"),a=pe().setTimeout(()=>{r(o)},Rh.get());function l(){pe().clearTimeout(a),s(i)}i.ping(l).then(l,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jh="__/auth/handler",zh="emulator/auth/handler",Wh=encodeURIComponent("fac");async function Ur(n,e,t,i,s,r){R(n.config.authDomain,n,"auth-domain-config-required"),R(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:xt,eventId:s};if(e instanceof la){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Hi(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,u]of Object.entries({}))o[d]=u}if(e instanceof ln){const d=e.getScopes().filter(u=>u!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const d of Object.keys(a))a[d]===void 0&&delete a[d];const l=await n._getAppCheckToken(),c=l?`#${Wh}=${encodeURIComponent(l)}`:"";return`${Vh(n)}?${St(a).slice(1)}${c}`}function Vh({config:n}){return n.emulator?vs(n,zh):`https://${n.authDomain}/${jh}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qh(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Jh(n){_t(new Ze("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=i.options;R(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const l={apiKey:o,authDomain:a,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:ra(n)},c=new Tu(i,s,r,l);return Ou(c,t),c},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),_t(new Ze("auth-internal",e=>{const t=si(e.getProvider("auth").getImmediate());return(i=>new Yh(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Fe(Br,Hr,Qh(n)),Fe(Br,Hr,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bf{constructor(e,t){this.appName_=e,this.appCheckProvider=t,this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(i=>this.appCheck=i)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((t,i)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,i):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)===null||t===void 0||t.get().then(i=>i.addTokenListener(e))}notifyForInvalidToken(){ee(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sf{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&kt(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn extends qa{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!hs()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Bn}getInitialEvent(e){return y(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const to=32,no=768;class B{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let i=0;for(let s=0;s<this.pieces_.length;s++)this.pieces_[s].length>0&&(this.pieces_[i]=this.pieces_[s],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function $(){return new B("")}function N(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function je(n){return n.pieces_.length-n.pieceNum_}function j(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new B(n.pieces_,e)}function Rs(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function Gf(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function Qt(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function ja(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new B(e,0)}function z(n,e){const t=[];for(let i=n.pieceNum_;i<n.pieces_.length;i++)t.push(n.pieces_[i]);if(e instanceof B)for(let i=e.pieceNum_;i<e.pieces_.length;i++)t.push(e.pieces_[i]);else{const i=e.split("/");for(let s=0;s<i.length;s++)i[s].length>0&&t.push(i[s])}return new B(t,0)}function O(n){return n.pieceNum_>=n.pieces_.length}function Z(n,e){const t=N(n),i=N(e);if(t===null)return e;if(t===i)return Z(j(n),j(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function Kf(n,e){const t=Qt(n,0),i=Qt(e,0);for(let s=0;s<t.length&&s<i.length;s++){const r=st(t[s],i[s]);if(r!==0)return r}return t.length===i.length?0:t.length<i.length?-1:1}function As(n,e){if(je(n)!==je(e))return!1;for(let t=n.pieceNum_,i=e.pieceNum_;t<=n.pieces_.length;t++,i++)if(n.pieces_[t]!==e.pieces_[i])return!1;return!0}function oe(n,e){let t=n.pieceNum_,i=e.pieceNum_;if(je(n)>je(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[i])return!1;++t,++i}return!0}class Yf{constructor(e,t){this.errorPrefix_=t,this.parts_=Qt(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=ni(this.parts_[i]);za(this)}}function Qf(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=ni(e),za(n)}function Jf(n){const e=n.parts_.pop();n.byteLength_-=ni(e),n.parts_.length>0&&(n.byteLength_-=1)}function za(n){if(n.byteLength_>no)throw new Error(n.errorPrefix_+"has a key path longer than "+no+" bytes ("+n.byteLength_+").");if(n.parts_.length>to)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+to+") or object contains a cycle "+Ye(n))}function Ye(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ai{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new P(vt,e),s=new P(vt,t);return this.compare(i,s)!==0}minPost(){return P.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bn;class Wa extends ai{static get __EMPTY_NODE(){return bn}static set __EMPTY_NODE(e){bn=e}compare(e,t){return st(e.name,t.name)}isDefinedOn(e){throw It("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return P.MIN}maxPost(){return new P(tt,bn)}makePost(e,t){return y(typeof e=="string","KeyIndex indexValue must always be a string."),new P(e,bn)}toString(){return".key"}}const mt=new Wa;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ka,Ya;function rp(n){Ka=n}function op(n){Ya=n}class ap extends ai{compare(e,t){const i=e.node.getPriority(),s=t.node.getPriority(),r=i.compareTo(s);return r===0?st(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return P.MIN}maxPost(){return new P(tt,new K("[PRIORITY-POST]",Ya))}makePost(e,t){const i=Ka(e);return new P(t,new K("[PRIORITY-POST]",i))}toString(){return".priority"}}const W=new ap;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lp=Math.log(2);class cp{constructor(e){const t=r=>parseInt(Math.log(r)/lp,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Hn=function(n,e,t,i){n.sort(e);const s=function(l,c){const d=c-l;let u,f;if(d===0)return null;if(d===1)return u=n[l],f=t?t(u):u,new Y(f,u.node,Y.BLACK,null,null);{const h=parseInt(d/2,10)+l,m=s(l,h),_=s(h+1,c);return u=n[h],f=t?t(u):u,new Y(f,u.node,Y.BLACK,m,_)}},r=function(l){let c=null,d=null,u=n.length;const f=function(m,_){const w=u-m,S=u;u-=m;const E=s(w+1,S),x=n[w],A=t?t(x):x;h(new Y(A,x.node,_,null,E))},h=function(m){c?(c.left=m,c=m):(d=m,c=m)};for(let m=0;m<l.count;++m){const _=l.nextBitIsOne(),w=Math.pow(2,l.count-(m+1));_?f(w,Y.BLACK):(f(w,Y.BLACK),f(w,Y.RED))}return d},o=new cp(n.length),a=r(o);return new ie(i||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $i;const ot={};class Ee{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return y(ot&&W,"ChildrenNode.ts has not been loaded"),$i=$i||new Ee({".priority":ot},{".priority":W}),$i}get(e){const t=gt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof ie?t:null}hasIndex(e){return _e(this.indexSet_,e.toString())}addIndex(e,t){y(e!==mt,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(P.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=Hn(i,e.getCompare()):a=ot;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const d=Object.assign({},this.indexes_);return d[l]=a,new Ee(d,c)}addToIndexes(e,t){const i=Nn(this.indexes_,(s,r)=>{const o=gt(this.indexSet_,r);if(y(o,"Missing index implementation for "+r),s===ot)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(P.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),Hn(a,o.getCompare())}else return ot;else{const a=t.get(e.name);let l=s;return a&&(l=l.remove(new P(e.name,a))),l.insert(e,e.node)}});return new Ee(i,this.indexSet_)}removeFromIndexes(e,t){const i=Nn(this.indexes_,s=>{if(s===ot)return s;{const r=t.get(e.name);return r?s.remove(new P(e.name,r)):s}});return new Ee(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $t;class T{constructor(e,t,i){this.children_=e,this.priorityNode_=t,this.indexMap_=i,this.lazyHash_=null,this.priorityNode_&&Ga(this.priorityNode_),this.children_.isEmpty()&&y(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}static get EMPTY_NODE(){return $t||($t=new T(new ie(Ps),null,Ee.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||$t}updatePriority(e){return this.children_.isEmpty()?this:new T(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?$t:t}}getChild(e){const t=N(e);return t===null?this:this.getImmediateChild(t).getChild(j(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(y(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const i=new P(e,t);let s,r;t.isEmpty()?(s=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(i,this.children_)):(s=this.children_.insert(e,t),r=this.indexMap_.addToIndexes(i,this.children_));const o=s.isEmpty()?$t:this.priorityNode_;return new T(s,o,r)}}updateChild(e,t){const i=N(e);if(i===null)return t;{y(N(e)!==".priority"||je(e)===1,".priority must be the last token in a path");const s=this.getImmediateChild(i).updateChild(j(e),t);return this.updateImmediateChild(i,s)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let i=0,s=0,r=!0;if(this.forEachChild(W,(o,a)=>{t[o]=a.val(e),i++,r&&T.INTEGER_REGEXP_.test(o)?s=Math.max(s,Number(o)):r=!1}),!e&&r&&s<2*i){const o=[];for(const a in t)o[a]=t[a];return o}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+Va(this.getPriority().val())+":"),this.forEachChild(W,(t,i)=>{const s=i.hash();s!==""&&(e+=":"+t+":"+s)}),this.lazyHash_=e===""?"":Ea(e)}return this.lazyHash_}getPredecessorChildName(e,t,i){const s=this.resolveIndex_(i);if(s){const r=s.getPredecessorKey(new P(e,t));return r?r.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const i=t.minKey();return i&&i.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new P(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const i=t.maxKey();return i&&i.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new P(t,this.children_.get(t)):null}forEachChild(e,t){const i=this.resolveIndex_(e);return i?i.inorderTraversal(s=>t(s.name,s.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const i=this.resolveIndex_(t);if(i)return i.getIteratorFrom(e,s=>s);{const s=this.children_.getIteratorFrom(e.name,P.Wrap);let r=s.peek();for(;r!=null&&t.compare(r,e)<0;)s.getNext(),r=s.peek();return s}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const i=this.resolveIndex_(t);if(i)return i.getReverseIteratorFrom(e,s=>s);{const s=this.children_.getReverseIteratorFrom(e.name,P.Wrap);let r=s.peek();for(;r!=null&&t.compare(r,e)>0;)s.getNext(),r=s.peek();return s}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===hn?-1:0}withIndex(e){if(e===mt||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new T(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===mt||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const i=this.getIterator(W),s=t.getIterator(W);let r=i.getNext(),o=s.getNext();for(;r&&o;){if(r.name!==o.name||!r.node.equals(o.node))return!1;r=i.getNext(),o=s.getNext()}return r===null&&o===null}else return!1;else return!1}}resolveIndex_(e){return e===mt?null:this.indexMap_.get(e.toString())}}T.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class dp extends T{constructor(){super(new ie(Ps),T.EMPTY_NODE,Ee.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return T.EMPTY_NODE}isEmpty(){return!1}}const hn=new dp;Object.defineProperties(P,{MIN:{value:new P(vt,T.EMPTY_NODE)},MAX:{value:new P(tt,hn)}});Wa.__EMPTY_NODE=T.EMPTY_NODE;K.__childrenNodeConstructor=T;sp(hn);op(hn);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hp extends ai{constructor(e){super(),this.indexPath_=e,y(!O(e)&&N(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const i=this.extractChild(e.node),s=this.extractChild(t.node),r=i.compareTo(s);return r===0?st(e.name,t.name):r}makePost(e,t){const i=V(e),s=T.EMPTY_NODE.updateChild(this.indexPath_,i);return new P(t,s)}maxPost(){const e=T.EMPTY_NODE.updateChild(this.indexPath_,hn);return new P(tt,e)}toString(){return Qt(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fp extends ai{compare(e,t){const i=e.node.compareTo(t.node);return i===0?st(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return P.MIN}maxPost(){return P.MAX}makePost(e,t){const i=V(e);return new P(t,i)}toString(){return".value"}}const pp=new fp;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qa(n){return{type:"value",snapshotNode:n}}function yt(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Jt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Xt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function mp(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Os{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){y(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(Jt(t,a)):y(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(yt(t,i)):o.trackChildChange(Xt(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(W,(s,r)=>{t.hasChild(s)||i.trackChildChange(Jt(s,r))}),t.isLeafNode()||t.forEachChild(W,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(Xt(s,r,o))}else i.trackChildChange(yt(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?T.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qn extends Ha{constructor(e,t,i,s){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=i,this.appCheckTokenProvider_=s,this.log_=un("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(y(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,i,s){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=qn.getListenId_(e,i),a={};this.listens_[o]=a;const l=oo(e._queryParams);this.restRequest_(r+".json",l,(c,d)=>{let u=d;if(c===404&&(u=null,c=null),c===null&&this.onDataUpdate_(r,u,!1,i),gt(this.listens_,o)===a){let f;c?c===401?f="permission_denied":f="rest_error:"+c:f="ok",s(f,null)}})}unlisten(e,t){const i=qn.getListenId_(e,t);delete this.listens_[i]}get(e){const t=oo(e._queryParams),i=e._path.toString(),s=new rn;return this.restRequest_(i+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(i,a,!1,null),s.resolve(a)):s.reject(new Error(a))}),s.promise}refreshAuthToken(e){}restRequest_(e,t={},i){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([s,r])=>{s&&s.accessToken&&(t.auth=s.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+St(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(i&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=Vt(a.responseText)}catch{ee("Failed to parse JSON response for "+o+": "+a.responseText)}i(null,l)}else a.status!==401&&a.status!==404&&ee("Got unsuccessful REST response for "+o+" Status: "+a.status),i(a.status);i=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jn(){return{value:null,children:new Map}}function Ja(n,e,t){if(O(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const i=N(e);n.children.has(i)||n.children.set(i,jn());const s=n.children.get(i);e=j(e),Ja(s,e,t)}}function Zi(n,e,t){n.value!==null?t(e,n.value):yp(n,(i,s)=>{const r=new B(e.toString()+"/"+i);Zi(s,r,t)})}function yp(n,e){n.children.forEach((t,i)=>{e(i,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lo=10*1e3,wp=30*1e3,Ep=5*60*1e3;class Cp{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new bp(e);const i=lo+(wp-lo)*Math.random();qt(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;J(e,(s,r)=>{r>0&&_e(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),qt(this.reportStats_.bind(this),Math.floor(Math.random()*2*Ep))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=de.ACK_USER_WRITE,this.source=Ds()}operationForChild(e){if(O(this.path)){if(this.affectedTree.value!=null)return y(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new B(e));return new zn($(),t,this.revert)}}else return y(N(this.path)===e,"operationForChild called for unrelated child."),new zn(j(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en{constructor(e,t){this.source=e,this.path=t,this.type=de.LISTEN_COMPLETE}operationForChild(e){return O(this.path)?new en(this.source,$()):new en(this.source,j(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nt{constructor(e,t,i){this.source=e,this.path=t,this.snap=i,this.type=de.OVERWRITE}operationForChild(e){return O(this.path)?new nt(this.source,$(),this.snap.getImmediateChild(e)):new nt(this.source,j(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=de.MERGE}operationForChild(e){if(O(this.path)){const t=this.children.subtree(new B(e));return t.isEmpty()?null:t.value?new nt(this.source,$(),t.value):new bt(this.source,$(),t)}else return y(N(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new bt(this.source,j(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ip{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Sp(n,e,t,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(mp(o.childName,o.snapshotNode))}),Ft(n,s,"child_removed",e,i,t),Ft(n,s,"child_added",e,i,t),Ft(n,s,"child_moved",r,i,t),Ft(n,s,"child_changed",e,i,t),Ft(n,s,"value",e,i,t),s}function Ft(n,e,t,i,s,r){const o=i.filter(a=>a.type===t);o.sort((a,l)=>Tp(n,a,l)),o.forEach(a=>{const l=xp(n,a,r);s.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,n.query_))})})}function xp(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function Tp(n,e,t){if(e.childName==null||t.childName==null)throw It("Should only compare child_ events.");const i=new P(e.childName,e.snapshotNode),s=new P(t.childName,t.snapshotNode);return n.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function li(n,e){return{eventCache:n,serverCache:e}}function jt(n,e,t,i){return li(new ze(e,t,i),n.serverCache)}function Xa(n,e,t,i){return li(n.eventCache,new ze(e,t,i))}function Wn(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function it(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fi;const kp=()=>(Fi||(Fi=new ie(hf)),Fi);class q{constructor(e,t=kp()){this.value=e,this.children=t}static fromObject(e){let t=new q(null);return J(e,(i,s)=>{t=t.set(new B(i),s)}),t}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(this.value!=null&&t(this.value))return{path:$(),value:this.value};if(O(e))return null;{const i=N(e),s=this.children.get(i);if(s!==null){const r=s.findRootMostMatchingPathAndValue(j(e),t);return r!=null?{path:z(new B(i),r.path),value:r.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(O(e))return this;{const t=N(e),i=this.children.get(t);return i!==null?i.subtree(j(e)):new q(null)}}set(e,t){if(O(e))return new q(t,this.children);{const i=N(e),r=(this.children.get(i)||new q(null)).set(j(e),t),o=this.children.insert(i,r);return new q(this.value,o)}}remove(e){if(O(e))return this.children.isEmpty()?new q(null):new q(null,this.children);{const t=N(e),i=this.children.get(t);if(i){const s=i.remove(j(e));let r;return s.isEmpty()?r=this.children.remove(t):r=this.children.insert(t,s),this.value===null&&r.isEmpty()?new q(null):new q(this.value,r)}else return this}}get(e){if(O(e))return this.value;{const t=N(e),i=this.children.get(t);return i?i.get(j(e)):null}}setTree(e,t){if(O(e))return t;{const i=N(e),r=(this.children.get(i)||new q(null)).setTree(j(e),t);let o;return r.isEmpty()?o=this.children.remove(i):o=this.children.insert(i,r),new q(this.value,o)}}fold(e){return this.fold_($(),e)}fold_(e,t){const i={};return this.children.inorderTraversal((s,r)=>{i[s]=r.fold_(z(e,s),t)}),t(e,this.value,i)}findOnPath(e,t){return this.findOnPath_(e,$(),t)}findOnPath_(e,t,i){const s=this.value?i(t,this.value):!1;if(s)return s;if(O(e))return null;{const r=N(e),o=this.children.get(r);return o?o.findOnPath_(j(e),z(t,r),i):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,$(),t)}foreachOnPath_(e,t,i){if(O(e))return this;{this.value&&i(t,this.value);const s=N(e),r=this.children.get(s);return r?r.foreachOnPath_(j(e),z(t,s),i):new q(null)}}foreach(e){this.foreach_($(),e)}foreach_(e,t){this.children.inorderTraversal((i,s)=>{s.foreach_(z(e,i),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,i)=>{i.value&&e(t,i.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wp(n){return{filter:n}}function Vp(n,e){y(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),y(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function Gp(n,e,t,i,s){const r=new jp;let o,a;if(t.type===de.OVERWRITE){const c=t;c.source.fromUser?o=is(n,e,c.path,c.snap,i,s,r):(y(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!O(c.path),o=Kn(n,e,c.path,c.snap,i,s,a,r))}else if(t.type===de.MERGE){const c=t;c.source.fromUser?o=Yp(n,e,c.path,c.children,i,s,r):(y(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=ss(n,e,c.path,c.children,i,s,a,r))}else if(t.type===de.ACK_USER_WRITE){const c=t;c.revert?o=Xp(n,e,c.path,i,s,r):o=Qp(n,e,c.path,c.affectedTree,i,s,r)}else if(t.type===de.LISTEN_COMPLETE)o=Jp(n,e,t.path,i,r);else throw It("Unknown operation type: "+t.type);const l=r.getChanges();return Kp(e,o,l),{viewCache:o,changes:l}}function Kp(n,e,t){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=Wn(n);(t.length>0||!n.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&t.push(Qa(Wn(e)))}}function rl(n,e,t,i,s,r){const o=e.eventCache;if(Gn(i,t)!=null)return e;{let a,l;if(O(t))if(y(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=it(e),d=c instanceof T?c:T.EMPTY_NODE,u=Fs(i,d);a=n.filter.updateFullNode(e.eventCache.getNode(),u,r)}else{const c=Vn(i,it(e));a=n.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=N(t);if(c===".priority"){y(je(t)===1,"Can't have a priority with additional path components");const d=o.getNode();l=e.serverCache.getNode();const u=ho(i,t,d,l);u!=null?a=n.filter.updatePriority(d,u):a=o.getNode()}else{const d=j(t);let u;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const f=ho(i,t,o.getNode(),l);f!=null?u=o.getNode().getImmediateChild(c).updateChild(d,f):u=o.getNode().getImmediateChild(c)}else u=Us(i,c,e.serverCache);u!=null?a=n.filter.updateChild(o.getNode(),c,u,d,s,r):a=o.getNode()}}return jt(e,a,o.isFullyInitialized()||O(t),n.filter.filtersNodes())}}function Kn(n,e,t,i,s,r,o,a){const l=e.serverCache;let c;const d=o?n.filter:n.filter.getIndexedFilter();if(O(t))c=d.updateFullNode(l.getNode(),i,null);else if(d.filtersNodes()&&!l.isFiltered()){const h=l.getNode().updateChild(t,i);c=d.updateFullNode(l.getNode(),h,null)}else{const h=N(t);if(!l.isCompleteForPath(t)&&je(t)>1)return e;const m=j(t),w=l.getNode().getImmediateChild(h).updateChild(m,i);h===".priority"?c=d.updatePriority(l.getNode(),w):c=d.updateChild(l.getNode(),h,w,m,sl,null)}const u=Xa(e,c,l.isFullyInitialized()||O(t),d.filtersNodes()),f=new Bs(s,u,r);return rl(n,u,t,s,f,a)}function is(n,e,t,i,s,r,o){const a=e.eventCache;let l,c;const d=new Bs(s,e,r);if(O(t))c=n.filter.updateFullNode(e.eventCache.getNode(),i,o),l=jt(e,c,!0,n.filter.filtersNodes());else{const u=N(t);if(u===".priority")c=n.filter.updatePriority(e.eventCache.getNode(),i),l=jt(e,c,a.isFullyInitialized(),a.isFiltered());else{const f=j(t),h=a.getNode().getImmediateChild(u);let m;if(O(f))m=i;else{const _=d.getCompleteChild(u);_!=null?Rs(f)===".priority"&&_.getChild(ja(f)).isEmpty()?m=_:m=_.updateChild(f,i):m=T.EMPTY_NODE}if(h.equals(m))l=e;else{const _=n.filter.updateChild(a.getNode(),u,m,f,d,o);l=jt(e,_,a.isFullyInitialized(),n.filter.filtersNodes())}}}return l}function fo(n,e){return n.eventCache.isCompleteForChild(e)}function Yp(n,e,t,i,s,r,o){let a=e;return i.foreach((l,c)=>{const d=z(t,l);fo(e,N(d))&&(a=is(n,a,d,c,s,r,o))}),i.foreach((l,c)=>{const d=z(t,l);fo(e,N(d))||(a=is(n,a,d,c,s,r,o))}),a}function po(n,e,t){return t.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function ss(n,e,t,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;O(t)?c=i:c=new q(null).setTree(t,i);const d=e.serverCache.getNode();return c.children.inorderTraversal((u,f)=>{if(d.hasChild(u)){const h=e.serverCache.getNode().getImmediateChild(u),m=po(n,h,f);l=Kn(n,l,new B(u),m,s,r,o,a)}}),c.children.inorderTraversal((u,f)=>{const h=!e.serverCache.isCompleteForChild(u)&&f.value===null;if(!d.hasChild(u)&&!h){const m=e.serverCache.getNode().getImmediateChild(u),_=po(n,m,f);l=Kn(n,l,new B(u),_,s,r,o,a)}}),l}function Qp(n,e,t,i,s,r,o){if(Gn(s,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(O(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return Kn(n,e,t,l.getNode().getChild(t),s,r,a,o);if(O(t)){let c=new q(null);return l.getNode().forEachChild(mt,(d,u)=>{c=c.set(new B(d),u)}),ss(n,e,t,c,s,r,a,o)}else return e}else{let c=new q(null);return i.foreach((d,u)=>{const f=z(t,d);l.isCompleteForPath(f)&&(c=c.set(d,l.getNode().getChild(f)))}),ss(n,e,t,c,s,r,a,o)}}function Jp(n,e,t,i,s){const r=e.serverCache,o=Xa(e,r.getNode(),r.isFullyInitialized()||O(t),r.isFiltered());return rl(n,o,t,i,sl,s)}function Xp(n,e,t,i,s,r){let o;if(Gn(i,t)!=null)return e;{const a=new Bs(i,e,s),l=e.eventCache.getNode();let c;if(O(t)||N(t)===".priority"){let d;if(e.serverCache.isFullyInitialized())d=Vn(i,it(e));else{const u=e.serverCache.getNode();y(u instanceof T,"serverChildren would be complete if leaf node"),d=Fs(i,u)}d=d,c=n.filter.updateFullNode(l,d,r)}else{const d=N(t);let u=Us(i,d,e.serverCache);u==null&&e.serverCache.isCompleteForChild(d)&&(u=l.getImmediateChild(d)),u!=null?c=n.filter.updateChild(l,d,u,j(t),a,r):e.eventCache.getNode().hasChild(d)?c=n.filter.updateChild(l,d,T.EMPTY_NODE,j(t),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Vn(i,it(e)),o.isLeafNode()&&(c=n.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||Gn(i,$())!=null,jt(e,c,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Yn;class al{constructor(){this.views=new Map}}function rm(n){y(!Yn,"__referenceConstructor has already been defined"),Yn=n}function om(){return y(Yn,"Reference.ts has not been loaded"),Yn}function am(n){return n.views.size===0}function Hs(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return y(r!=null,"SyncTree gave us an op for an invalid query."),_o(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(_o(o,e,t,i));return r}}function ll(n,e,t,i,s){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=Vn(t,s?i:null),l=!1;a?l=!0:i instanceof T?(a=Fs(t,i),l=!1):(a=T.EMPTY_NODE,l=!1);const c=li(new ze(a,l,!1),new ze(i,s,!1));return new Zp(e,c)}return o}function lm(n,e,t,i,s,r){const o=ll(n,e,i,s,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),im(o,t),sm(o,t)}function cm(n,e,t,i){const s=e._queryIdentifier,r=[];let o=[];const a=We(n);if(s==="default")for(const[l,c]of n.views.entries())o=o.concat(go(c,t,i)),mo(c)&&(n.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=n.views.get(s);l&&(o=o.concat(go(l,t,i)),mo(l)&&(n.views.delete(s),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!We(n)&&r.push(new(om())(e._repo,e._path)),{removed:r,events:o}}function cl(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function He(n,e){let t=null;for(const i of n.views.values())t=t||nm(i,e);return t}function dl(n,e){if(e._queryParams.loadsAllData())return di(n);{const i=e._queryIdentifier;return n.views.get(i)}}function ul(n,e){return dl(n,e)!=null}function We(n){return di(n)!=null}function di(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Qn;function dm(n){y(!Qn,"__referenceConstructor has already been defined"),Qn=n}function um(){return y(Qn,"Reference.ts has not been loaded"),Qn}let hm=1;class vo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new q(null),this.pendingWriteTree_=Hp(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function hl(n,e,t,i,s){return Rp(n.pendingWriteTree_,e,t,i,s),s?Rt(n,new nt(Ds(),e,t)):[]}function fm(n,e,t,i){Ap(n.pendingWriteTree_,e,t,i);const s=q.fromObject(t);return Rt(n,new bt(Ds(),e,s))}function De(n,e,t=!1){const i=Np(n.pendingWriteTree_,e);if(Pp(n.pendingWriteTree_,e)){let r=new q(null);return i.snap!=null?r=r.set($(),!0):J(i.children,o=>{r=r.set(new B(o),!0)}),Rt(n,new zn(i.path,r,t))}else return[]}function fn(n,e,t){return Rt(n,new nt(Ms(),e,t))}function pm(n,e,t){const i=q.fromObject(t);return Rt(n,new bt(Ms(),e,i))}function mm(n,e){return Rt(n,new en(Ms(),e))}function gm(n,e,t){const i=js(n,t);if(i){const s=zs(i),r=s.path,o=s.queryId,a=Z(r,e),l=new en($s(o),a);return Ws(n,r,l)}else return[]}function Jn(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||ul(o,e))){const l=cm(o,e,t,i);am(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const d=c.findIndex(f=>f._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(f,h)=>We(h));if(d&&!u){const f=n.syncPointTree_.subtree(r);if(!f.isEmpty()){const h=ym(f);for(let m=0;m<h.length;++m){const _=h[m],w=_.query,S=gl(n,_);n.listenProvider_.startListening(Wt(w),tn(n,w),S.hashFn,S.onComplete)}}}!u&&c.length>0&&!i&&(d?n.listenProvider_.stopListening(Wt(e),null):c.forEach(f=>{const h=n.queryToTagMap.get(ui(f));n.listenProvider_.stopListening(Wt(f),h)}))}bm(n,c)}return a}function fl(n,e,t,i){const s=js(n,i);if(s!=null){const r=zs(s),o=r.path,a=r.queryId,l=Z(o,e),c=new nt($s(a),l,t);return Ws(n,o,c)}else return[]}function _m(n,e,t,i){const s=js(n,i);if(s){const r=zs(s),o=r.path,a=r.queryId,l=Z(o,e),c=q.fromObject(t),d=new bt($s(a),l,c);return Ws(n,o,d)}else return[]}function rs(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(f,h)=>{const m=Z(f,s);r=r||He(h,m),o=o||We(h)});let a=n.syncPointTree_.get(s);a?(o=o||We(a),r=r||He(a,$())):(a=new al,n.syncPointTree_=n.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=T.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((h,m)=>{const _=He(m,$());_&&(r=r.updateImmediateChild(h,_))}));const c=ul(a,e);if(!c&&!e._queryParams.loadsAllData()){const f=ui(e);y(!n.queryToTagMap.has(f),"View does not exist, but we have a tag");const h=wm();n.queryToTagMap.set(f,h),n.tagToQueryMap.set(h,f)}const d=ci(n.pendingWriteTree_,s);let u=lm(a,e,t,d,r,l);if(!c&&!o&&!i){const f=dl(a,e);u=u.concat(Em(n,e,f))}return u}function qs(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=Z(o,e),c=He(a,l);if(c)return c});return tl(s,e,r,t,!0)}function vm(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(c,d)=>{const u=Z(c,t);i=i||He(d,u)});let s=n.syncPointTree_.get(t);s?i=i||He(s,$()):(s=new al,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new ze(i,!0,!1):null,a=ci(n.pendingWriteTree_,e._path),l=ll(s,e,a,r?o.getNode():T.EMPTY_NODE,r);return tm(l)}function Rt(n,e){return pl(e,n.syncPointTree_,null,ci(n.pendingWriteTree_,$()))}function pl(n,e,t,i){if(O(n.path))return ml(n,e,t,i);{const s=e.get($());t==null&&s!=null&&(t=He(s,$()));let r=[];const o=N(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,d=nl(i,o);r=r.concat(pl(a,l,c,d))}return s&&(r=r.concat(Hs(s,n,i,t))),r}}function ml(n,e,t,i){const s=e.get($());t==null&&s!=null&&(t=He(s,$()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=nl(i,o),d=n.operationForChild(o);d&&(r=r.concat(ml(d,a,l,c)))}),s&&(r=r.concat(Hs(s,n,i,t))),r}function gl(n,e){const t=e.query,i=tn(n,t);return{hashFn:()=>(em(e)||T.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?gm(n,t._path,i):mm(n,t._path);{const r=mf(s,t);return Jn(n,t,null,r)}}}}function tn(n,e){const t=ui(e);return n.queryToTagMap.get(t)}function ui(n){return n._path.toString()+"$"+n._queryIdentifier}function js(n,e){return n.tagToQueryMap.get(e)}function zs(n){const e=n.indexOf("$");return y(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new B(n.substr(0,e))}}function Ws(n,e,t){const i=n.syncPointTree_.get(e);y(i,"Missing sync point for query tag that we're tracking");const s=ci(n.pendingWriteTree_,e);return Hs(i,t,s,null)}function ym(n){return n.fold((e,t,i)=>{if(t&&We(t))return[di(t)];{let s=[];return t&&(s=cl(t)),J(i,(r,o)=>{s=s.concat(o)}),s}})}function Wt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(um())(n._repo,n._path):n}function bm(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=ui(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function wm(){return hm++}function Em(n,e,t){const i=e._path,s=tn(n,e),r=gl(n,t),o=n.listenProvider_.startListening(Wt(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)y(!We(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,d,u)=>{if(!O(c)&&d&&We(d))return[di(d).query];{let f=[];return d&&(f=f.concat(cl(d).map(h=>h.query))),J(u,(h,m)=>{f=f.concat(m)}),f}});for(let c=0;c<l.length;++c){const d=l[c];n.listenProvider_.stopListening(Wt(d),tn(n,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ys{constructor(e="",t=null,i={children:{},childCount:0}){this.name=e,this.parent=t,this.node=i}}function Qs(n,e){let t=e instanceof B?e:new B(e),i=n,s=N(t);for(;s!==null;){const r=gt(i.node.children,s)||{children:{},childCount:0};i=new Ys(s,i,r),t=j(t),s=N(t)}return i}function At(n){return n.node.value}function yl(n,e){n.node.value=e,os(n)}function bl(n){return n.node.childCount>0}function xm(n){return At(n)===void 0&&!bl(n)}function hi(n,e){J(n.node.children,(t,i)=>{e(new Ys(t,n,i))})}function wl(n,e,t,i){t&&e(n),hi(n,s=>{wl(s,e,!0)})}function Tm(n,e,t){let i=n.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function pn(n){return new B(n.parent===null?n.name:pn(n.parent)+"/"+n.name)}function os(n){n.parent!==null&&km(n.parent,n.name,n)}function km(n,e,t){const i=xm(t),s=_e(n.node.children,e);i&&s?(delete n.node.children[e],n.node.childCount--,os(n)):!i&&!s&&(n.node.children[e]=t.node,n.node.childCount++,os(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rm=/[\[\].#$\/\u0000-\u001F\u007F]/,Am=/[\[\].#$\u0000-\u001F\u007F]/,Ui=10*1024*1024,Js=function(n){return typeof n=="string"&&n.length!==0&&!Rm.test(n)},El=function(n){return typeof n=="string"&&n.length!==0&&!Am.test(n)},Nm=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),El(n)},Pm=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Is(n)||n&&typeof n=="object"&&_e(n,".sv")},Cl=function(n,e,t,i){i&&e===void 0||fi(ti(n,"value"),e,t)},fi=function(n,e,t){const i=t instanceof B?new Yf(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+Ye(i));if(typeof e=="function")throw new Error(n+"contains a function "+Ye(i)+" with contents = "+e.toString());if(Is(e))throw new Error(n+"contains "+e.toString()+" "+Ye(i));if(typeof e=="string"&&e.length>Ui/3&&ni(e)>Ui)throw new Error(n+"contains a string greater than "+Ui+" utf8 bytes "+Ye(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(J(e,(o,a)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Js(o)))throw new Error(n+" contains an invalid key ("+o+") "+Ye(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Qf(i,o),fi(n,a,i),Jf(i)}),s&&r)throw new Error(n+' contains ".value" child '+Ye(i)+" in addition to actual children.")}},Om=function(n,e){let t,i;for(t=0;t<e.length;t++){i=e[t];const r=Qt(i);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!Js(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+i.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(Kf);let s=null;for(t=0;t<e.length;t++){if(i=e[t],s!==null&&oe(s,i))throw new Error(n+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}},Lm=function(n,e,t,i){const s=ti(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(s+" must be an object containing the children to replace.");const r=[];J(e,(o,a)=>{const l=new B(o);if(fi(s,a,z(t,l)),Rs(l)===".priority"&&!Pm(a))throw new Error(s+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(l)}),Om(s,r)},Il=function(n,e,t,i){if(!El(t))throw new Error(ti(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Dm=function(n,e,t,i){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Il(n,e,t)},Sl=function(n,e){if(N(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Mm=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Js(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Nm(t))throw new Error(ti(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $m{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function pi(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!As(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function xl(n,e,t){pi(n,t),Tl(n,i=>As(i,e))}function le(n,e,t){pi(n,t),Tl(n,i=>oe(i,e)||oe(e,i))}function Tl(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(Fm(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Fm(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();Ht&&Q("event: "+t.toString()),kt(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Um="repo_interrupt",Bm=25;class Hm{constructor(e,t,i,s){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new $m,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=jn(),this.transactionQueueTree_=new Ys,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function qm(n,e,t){if(n.stats_=Ts(n.repoInfo_),n.forceRestClient_||yf())n.server_=new qn(n.repoInfo_,(i,s,r,o)=>{bo(n,i,s,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>wo(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{G(t)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}n.persistentConnection_=new Ce(n.repoInfo_,e,(i,s,r,o)=>{bo(n,i,s,r,o)},i=>{wo(n,i)},i=>{jm(n,i)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(i=>{n.server_.refreshAuthToken(i)}),n.appCheckProvider_.addTokenChangeListener(i=>{n.server_.refreshAppCheckToken(i.token)}),n.statsReporter_=If(n.repoInfo_,()=>new Cp(n.stats_,n.server_)),n.infoData_=new vp,n.infoSyncTree_=new vo({startListening:(i,s,r,o)=>{let a=[];const l=n.infoData_.getNode(i._path);return l.isEmpty()||(a=fn(n.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Xs(n,"connected",!1),n.serverSyncTree_=new vo({startListening:(i,s,r,o)=>(n.server_.listen(i,r,s,(a,l)=>{const c=o(a,l);le(n.eventQueue_,i._path,c)}),[]),stopListening:(i,s)=>{n.server_.unlisten(i,s)}})}function kl(n){const t=n.infoData_.getNode(new B(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function mi(n){return Cm({timestamp:kl(n)})}function bo(n,e,t,i,s){n.dataUpdateCount++;const r=new B(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(s)if(i){const l=Nn(t,c=>V(c));o=_m(n.serverSyncTree_,r,l,s)}else{const l=V(t);o=fl(n.serverSyncTree_,r,l,s)}else if(i){const l=Nn(t,c=>V(c));o=pm(n.serverSyncTree_,r,l)}else{const l=V(t);o=fn(n.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=Et(n,r)),le(n.eventQueue_,a,o)}function wo(n,e){Xs(n,"connected",e),e===!1&&Gm(n)}function jm(n,e){J(e,(t,i)=>{Xs(n,t,i)})}function Xs(n,e,t){const i=new B("/.info/"+e),s=V(t);n.infoData_.updateSnapshot(i,s);const r=fn(n.infoSyncTree_,i,s);le(n.eventQueue_,i,r)}function Zs(n){return n.nextWriteId_++}function zm(n,e,t){const i=vm(n.serverSyncTree_,e);return i!=null?Promise.resolve(i):n.server_.get(e).then(s=>{const r=V(s).withIndex(e._queryParams.getIndex());rs(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=fn(n.serverSyncTree_,e._path,r);else{const a=tn(n.serverSyncTree_,e);o=fl(n.serverSyncTree_,e._path,r,a)}return le(n.eventQueue_,e._path,o),Jn(n.serverSyncTree_,e,t,null,!0),r},s=>(mn(n,"get for query "+G(e)+" failed: "+s),Promise.reject(new Error(s))))}function Wm(n,e,t,i,s){mn(n,"set",{path:e.toString(),value:t,priority:i});const r=mi(n),o=V(t,i),a=qs(n.serverSyncTree_,e),l=vl(o,a,r),c=Zs(n),d=hl(n.serverSyncTree_,e,l,c,!0);pi(n.eventQueue_,d),n.server_.put(e.toString(),o.val(!0),(f,h)=>{const m=f==="ok";m||ee("set at "+e+" failed: "+f);const _=De(n.serverSyncTree_,c,!m);le(n.eventQueue_,e,_),as(n,s,f,h)});const u=tr(n,e);Et(n,u),le(n.eventQueue_,u,[])}function Vm(n,e,t,i){mn(n,"update",{path:e.toString(),value:t});let s=!0;const r=mi(n),o={};if(J(t,(a,l)=>{s=!1,o[a]=_l(z(e,a),V(l),n.serverSyncTree_,r)}),s)Q("update() called with empty data.  Don't do anything."),as(n,i,"ok",void 0);else{const a=Zs(n),l=fm(n.serverSyncTree_,e,o,a);pi(n.eventQueue_,l),n.server_.merge(e.toString(),t,(c,d)=>{const u=c==="ok";u||ee("update at "+e+" failed: "+c);const f=De(n.serverSyncTree_,a,!u),h=f.length>0?Et(n,e):e;le(n.eventQueue_,h,f),as(n,i,c,d)}),J(t,c=>{const d=tr(n,z(e,c));Et(n,d)}),le(n.eventQueue_,e,[])}}function Gm(n){mn(n,"onDisconnectEvents");const e=mi(n),t=jn();Zi(n.onDisconnect_,$(),(s,r)=>{const o=_l(s,r,n.serverSyncTree_,e);Ja(t,s,o)});let i=[];Zi(t,$(),(s,r)=>{i=i.concat(fn(n.serverSyncTree_,s,r));const o=tr(n,s);Et(n,o)}),n.onDisconnect_=jn(),le(n.eventQueue_,$(),i)}function Km(n,e,t){let i;N(e._path)===".info"?i=rs(n.infoSyncTree_,e,t):i=rs(n.serverSyncTree_,e,t),xl(n.eventQueue_,e._path,i)}function Rl(n,e,t){let i;N(e._path)===".info"?i=Jn(n.infoSyncTree_,e,t):i=Jn(n.serverSyncTree_,e,t),xl(n.eventQueue_,e._path,i)}function Ym(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Um)}function mn(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Q(t,...e)}function as(n,e,t,i){e&&kt(()=>{if(t==="ok")e(null);else{const s=(t||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function Al(n,e,t){return qs(n.serverSyncTree_,e,t)||T.EMPTY_NODE}function er(n,e=n.transactionQueueTree_){if(e||gi(n,e),At(e)){const t=Pl(n,e);y(t.length>0,"Sending zero length transaction queue"),t.every(s=>s.status===0)&&Qm(n,pn(e),t)}else bl(e)&&hi(e,t=>{er(n,t)})}function Qm(n,e,t){const i=t.map(c=>c.currentWriteId),s=Al(n,e,i);let r=s;const o=s.hash();for(let c=0;c<t.length;c++){const d=t[c];y(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const u=Z(e,d.path);r=r.updateChild(u,d.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;n.server_.put(l.toString(),a,c=>{mn(n,"transaction put response",{path:l.toString(),status:c});let d=[];if(c==="ok"){const u=[];for(let f=0;f<t.length;f++)t[f].status=2,d=d.concat(De(n.serverSyncTree_,t[f].currentWriteId)),t[f].onComplete&&u.push(()=>t[f].onComplete(null,!0,t[f].currentOutputSnapshotResolved)),t[f].unwatcher();gi(n,Qs(n.transactionQueueTree_,e)),er(n,n.transactionQueueTree_),le(n.eventQueue_,e,d);for(let f=0;f<u.length;f++)kt(u[f])}else{if(c==="datastale")for(let u=0;u<t.length;u++)t[u].status===3?t[u].status=4:t[u].status=0;else{ee("transaction at "+l.toString()+" failed: "+c);for(let u=0;u<t.length;u++)t[u].status=4,t[u].abortReason=c}Et(n,e)}},o)}function Et(n,e){const t=Nl(n,e),i=pn(t),s=Pl(n,t);return Jm(n,s,i),i}function Jm(n,e,t){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=Z(t,l.path);let d=!1,u;if(y(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)d=!0,u=l.abortReason,s=s.concat(De(n.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=Bm)d=!0,u="maxretry",s=s.concat(De(n.serverSyncTree_,l.currentWriteId,!0));else{const f=Al(n,l.path,o);l.currentInputSnapshot=f;const h=e[a].update(f.val());if(h!==void 0){fi("transaction failed: Data returned ",h,l.path);let m=V(h);typeof h=="object"&&h!=null&&_e(h,".priority")||(m=m.updatePriority(f.getPriority()));const w=l.currentWriteId,S=mi(n),E=vl(m,f,S);l.currentOutputSnapshotRaw=m,l.currentOutputSnapshotResolved=E,l.currentWriteId=Zs(n),o.splice(o.indexOf(w),1),s=s.concat(hl(n.serverSyncTree_,l.path,E,l.currentWriteId,l.applyLocally)),s=s.concat(De(n.serverSyncTree_,w,!0))}else d=!0,u="nodata",s=s.concat(De(n.serverSyncTree_,l.currentWriteId,!0))}le(n.eventQueue_,t,s),s=[],d&&(e[a].status=2,function(f){setTimeout(f,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(u==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(u),!1,null))))}gi(n,n.transactionQueueTree_);for(let a=0;a<i.length;a++)kt(i[a]);er(n,n.transactionQueueTree_)}function Nl(n,e){let t,i=n.transactionQueueTree_;for(t=N(e);t!==null&&At(i)===void 0;)i=Qs(i,t),e=j(e),t=N(e);return i}function Pl(n,e){const t=[];return Ol(n,e,t),t.sort((i,s)=>i.order-s.order),t}function Ol(n,e,t){const i=At(e);if(i)for(let s=0;s<i.length;s++)t.push(i[s]);hi(e,s=>{Ol(n,s,t)})}function gi(n,e){const t=At(e);if(t){let i=0;for(let s=0;s<t.length;s++)t[s].status!==2&&(t[i]=t[s],i++);t.length=i,yl(e,t.length>0?t:void 0)}hi(e,i=>{gi(n,i)})}function tr(n,e){const t=pn(Nl(n,e)),i=Qs(n.transactionQueueTree_,e);return Tm(i,s=>{Bi(n,s)}),Bi(n,i),wl(i,s=>{Bi(n,s)}),t}function Bi(n,e){const t=At(e);if(t){const i=[];let s=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(y(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(y(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),s=s.concat(De(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&i.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?yl(e,void 0):t.length=r+1,le(n.eventQueue_,pn(e),s);for(let o=0;o<i.length;o++)kt(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nr{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return O(this._path)?null:Rs(this._path)}get ref(){return new ke(this._repo,this._path)}get _queryIdentifier(){const e=ao(this._queryParams),t=Ss(e);return t==="{}"?"default":t}get _queryObject(){return ao(this._queryParams)}isEqual(e){if(e=se(e),!(e instanceof nr))return!1;const t=this._repo===e._repo,i=As(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+Gf(this._path)}}class ke extends nr{constructor(e,t){super(e,t,new Ls,!1)}get parent(){const e=ja(this._path);return e===null?null:new ke(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class nn{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new B(e),i=sn(this.ref,e);return new nn(this._node.getChild(t),i,W)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new nn(s,sn(this.ref,i),W)))}hasChild(e){const t=new B(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function C(n,e){return n=se(n),n._checkNotDeleted("ref"),e!==void 0?sn(n._root,e):n._root}function sn(n,e){return n=se(n),N(n._path)===null?Dm("child","path",e):Il("child","path",e),new ke(n._repo,z(n._path,e))}function Nt(n,e){n=se(n),Sl("push",n._path),Cl("push",e,n._path,!0);const t=kl(n._repo),i=tg(t),s=sn(n,i),r=sn(n,i);let o;return o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function F(n,e){n=se(n),Sl("set",n._path),Cl("set",e,n._path,!1);const t=new rn;return Wm(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function ge(n,e){Lm("update",e,n._path);const t=new rn;return Vm(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function ne(n){n=se(n);const e=new Ll(()=>{}),t=new _i(e);return zm(n._repo,n,t).then(i=>new nn(i,new ke(n._repo,n._path),n._queryParams.getIndex()))}class _i{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new ng("value",this,new nn(e.snapshotNode,new ke(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new ig(this,e,t):null}matches(e){return e instanceof _i?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function sg(n,e,t,i,s){const r=new Ll(t,void 0),o=new _i(r);return Km(n._repo,n,o),()=>Rl(n._repo,n,o)}function ir(n,e,t,i){return sg(n,"value",e)}function sr(n,e,t){Rl(n._repo,n,null)}rm(ke);dm(ke);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pg(n){sf(xt),_t(new Ze("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return lg(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),Fe(zr,Wr,n),Fe(zr,Wr,"esm2017")}Ce.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};Ce.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};pg();const mg={apiKey:"AIzaSyCzdkKcfNvafQ3x9NDUsTn8UOww7_v3nn0",authDomain:"who-s-the-queen-bee.firebaseapp.com",databaseURL:"https://who-s-the-queen-bee-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"who-s-the-queen-bee",storageBucket:"who-s-the-queen-bee.firebasestorage.app",messagingSenderId:"808367557368",appId:"1:808367557368:web:7af8a2948e62494c5e490d"},Dl=$o(mg),gg=tf(Dl),I=hg(Dl),_g="modulepreload",vg=function(n){return"/queen-bee-scorecard/"+n},Io={},Ml=function(e,t,i){let s=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),a=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(t.map(l=>{if(l=vg(l),l in Io)return;Io[l]=!0;const c=l.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":_g,c||(u.as="script"),u.crossOrigin="",u.href=l,a&&u.setAttribute("nonce",a),document.head.appendChild(u),c)return new Promise((f,h)=>{u.addEventListener("load",f),u.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return s.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return e().catch(r)})};async function ae(){const n=await ne(C(I,"employees"));return n.exists()?n.val():{}}async function vi(n,e){await ge(C(I,`employees/${n}`),e)}function Re(n=new Date){return`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}`}async function gn(n,e=Re()){const t=await ne(C(I,`monthly_points/${e}/${n}`));return t.exists()?t.val():{points:0,rank:null,db_count:0,db_pts_deducted:0,net_points:0}}async function rr(n,e,t=Re()){const i=await gn(n,t),s={...i,points:(i.points||0)+e,net_points:(i.net_points||0)+e};return await F(C(I,`monthly_points/${t}/${n}`),s),s}function yi(n=Re(),e){const t=C(I,`monthly_points/${n}`);return ir(t,i=>e(i.exists()?i.val():{})),()=>sr(t)}async function _n(n){const e=await ne(C(I,`vault/${n}`));return e.exists()?e.val():{total_earned:0,total_deducted:0,net:0,last_reset_date:null}}async function or(n,e){const t=await _n(n),i={...t,total_earned:(t.total_earned||0)+e,net:(t.net||0)+e};return await F(C(I,`vault/${n}`),i),i}async function $l(n){const e=Nt(C(I,"awards")),t={...n,timestamp:Date.now()};return await F(e,t),e.key}async function Fl(n){const e=await ne(C(I,"awards"));if(!e.exists())return[];const t=e.val();return Object.entries(t).map(([i,s])=>({id:i,...s})).filter(i=>i.receiver_id===n).sort((i,s)=>s.timestamp-i.timestamp)}async function ar(n){const e=await ne(C(I,"awards"));if(!e.exists())return[];const t=e.val();return Object.entries(t).map(([i,s])=>({id:i,...s})).filter(i=>i.giver_id===n).sort((i,s)=>s.timestamp-i.timestamp)}async function Ul(n){const e=Nt(C(I,"dark_beans")),t={...n,timestamp:Date.now(),appealed:!1,appeal_status:null};return await F(e,t),e.key}async function Bl(n,e=Re()){const t=await ne(C(I,"dark_beans"));if(!t.exists())return[];const i=t.val();return Object.entries(i).map(([s,r])=>({id:s,...r})).filter(s=>s.receiver_id===n&&s.month_key===e).sort((s,r)=>r.timestamp-s.timestamp)}async function lr(n,e,t){const i=await ne(C(I,`offense_escalation/${n}/${e}/${t}`));return i.exists()?i.val().instance_count:0}async function Hl(n,e,t){const i=await lr(n,e,t);return await F(C(I,`offense_escalation/${n}/${e}/${t}`),{instance_count:i+1}),i+1}async function Pt(){const n=await ne(C(I,"action_menu"));return n.exists()?n.val():{}}async function ql(n,e){await ge(C(I,`action_menu/${n}`),e)}async function Ot(){const n=await ne(C(I,"offense_menu"));return n.exists()?n.val():{}}async function jl(n,e){await ge(C(I,`offense_menu/${n}`),e)}async function bi(n=Re()){const e=await ne(C(I,`nominations/${n}/wildcard_nominee`));return e.exists()?e.val():null}async function cr(n,e){await F(C(I,`nominations/${n}/wildcard_nominee`),e)}async function dr(n){await F(C(I,`nominations/${n}/wildcard_nominee`),null)}async function zl(n,e,t){await F(C(I,`votes/${n}/${e}`),t)}async function vn(n=Re()){const e=await ne(C(I,`votes/${n}`));return e.exists()?e.val():{}}async function Tn(n,e){return(await ne(C(I,`votes/${n}/${e}`))).exists()}async function Ut(n){const e=Nt(C(I,"audit_flags")),t={...n,timestamp:Date.now(),status:"open",acted_by:null,acted_at:null};return await F(e,t),e.key}async function Wl(n,e,t){await ge(C(I,`audit_flags/${n}`),{status:e,acted_by:t,acted_at:Date.now()})}async function Vl(){const n=await ne(C(I,"audit_flags"));return n.exists()?Object.entries(n.val()).map(([e,t])=>({id:e,...t})).sort((e,t)=>t.timestamp-e.timestamp):[]}async function Gl(n){const e=Nt(C(I,"pending_registrations"));return await F(e,{...n,submitted_at:Date.now(),status:"pending"}),e.key}async function Kl(n,e,t){const i="emp_"+n.slice(-8);return await F(C(I,`employees/${i}`),{name:e.name,email:e.email,role:e.role,outlet:e.outlet,pin_hash:e.pin_hash,active:!0}),await ge(C(I,`pending_registrations/${n}`),{status:"approved",approved_by:t,approved_at:Date.now()}),i}async function Yl(n,e){await ge(C(I,`pending_registrations/${n}`),{status:"rejected",rejected_by:e,rejected_at:Date.now()})}function Xn(n){const e=C(I,"pending_registrations");return ir(e,t=>{if(!t.exists()){n([]);return}const i=Object.entries(t.val()).map(([s,r])=>({id:s,...r})).filter(s=>s.status==="pending");n(i)}),()=>sr(e)}async function Ql(n,e,t,i=Re()){const s=await gn(n,i),r={...s,db_count:(s.db_count||0)+e,db_pts_deducted:(s.db_pts_deducted||0)+t,net_points:Math.max(0,(s.net_points||s.points||0)-t)};return await F(C(I,`monthly_points/${i}/${n}`),r),r}async function Jl(n,e){const t=await _n(n),i={...t,total_deducted:(t.total_deducted||0)+e,net:Math.max(0,(t.net||0)-e)};return await F(C(I,`vault/${n}`),i),i}async function Xl(n,e,t,i=Re()){const s=await gn(n,i),r={...s,db_count:Math.max(0,(s.db_count||0)-e),db_pts_deducted:Math.max(0,(s.db_pts_deducted||0)-t),net_points:(s.net_points||s.points||0)+t};return await F(C(I,`monthly_points/${i}/${n}`),r),r}async function Zl(n,e){const t=await _n(n),i={...t,total_deducted:Math.max(0,(t.total_deducted||0)-e),net:(t.net||0)+e};return await F(C(I,`vault/${n}`),i),i}async function ec(n){const e=await ne(C(I,"dark_beans"));return e.exists()?Object.entries(e.val()).map(([t,i])=>({id:t,...i})).filter(t=>t.giver_id===n&&!t.revoked).sort((t,i)=>i.timestamp-t.timestamp):[]}async function tc(n){const e=Nt(C(I,"revoke_requests"));return await F(e,{...n,submitted_at:Date.now(),status:"pending"}),e.key}function Zn(n){const e=C(I,"revoke_requests");return ir(e,t=>{if(!t.exists()){n([]);return}const i=Object.entries(t.val()).map(([s,r])=>({id:s,...r})).filter(s=>s.status==="pending");n(i)}),()=>sr(e)}async function nc(n,e,t){const i=Date.now(),s=Nt(C(I,"revoke_log"));await Promise.all([Xl(e.receiver_id,e.db_count,e.pts_deducted,e.month_key),Zl(e.receiver_id,e.pts_deducted),ge(C(I,`dark_beans/${e.dark_bean_id}`),{revoked:!0,revoked_at:i,revoked_by:t}),ge(C(I,`revoke_requests/${n}`),{status:"approved",approved_by:t,approved_at:i}),F(s,{dark_bean_id:e.dark_bean_id,receiver_id:e.receiver_id,giver_id:e.giver_id,giver_name:e.giver_name,offense_id:e.offense_id,conduct_tier:e.conduct_tier,pts_restored:e.pts_deducted,reason:e.reason,approved_by:t,timestamp:i})])}async function ic(n,e){await ge(C(I,`revoke_requests/${n}`),{status:"rejected",rejected_by:e,rejected_at:Date.now()})}async function sc(){await Promise.all([F(C(I,"awards"),null),F(C(I,"monthly_points"),null),F(C(I,"vault"),null),F(C(I,"dark_beans"),null),F(C(I,"audit_flags"),null),F(C(I,"offense_escalation"),null),F(C(I,"votes"),null),F(C(I,"nominations"),null),F(C(I,"revoke_requests"),null),F(C(I,"revoke_log"),null)])}async function rc(){await Promise.all([F(C(I,"employees"),null),F(C(I,"pending_registrations"),null)])}async function wi(){const n=await ne(C(I,"config"));return n.exists()?n.val():{}}async function oc(n){await ge(C(I,"config"),n)}const yg=Object.freeze(Object.defineProperty({__proto__:null,addMonthlyPoints:rr,addVaultPoints:or,approveRegistration:Kl,approveRevokeRequest:nc,castVote:zl,clearWildcardNominee:dr,createAuditFlag:Ut,createAward:$l,createDarkBean:Ul,createRevokeRequest:tc,deductMonthlyPoints:Ql,deductVaultPoints:Jl,getActions:Pt,getAllEmployees:ae,getAllFlags:Vl,getAwardsByEmployee:Fl,getAwardsByGiver:ar,getConfig:wi,getDarkBeansByEmployee:Bl,getDarkBeansByGiver:ec,getMonthlyPoints:gn,getOffenseInstance:lr,getOffenses:Ot,getVault:_n,getVotes:vn,getWildcardNominee:bi,hasVoted:Tn,incrementOffenseInstance:Hl,listenLeaderboard:yi,listenPendingRegistrations:Xn,listenRevokeRequests:Zn,monthKey:Re,nukeAllStaff:rc,nukeTransactionalData:sc,rejectRegistration:Yl,rejectRevokeRequest:ic,reverseDeduction:Xl,reverseVaultDeduction:Zl,setWildcardNominee:cr,submitRegistration:Gl,updateConfig:oc,updateFlagStatus:Wl,upsertAction:ql,upsertEmployee:vi,upsertOffense:jl},Symbol.toStringTag,{value:"Module"})),Ei="hb_bs_session",bg=2*60*60*1e3,wg=30*1e3;function ac(n){const e={...n,loginAt:Date.now()};localStorage.setItem(Ei,JSON.stringify(e))}function lc(){try{const n=localStorage.getItem(Ei);if(!n)return null;const e=JSON.parse(n);return Date.now()-e.loginAt>bg?(cc(),null):e}catch{return null}}function cc(){localStorage.removeItem(Ei)}function Eg(){const n=lc();n&&(n.loginAt=Date.now(),localStorage.setItem(Ei,JSON.stringify(n)))}function dc(){return setInterval(Eg,wg)}async function Cg(n){const t=new TextEncoder().encode(n),i=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}async function Ig(n,e){const{getAllEmployees:t}=await Ml(async()=>{const{getAllEmployees:o}=await Promise.resolve().then(()=>yg);return{getAllEmployees:o}},void 0),i=await t(),s=Object.entries(i).map(([o,a])=>({id:o,...a})).find(o=>o.email===n&&o.active!==!1);if(!s)throw new Error("Employee not found");const r=await Cg(e);if(s.pin_hash!==r)throw new Error("Incorrect PIN");return ac(s),s}function ei(){return!!(window.PublicKeyCredential&&navigator.credentials)}async function Sg(n){if(!ei())return!1;try{const e=crypto.getRandomValues(new Uint8Array(32)),t=new TextEncoder().encode(n.id),i=await navigator.credentials.create({publicKey:{challenge:e,rp:{name:"Heebee Bean System"},user:{id:t,name:n.email,displayName:n.name},pubKeyCredParams:[{type:"public-key",alg:-7}],authenticatorSelection:{authenticatorAttachment:"platform",userVerification:"required"},timeout:6e4,attestation:"none"}});return i?(await vi(n.id,{webauthn_id:Tg(i.rawId)}),!0):!1}catch(e){return console.warn("WebAuthn registration failed, using PIN only:",e.message),!1}}async function xg(n){if(!ei()||!n.webauthn_id)return!1;try{const e=crypto.getRandomValues(new Uint8Array(32)),t=kg(n.webauthn_id);return await navigator.credentials.get({publicKey:{challenge:e,allowCredentials:[{type:"public-key",id:t}],userVerification:"required",timeout:6e4}})?(ac(n),n):!1}catch(e){return console.warn("WebAuthn auth failed, fall back to PIN:",e.message),!1}}function Tg(n){return btoa(String.fromCharCode(...new Uint8Array(n)))}function kg(n){const e=atob(n),t=new Uint8Array(e.length);for(let i=0;i<e.length;i++)t[i]=e.charCodeAt(i);return t.buffer}function Rg(){cc()}const he={green:{id:"green",icon:"🫘",label:"Green Bean",pts:1,dailyCap:3},silver:{id:"silver",icon:"☕",label:"Silver Bean",pts:5,dailyCap:3},gold:{id:"gold",icon:"🥇",label:"Gold Bean",pts:10,dailyCap:3},crystal:{id:"crystal",icon:"💎",label:"Crystal Bean",pts:25,dailyCap:10}},Ct=["Trainee","Barista","Senior Barista","Kitchen Helper","Commi 3","Commi 2","Commi 1","DCDP","CDP"],Ci=["Floor Manager","Sous Chef","Cafe Manager","Head Chef","Area Manager","HOD","CEO","COO","Owner"],Ii=["HR","Accountant","Admin Staff"],uc={"Floor Manager":["green"],"Sous Chef":["green"],"Cafe Manager":["silver"],"Head Chef":["silver"],"Area Manager":["gold"],HOD:["gold"],CEO:["green","silver","gold","crystal"],COO:["green","silver","gold","crystal"],Owner:["green","silver","gold","crystal"]},kn={green:{id:"green",icon:"🟢",label:"Minor",base_db:1,pts:5},silver:{id:"silver",icon:"🟠",label:"Moderate",base_db:3,pts:15},gold:{id:"gold",icon:"🔴",label:"Serious",base_db:5,pts:25},crystal:{id:"crystal",icon:"⚫",label:"Severe",base_db:10,pts:50}},hc={"Floor Manager":["green"],"Sous Chef":["green"],"Cafe Manager":["green","silver"],"Head Chef":["green","silver"],"Area Manager":["green","silver","gold"],HOD:["green","silver","gold"],HR:["green","silver","gold","crystal"],CEO:["green","silver","gold","crystal"],COO:["green","silver","gold","crystal"],Owner:["green","silver","gold","crystal"]},cs=5,fc=[{id:"act_01",name:"Daily Task Completion",applicable_bean_tier:"any",active:!0},{id:"act_02",name:"Perfect Attendance",applicable_bean_tier:"any",active:!0},{id:"act_03",name:"Upsell Achievement",applicable_bean_tier:"silver",active:!0},{id:"act_04",name:"Training Completion",applicable_bean_tier:"any",active:!0},{id:"act_05",name:"Customer Recovery Handle",applicable_bean_tier:"silver",active:!0},{id:"act_06",name:"Outlet Opening Standard",applicable_bean_tier:"any",active:!0},{id:"act_07",name:"Special Initiative",applicable_bean_tier:"gold",active:!0}],pc=[{id:"off_01",name:"Late Arrival",base_db:1,escalation:"double",submission_cap:8,active:!0},{id:"off_02",name:"No-Show No Notice",base_db:5,escalation:"double",submission_cap:20,active:!0},{id:"off_03",name:"Negligence",base_db:2,escalation:"double",submission_cap:16,active:!0},{id:"off_04",name:"Duty Denial",base_db:3,escalation:"double",submission_cap:24,active:!0},{id:"off_05",name:"Misconduct",base_db:4,escalation:"double",submission_cap:32,active:!0},{id:"off_06",name:"Serious/Insubordination",base_db:10,escalation:"double",submission_cap:40,active:!0}],ur=[{id:"SHB",name:"Sarabha Nagar",brand:"Heebee Coffee"},{id:"GHB",name:"Ghumar Mandi",brand:"Heebee Coffee"},{id:"JLD",name:"Model Town, Jalandhar",brand:"Heebee Coffee"},{id:"POUR",name:"Pour by Heebee",brand:"Pour"}];function mc(n){return Ct.includes(n)}function hr(n){return Ci.includes(n)}function gc(n){return Ii.includes(n)}function dt(n){return n==="HR"}function re(n){return["CEO","COO","Owner"].includes(n)}function _c(n){const e={},t={};n.forEach(({giver_id:s,receiver_id:r,points_value:o})=>{e[s]=(e[s]||0)+o;const a=`${s}::${r}`;t[a]=(t[a]||0)+o});const i=[];return Object.entries(t).forEach(([s,r])=>{const[o,a]=s.split("::"),l=e[o]||0;l>0&&r/l>.6&&i.push({type:"bias_concentration",giver_id:o,receiver_id:a,pct:Math.round(r/l*100)})}),i}function vc(n){return n>=100?"disciplinary":n>=51?"owners_notified":n>=26?"suggest_disqualify":n>=10?"silent_flag":null}function yc(n){const e={green:0,silver:0,gold:0,crystal:0};return n.forEach(({bean_type:t})=>{e[t]!==void 0&&e[t]++}),Object.entries(e).filter(([,t])=>t>0).map(([t,i])=>`${he[t].icon} ${i}`).join(" · ")}const Ag=Object.freeze(Object.defineProperty({__proto__:null,ADMIN_ROLES:Ii,BEAN_TIERS:he,CONDUCT_TIERS:kn,DB_POINTS_EACH:cs,DEFAULT_ACTIONS:fc,DEFAULT_OFFENSES:pc,GIVER_ROLES:Ci,OUTLETS:ur,RECEIVER_ROLES:Ct,ROLE_BEAN_PERMISSIONS:uc,ROLE_CONDUCT_PERMISSIONS:hc,checkBiasConcentration:_c,formatBeanCounts:yc,getDBThresholdLevel:vc,isAdmin:gc,isGiver:hr,isHR:dt,isOwner:re,isReceiver:mc},Symbol.toStringTag,{value:"Module"})),Ng=[...Ct,...Ci,...Ii];async function Pg(n){const e=new TextEncoder().encode(n),t=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(t)).map(i=>i.toString(16).padStart(2,"0")).join("")}function Og(n,e){n.innerHTML=`
  ...
  `,n.querySelector("#btn-logout").addEventListener("click",i);try{hr(e.role)?await Hg(n,e,s):gc(e.role)?await qg(n,e,s):await Bg(n,e,t,s)}catch(r){console.error("Dashboard error:",r),n.querySelector("#dash-loading").classList.remove("hidden"),n.querySelector("#dash-loading").innerHTML=`<div class="empty-state"><p style="color:var(--red);">Failed to load dashboard.</p><p class="text-dim text-sm mt-8">${r.message}</p></div>`}}async function Bg(n,e,t,i){const s=t.db_toggle===!0,[r,o,a,l,c]=await Promise.all([gn(e.id),_n(e.id),Fl(e.id),ae(),Pt()]);n.querySelector("#dash-loading").classList.add("hidden");const d=n.querySelector("#dash-content");d.classList.remove("hidden"),yi(me(),E=>{const x=Fg(E),A=["Trainee","Barista","Senior Barista","Kitchen Helper","Commi 3","Commi 2","Commi 1","DCDP","CDP"],b=x.filter(M=>{const D=l[M.id]||{};return A.includes(D.role||"")}).findIndex(M=>M.id===e.id),p=d.querySelector("#nomination-banner");p&&(b>=0&&b<5?(p.innerHTML=`
        ...
        `,p.classList.remove("hidden")):(p.innerHTML="",p.classList.add("hidden")));const v=x.find(M=>M.id===e.id),k=d.querySelector("#my-rank");k&&v&&(k.textContent=`#${v.rank}`)});const u=a.slice(0,5),f=yc(a),h=e.name.split(" ").map(E=>E[0]).join("").slice(0,2).toUpperCase(),m=["#8B5E3C","#5E6E8B","#5E8B6E","#8B5E7A","#7A8B5E","#6E5E8B","#8B7A5E"],_=m[e.name.charCodeAt(0)%m.length];d.innerHTML=`
    <!-- Profile Photo -->
  ...
  `;const w=d.querySelector("#photo-upload"),S=d.querySelector("#photo-status");d.querySelector("#profile-hex"),w==null||w.addEventListener("change",async E=>{const x=E.target.files[0];if(x){S.textContent="Compressing…";try{const A=await Dg(x),g=Math.round(A.length/1024);await vi(e.id,{photo_url:A}),e.photo_url=A;const b=d.querySelector("#profile-hex");b&&(b.outerHTML=`<img id="profile-hex" src="${A}" style="width:64px;height:64px;clip-path:polygon(50% 0%,95% 25%,95% 75%,50% 100%,5% 75%,5% 25%);object-fit:cover;" />`),S.textContent=`✓ Saved (${g}KB)`,setTimeout(()=>{S.textContent=""},3e3)}catch(A){S.textContent="Failed. Try a smaller image.",console.error(A)}}})}async function Hg(n,e,t){var x,A,g,b;const i=["Owner","CEO","COO","HR"].includes(e.role),s=me(),[r,o,a,l,c,d,u,f]=await Promise.all([ar(e.id),ae(),Pt(),ec(e.id),Ot(),i?wi():Promise.resolve({}),i?bi(s):Promise.resolve(null),i?vn(s):Promise.resolve({})]),h=Object.keys(f).length>0;n.querySelector("#dash-loading").classList.add("hidden");const m=n.querySelector("#dash-content");m.classList.remove("hidden");const _=me(),w=r.filter(p=>{const v=new Date(p.timestamp);return`${v.getFullYear()}-${String(v.getMonth()+1).padStart(2,"0")}`===_}),S=w.reduce((p,v)=>p+v.points_value*(v.quantity||1),0),E={green:0,silver:0,gold:0,crystal:0};w.forEach(p=>{E[p.bean_type]!==void 0&&E[p.bean_type]++}),m.innerHTML=`
    <div class="card mb-16" style="text-align:center;padding:28px 20px;">
      <p class="section-header" style="margin-bottom:4px;">Beans Given This Month</p>
      <div class="mono text-gold" style="font-size:3rem;font-weight:400;margin-bottom:4px;">
        ${w.length}
      </div>
      <p class="text-dim text-sm">${Je(S)} pts awarded to your team</p>
    </div>
  ...
  `,(x=m.querySelector("#btn-quick-award"))==null||x.addEventListener("click",()=>t("award")),(A=m.querySelector("#toggle-voting-pts"))==null||A.addEventListener("change",async p=>{const v=p.target.checked,k=p.target.nextElementSibling,M=k==null?void 0:k.querySelector("span");k&&(k.style.background=v?"var(--gold)":"var(--border)"),M&&(M.style.left=v?"23px":"3px"),await oc({voting_points_enabled:v})}),(g=m.querySelector("#btn-set-wildcard"))==null||g.addEventListener("click",async()=>{if(h)return;const p=m.querySelector("#wildcard-select"),v=p==null?void 0:p.value;if(!v)return;const k=m.querySelector("#btn-set-wildcard");k.disabled=!0,k.textContent="Saving…",await cr(s,{employee_id:v,nominated_by_id:e.id,nominated_by_name:e.name,nominated_at:Date.now()}),k.textContent="✓ Saved";const M=m.querySelector("#wildcard-status"),D=o[v];M&&(M.textContent=`⭐ ${(D==null?void 0:D.name)||v} is this month's wildcard nominee`),k.disabled=!1}),(b=m.querySelector("#btn-clear-wildcard"))==null||b.addEventListener("click",async()=>{if(h)return;const p=m.querySelector("#btn-clear-wildcard");p.disabled=!0,p.textContent="Clearing…",await dr(s),p.textContent="Cleared";const v=m.querySelector("#wildcard-status");v&&(v.textContent="No wildcard nominee set"),m.querySelector("#wildcard-select").value=""}),m.querySelectorAll(".btn-revoke-request").forEach(p=>{p.addEventListener("click",async()=>{const v=p.dataset.id,k=l.find(D=>D.id===v);if(!k)return;const M=prompt("Reason for revoking this conduct? (required)");if(!(!M||!M.trim())){p.disabled=!0,p.textContent="Requesting…";try{await tc({dark_bean_id:v,receiver_id:k.receiver_id,giver_id:e.id,giver_name:e.name,offense_id:k.offense_id,conduct_tier:k.conduct_tier,db_count:k.db_count,pts_deducted:k.pts_deducted,month_key:k.month_key,reason:M.trim()}),p.textContent="⏳ Pending Approval",p.style.color="var(--text-secondary)"}catch(D){p.disabled=!1,p.textContent="Request Revoke",console.error(D)}}})})}async function qg(n,e,t){var c,d,u,f;const i=me(),[s,r,o]=await Promise.all([ae(),bi(i),vn(i)]),a=Object.keys(o).length>0;n.querySelector("#dash-loading").classList.add("hidden");const l=n.querySelector("#dash-content");l.classList.remove("hidden"),l.innerHTML=`
...
👤 From: ${i} · 📋 ${s}`})}async function e_(n,e,t){n.innerHTML=`
  ...
  `;let i=e.role==="HR"?"conduct":"award",s={},r={},o={},a=[];try{[s,r,o]=await Promise.all([ae(),Pt(),Ot()]),a=Object.entries(s).map(([d,u])=>({id:d,...u})).filter(d=>mc(d.role)&&d.active!==!1).sort((d,u)=>d.name.localeCompare(u.name))}catch{n.querySelector("#award-content").innerHTML='<p class="text-dim text-sm text-center">Failed to load. Check connection.</p>';return}n.querySelectorAll(".award-tab").forEach(d=>{d.addEventListener("click",()=>{i=d.dataset.tab,n.querySelectorAll(".award-tab").forEach(u=>{u.className=u.dataset.tab===i?"btn btn-primary award-tab":"btn btn-ghost award-tab",u.style.flex="1",u.style.padding="10px"}),i==="award"?l():c()})}),e.role==="HR"?c():l();function l(){const d=n.querySelector("#award-content"),u=uc[e.role]||[],f=Object.entries(r).map(([p,v])=>({id:p,...v})).filter(p=>p.active!==!1);if(a.length===0){d.innerHTML=`
    ...
    `;const m=d.querySelector("#emp-list"),_=d.querySelector("#search-emp");let w=a;function S(){m.innerHTML=w.map(p=>{var v,k;return`
        <div class="lb-row emp-row" data-id="${p.id}" style="cursor:pointer;margin-bottom:6px;${((v=h.receiver)==null?void 0:v.id)===p.id?"border-color:var(--gold);background:rgba(201,168,76,0.06);":""}">
          ...
          ${((k=h.receiver)==null?void 0:k.id)===p.id?'<span class="text-gold">✓</span>':""}
        </div>
      `}).join(""),m.querySelectorAll(".emp-row").forEach(p=>{p.addEventListener("click",()=>{h.receiver=a.find(v=>v.id===p.dataset.id),S(),b()})})}_.addEventListener("input",()=>{const p=_.value.toLowerCase();w=p?a.filter(v=>v.name.toLowerCase().includes(p)):a,S()}),S();function E(p){h.beanType=p,d.querySelectorAll(".bean-type-btn").forEach(v=>{v.style.borderColor=v.dataset.type===p?"var(--gold)":"var(--border)",v.style.background=v.dataset.type===p?"rgba(201,168,76,0.1)":"var(--glass-bg)"}),b()}d.querySelectorAll(".bean-type-btn").forEach(p=>{p.addEventListener("click",()=>E(p.dataset.type))}),u.length===1&&E(u[0]),d.querySelectorAll(".action-btn").forEach(p=>{p.addEventListener("click",()=>{h.actionId=p.dataset.id,d.querySelectorAll(".action-btn").forEach(v=>{v.style.background=v.dataset.id===h.actionId?"rgba(201,168,76,0.15)":"",v.style.borderColor=v.dataset.id===h.actionId?"rgba(201,168,76,0.4)":"",v.style.color=v.dataset.id===h.actionId?"var(--gold)":""}),b()})});const x=d.querySelector("#qty-display");d.querySelector("#btn-minus").addEventListener("click",()=>{h.quantity>1&&(h.quantity--,x.textContent=h.quantity)}),d.querySelector("#btn-plus").addEventListener("click",()=>{const p=h.beanType?he[h.beanType].dailyCap:10;h.quantity<p&&(h.quantity++,x.textContent=h.quantity)});const A=d.querySelector("#btn-submit"),g=d.querySelector("#award-error");function b(){A.disabled=!(h.receiver&&h.beanType&&h.actionId)}A.addEventListener("click",async()=>{if(!(!h.receiver||!h.beanType||!h.actionId)){A.disabled=!0,A.textContent="Awarding…",g.classList.add("hidden");try{const p=he[h.beanType],v=p.pts*h.quantity;await $l({giver_id:e.id,giver_name:e.name,receiver_id:h.receiver.id,bean_type:h.beanType,points_value:p.pts,action_id:h.actionId,reason_text:d.querySelector("#inp-reason").value.trim(),outlet:e.outlet,quantity:h.quantity}),await Promise.all([rr(h.receiver.id,v),or(h.receiver.id,v)]),await Zg({receiverName:h.receiver.name,beanType:h.beanType,pts:v,giverName:e.name,actionName:h.actionId});const k=await ar(e.id),M=me(),D=k.filter(H=>{const X=new Date(H.timestamp);return`${X.getFullYear()}-${String(X.getMonth()+1).padStart(2,"0")}`===M}),L=_c(D);for(const H of L)await Ut({type:"bias_concentration",giver_id:H.giver_id,receiver_id:H.receiver_id,suggestion_text:`${e.name} has directed ${H.pct}% of their beans to one person this month.`,suggestion:"Review award distribution to ensure fairness across the team."}).catch(()=>{});d.innerHTML=`
    ...
    `;const m=d.querySelector("#emp-list-c"),_=d.querySelector("#search-emp-c");let w=a;function S(){m.innerHTML=w.map(g=>{var b,p;return`
      ...
      `}).join(""),m.querySelectorAll(".emp-row-c").forEach(g=>{g.addEventListener("click",()=>{h.receiver=a.find(b=>b.id===g.dataset.id),S(),E()})})}_.addEventListener("input",()=>{const g=_.value.toLowerCase();w=g?a.filter(b=>b.name.toLowerCase().includes(g)):a,S()}),S(),d.querySelectorAll(".conduct-tier-btn").forEach(g=>{g.addEventListener("click",()=>{h.tier=g.dataset.type,d.querySelectorAll(".conduct-tier-btn").forEach(b=>{b.style.borderColor=b.dataset.type===h.tier?"rgba(255,69,58,0.6)":"var(--border)",b.style.background=b.dataset.type===h.tier?"rgba(255,69,58,0.1)":"var(--glass-bg)"}),E()})}),d.querySelectorAll(".offense-btn").forEach(g=>{g.addEventListener("click",()=>{h.offenseId=g.dataset.id,d.querySelectorAll(".offense-btn").forEach(b=>{b.style.background=b.dataset.id===h.offenseId?"rgba(255,69,58,0.12)":"",b.style.borderColor=b.dataset.id===h.offenseId?"rgba(255,69,58,0.4)":"",b.style.color=b.dataset.id===h.offenseId?"var(--red)":""}),E()})});async function E(){const g=d.querySelector("#conduct-preview"),b=d.querySelector("#btn-conduct-submit");if(!h.receiver||!h.tier||!h.offenseId){g.classList.add("hidden"),b.disabled=!0;return}g.innerHTML='<div class="spinner" style="margin:0 auto;"></div>',g.classList.remove("hidden");const p=kn[h.tier],v=me(),k=await lr(h.receiver.id,v,h.offenseId)+1,M=Math.pow(2,k-1),D=p.base_db*M,L=D*cs,X=["1st","2nd","3rd","4th","5th"][k-1]||`${k}th`,Lt=f.find(pr=>pr.id===h.offenseId);g.innerHTML=`
        ...
        <p class="text-dim text-sm mt-8">= −${L} pts from monthly score</p>
      `,b.disabled=!1}const x=d.querySelector("#conduct-error"),A=d.querySelector("#btn-conduct-submit");A.addEventListener("click",async()=>{if(!(!h.receiver||!h.tier||!h.offenseId)){A.disabled=!0,A.textContent="Issuing…",x.classList.add("hidden");try{const g=me(),b=Mg(),p=kn[h.tier],v=f.find(Ge=>Ge.id===h.offenseId),M=(await Bl(h.receiver.id,g)).filter(Ge=>Ge.offense_id===h.offenseId&&!Ge.revoked),D=await Hl(h.receiver.id,g,h.offenseId),L=Math.pow(2,D-1),H=p.base_db*L,X=H*cs;await Ul({giver_id:e.id,giver_name:e.name,receiver_id:h.receiver.id,offense_id:h.offenseId,conduct_tier:h.tier,db_count:H,pts_deducted:X,month_key:g,note:d.querySelector("#inp-conduct-note").value.trim(),instance:D,multiplier:L});const Lt=await Ql(h.receiver.id,H,X,g);await Jl(h.receiver.id,X),M.filter(Ge=>{const xi=new Date(Ge.timestamp),Cc=`${xi.getFullYear()}-${String(xi.getMonth()+1).padStart(2,"0")}-${String(xi.getDate()).padStart(2,"0")}`;return Ge.giver_id!==e.id&&Cc===b}).length>0&&await Ut({type:"cross_conduct",receiver_id:h.receiver.id,giver_id:e.id,suggestion_text:`${h.receiver.name} received "${v==null?void 0:v.name}" conduct from multiple managers on the same day. Possible duplicate issuance.`,suggestion:"Confirm with both managers this is not a duplicate. Consider revoking one."}).catch(()=>{}),M.length>=3&&await Ut({type:"conduct_frequency",receiver_id:h.receiver.id,giver_id:e.id,suggestion_text:`${h.receiver.name} has now received "${v==null?void 0:v.name}" conduct ${M.length+1} times this month.`,suggestion:"High frequency of same conduct. Escalate to formal HR review or disciplinary process."}).catch(()=>{});const mr=Lt.db_count||0,Si=vc(mr);Si&&await Ut({type:"db_threshold",receiver_id:h.receiver.id,giver_id:e.id,suggestion_text:`${h.receiver.name} has accumulated ${mr} Dark Beans this month (${Si.replace(/_/g," ")}).`,suggestion:Si==="disciplinary"?"Consider formal disciplinary action.":"Review conduct history and consider counselling."}).catch(()=>{}),d.innerHTML=`
          <div class="text-center" style="padding:60px 20px;">
            <div style="font-size:3rem;margin-bottom:16px;">${p.icon}</div>
            <h2 style="margin-bottom:8px;color:var(--red);">Conduct Logged</h2>
            <p class="text-dim">${H} Dark Bean${H!==1?"s":""} issued to <strong>${h.receiver.name}</strong></p>
            <p class="text-dim text-sm mt-4">${(v==null?void 0:v.name)||""} · ${p.label}${D>1?` · ${L}× escalation`:""}</p>
            <p class="text-dim text-sm mt-4">−${X} pts deducted from their monthly score</p>
            <button class="btn btn-ghost mt-24" id="btn-conduct-again">Issue Another</button>
          </div>
        `,d.querySelector("#btn-conduct-again").addEventListener("click",c)}catch(g){x.textContent="Failed to submit. Try again.",x.classList.remove("hidden"),A.disabled=!1,A.textContent="Issue Conduct",console.error(g)}}})}}async function t_(n,e,t){const i=re(e.role);n.innerHTML=`
    <div class="page">
  ...
  `;let s="flags";const r=n.querySelector("#audit-content");n.querySelectorAll(".audit-tab").forEach(u=>{u.addEventListener("click",()=>{s=u.dataset.tab,n.querySelectorAll(".audit-tab").forEach(f=>{f.className=f.dataset.tab===s?"btn btn-primary audit-tab":"btn btn-ghost audit-tab",f.style.flex="1",f.style.padding="10px"}),o(s)})});async function o(u){r.innerHTML='<div class="loading-center" style="min-height:30vh;"><div class="spinner"></div></div>',u==="flags"&&await a(),u==="log"&&await l(),u==="votes"&&await c(),u==="reset"&&d()}async function a(){try{const[u,f]=await Promise.all([Vl(),ae()]),h=u.filter(_=>_.status==="open"),m=u.filter(_=>_.status!=="open");if(!u.length){r.innerHTML=`
        ...
        ${m.length?`
          ...
          ${m.map(_=>So(_,!0,f)).join("")}
        `:""}
      `,r.querySelectorAll(".flag-action-btn").forEach(_=>{_.addEventListener("click",async()=>{const{flagId:w,action:S}=_.dataset;_.disabled=!0,await Wl(w,S,e.id),await o("flags")})})}catch{r.innerHTML='<p class="text-dim text-sm text-center">Failed to load flags.</p>'}}async function l(){try{const u="https://who-s-the-queen-bee-default-rtdb.asia-southeast1.firebasedatabase.app",[f,h,m,_,w,S]=await Promise.all([ae(),Pt(),Ot(),fetch(`${u}/awards.json`).then(p=>p.json()),fetch(`${u}/dark_beans.json`).then(p=>p.json()),fetch(`${u}/revoke_log.json`).then(p=>p.json())]),E=_?Object.entries(_).map(([p,v])=>({id:p,kind:"award",...v})):[],x=w?Object.entries(w).map(([p,v])=>({id:p,kind:"conduct",...v})):[],A=S?Object.entries(S).map(([p,v])=>({id:p,kind:"revoke",...v})):[],g=[...E,...x,...A].sort((p,v)=>v.timestamp-p.timestamp);if(!g.length){r.innerHTML=`
          <div class="empty-state">
            <div class="icon">📋</div>
        ...
        <p class="section-header" style="margin-bottom:12px;">
          Full Log — ${E.length} awards · ${x.length} conduct
        </p>
        ${g.map(p=>{const v=f[p.receiver_id],k=f[p.giver_id],M=(k==null?void 0:k.name)||p.giver_name||p.giver_id||"—",D=(k==null?void 0:k.role)||"";if(p.kind==="award"){const L=he[p.bean_type]||{icon:"🫘",label:p.bean_type},H=h[p.action_id],X=p.points_value*(p.quantity||1);return`
              <div class="lb-row" style="margin-bottom:8px;flex-direction:column;align-items:flex-start;gap:6px;">
                ...
                <div style="display:flex;justify-content:space-between;width:100%;">
                  <p class="text-dim" style="font-size:0.75rem;">
                    ...
                    · ${(H==null?void 0:H.name)||p.action_id||""}
                    ${p.reason_text?`· "${p.reason_text}"`:""}
                  </p>
                  <p class="text-dim" style="font-size:0.75rem;flex-shrink:0;margin-left:8px;">${Xe(p.timestamp)}</p>
                </div>
              </div>
            `}else if(p.kind==="revoke"){const L=f[p.receiver_id],H=m[p.offense_id],X=b[p.conduct_tier]||"🌑";return`
              <div class="lb-row" style="margin-bottom:8px;flex-direction:column;align-items:flex-start;gap:6px;border-color:rgba(48,209,88,0.25);background:rgba(48,209,88,0.03);">
                <div style="display:flex;justify-content:space-between;align-items:center;width:100%;">
                  <div style="display:flex;align-items:center;gap:10px;">
                    ...
                    <div>
                      <p style="font-size:0.9rem;font-weight:600;">${(L==null?void 0:L.name)||p.receiver_id} <span style="font-size:0.72rem;color:var(--green);font-weight:400;">· conduct revoked</span></p>
                      <p class="text-dim" style="font-size:0.75rem;">${(L==null?void 0:L.role)||""} · ${(L==null?void 0:L.outlet)||""}</p>
                    </div>
                  </div>
                ...
                <div style="display:flex;justify-content:space-between;width:100%;">
                  <p class="text-dim" style="font-size:0.75rem;">
                    ${X} ${(H==null?void 0:H.name)||p.offense_id||"Conduct"}
            ...
            `}else{const L=m[p.offense_id],H=b[p.conduct_tier]||"🌑",X=p.revoked?'<span style="color:var(--text-tertiary);font-size:0.7rem;"> · revoked</span>':"";return`
              <div class="lb-row" style="margin-bottom:8px;flex-direction:column;align-items:flex-start;gap:6px;${p.revoked?"opacity:0.45;":"border-color:rgba(255,69,58,0.25);"}">
                <div style="display:flex;justify-content:space-between;align-items:center;width:100%;">
                  <div style="display:flex;align-items:center;gap:10px;">
                    ...
                    <div>
                      <p style="font-size:0.9rem;font-weight:600;">${(v==null?void 0:v.name)||p.receiver_id}${X}</p>
                      <p class="text-dim" style="font-size:0.75rem;">${(v==null?void 0:v.role)||""} · ${(v==null?void 0:v.outlet)||""}</p>
                    </div>
                  </div>
                ...
                <div style="display:flex;justify-content:space-between;width:100%;">
                  <p class="text-dim" style="font-size:0.75rem;">
                    By <span style="color:var(--text-secondary);font-weight:600;">${M}</span>
                    <span style="color:var(--text-tertiary);"> (${D})</span>
                    · ${(L==null?void 0:L.name)||p.offense_id||"Conduct"}
                    ${p.note?`· "${p.note}"`:""}
            ...
            `}}).join("")}
      `}catch{r.innerHTML='<p class="text-dim text-sm text-center">Failed to load log.</p>'}}async function c(){try{const u=me(),[f,h]=await Promise.all([ae(),vn(u)]),_=Object.values(f).filter(g=>g.active!==!1).length,w=Object.keys(h).length,S=_>0?Math.round(w/_*100):0,E={};Object.values(h).forEach(g=>{E[g]=(E[g]||0)+1});const x=Object.entries(E).map(([g,b])=>({id:g,count:b,emp:f[g]||{}})).sort((g,b)=>b.count-g.count),A=["🥇","🥈","🥉"];r.innerHTML=`
        ...
        `:`
          ...
          ${x.map((g,b)=>{const p=w>0?Math.round(g.count/w*100):0;return`
              <div class="lb-row mb-8" style="flex-direction:column;align-items:stretch;gap:8px;padding:14px;">
                <div style="display:flex;align-items:center;gap:10px;">
                  <span style="font-size:1.2rem;min-width:28px;">${A[b]||`#${b+1}`}</span>
                  <div style="flex:1;">
  ...
  `}function n_(n){if(n.data_snapshot){const e=n.data_snapshot;return`Giver: ${e.giverName||n.giver_id} · Receiver: ${e.receiverName||n.receiver_id}`}return`Flag ID: ${n.id}`}const i_=[...Ct,...Ci,...Ii];function s_(n,e){const t=re(e.role)||e.role==="HR";n.innerHTML=`
    <div class="page">
  ...
  `;let i=null;function s(l){n.querySelectorAll(".approval-tab").forEach(c=>{c.className=c.dataset.tab===l?"btn btn-primary approval-tab":"btn btn-ghost approval-tab",c.style.flex="1",c.style.padding="10px"}),i&&(i(),i=null),l==="pending"?r():l==="revokes"?o():a()}n.querySelectorAll(".approval-tab").forEach(l=>{l.addEventListener("click",()=>s(l.dataset.tab))}),Xn(l=>{const c=n.querySelector('.approval-tab[data-tab="pending"]');c&&(c.innerHTML=`✋ Approvals ${l.length>0?`<span style="background:#fff2;border-radius:10px;padding:1px 7px;font-size:0.72rem;margin-left:4px;">${l.length}</span>`:""}`)}),Zn(l=>{const c=n.querySelector('.approval-tab[data-tab="revokes"]');c&&(c.innerHTML=`↩ Revokes ${l.length>0?`<span style="background:#fff2;border-radius:10px;padding:1px 7px;font-size:0.72rem;margin-left:4px;">${l.length}</span>`:""}`)}),r();function r(){const l=n.querySelector("#approvals-content");l.innerHTML='<div class="loading-center" style="min-height:30vh;"><div class="spinner"></div></div>',i=Xn(c=>{if(c.length===0){l.innerHTML=`
          <div class="empty-state">
            <div class="icon">✅</div>
            ...
            <div class="card" style="margin-bottom:12px;border-color:rgba(255,69,58,0.25);" data-id="${_.id}">
              <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px;">
                <div>
                  ...
                  <p class="text-dim text-sm">${(S==null?void 0:S.name)||_.offense_id} · ${m[_.conduct_tier]||_.conduct_tier}</p>
                </div>
  ...
  `;const s=n.querySelector("#vote-content");try{const[r,o,a,l]=await Promise.all([ae(),Tn(t,e.id),wi(),bi(t)]),c=yi(t,f=>{u(f,r,o)}),d=new MutationObserver(()=>{document.contains(s)||(c(),d.disconnect())});d.observe(document.body,{childList:!0,subtree:!0});async function u(f,h,m){const _=Object.entries(f).map(([g,b])=>({id:g,...b,emp:h[g]||{}})).filter(g=>g.emp.active!==!1&&g.emp.role&&d_(g.emp.role)).sort((g,b)=>(b.net_points||b.points||0)-(g.net_points||g.points||0)).slice(0,5).map((g,b)=>({...g,rank:b+1}));let w=_.map(g=>l&&l.employee_id&&g.id===l.employee_id?{...g,isWildcard:!0,wildcardNominatedBy:l.nominated_by_name}:g);if(l&&l.employee_id&&!_.find(g=>g.id===l.employee_id)){const g=h[l.employee_id]||{},b=f[l.employee_id]||{};w.push({id:l.employee_id,emp:g,net_points:b.net_points||b.points||0,rank:6,isWildcard:!0,wildcardNominatedBy:l.nominated_by_name})}if(w.length===0){s.innerHTML=`
        ...
        ${A?`
          <div class="card mb-16" style="text-align:center;padding:20px 16px;background:rgba(48,209,88,0.06);border-color:rgba(48,209,88,0.3);">
            ...
            ${Ct.includes(e.role)&&a.voting_points_enabled!==!1?'<p style="font-size:0.82rem;color:var(--gold);">+25 pts added to your score 🌟</p>':""}
            ${re(e.role)?`<p class="text-dim text-sm mt-8">${x} vote${x!==1?"s":""} cast so far</p>`:""}
          </div>
        `:`
        ...
        `}
        ${w.map(g=>c_(g,!A,m,re(e.role),E,x)).join("")}
        ${re(e.role)?`
          <div class="card mt-16" style="padding:16px;">
            <p class="section-header" style="margin-bottom:8px;">Total Votes Cast</p>
            <div class="mono text-gold" style="font-size:2rem;">${x}</div>
          </div>
        `:""}
      `,!A&&i&&s.querySelectorAll(".nominee-vote-btn").forEach(g=>{g.addEventListener("click",async()=>{const b=g.dataset.id;g.disabled=!0;try{const p=await Tn(t,e.id);await zl(t,e.id,b);const v=Ct.includes(e.role);!p&&v&&a.voting_points_enabled!==!1&&await Promise.all([rr(e.id,25),or(e.id,25)]),u(f,h,b)}catch(p){g.disabled=!1,console.error(p)}})}),re(e.role)&&Object.keys(S).length>0&&s.querySelectorAll(".nominee-card-wrap").forEach(g=>{g.style.cursor="pointer",g.addEventListener("click",()=>{const b=g.dataset.nomineeId,p=h[b]||{},v=Object.entries(S).filter(([,L])=>L===b).map(([L])=>L),k=v.map(L=>{var H;return((H=h[L])==null?void 0:H.name)||L}),M=s.querySelector(".voter-modal");M&&M.remove();const D=document.createElement("div");D.className="voter-modal",D.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:999;display:flex;align-items:flex-end;",D.innerHTML=`
              <div style="background:var(--card-bg);border-radius:20px 20px 0 0;width:100%;max-height:70vh;overflow-y:auto;padding:20px;">
                ...
                ${k.length===0?'<p class="text-dim text-sm">No votes yet.</p>':k.map((L,H)=>`
                    <div class="lb-row" style="margin-bottom:6px;">
                      <span style="font-size:0.8rem;color:var(--text-tertiary);width:24px;">${H+1}</span>
                      <p style="font-size:0.9rem;">${L}</p>
                    </div>
                  `).join("")}
              </div>
            `,D.querySelector(".close-modal").addEventListener("click",()=>D.remove()),D.addEventListener("click",L=>{L.target===D&&D.remove()}),document.body.appendChild(D)})})}}catch{s.innerHTML='<p class="text-dim text-sm text-center">Failed to load. Check connection.</p>'}}function c_(n,e,t,i,s,r){var w;const o=n.net_points||n.points||0,a=n.emp,l=n.rank===1&&!n.isWildcard,c=s[n.id]||0,d=r>0?Math.round(c/r*100):0,u=(a.name||"??").split(" ").map(S=>S[0]).join("").slice(0,2).toUpperCase(),f=["#8B5E3C","#5E6E8B","#5E8B6E","#8B5E7A","#7A8B5E","#6E5E8B","#8B7A5E"],h=f[(a.name||"").charCodeAt(0)%f.length],m={1:"👑",2:"🥈",3:"🥉"},_=n.isWildcard?"⭐":m[n.rank]||`#${n.rank}`;return`
